...
Có hai cách kiếm tiền từ giá tài sản, và chúng khác nhau tận gốc về mặt toán học. Q-world (cuốn chị em) trả lời câu hỏi "**hôm nay** derivative này giá bao nhiêu" bằng no-arbitrage: nếu ta có thể replicate payoff của một option bằng một danh mục cổ phiếu và tiền mặt được điều chỉnh liên tục, thì giá option **buộc phải** bằng chi phí của danh mục đó — nếu không, có arbitrage không rủi ro. Điểm mấu chốt: người Q-world **không cần dự báo** giá tương lai sẽ lên hay xuống. Trong bức tranh Black-Scholes lý tưởng, họ chỉ cần biết vol và lãi suất, rồi để cơ chế replication làm phần còn lại (thực tế Q-world còn phải calibrate cả vol surface, correlation, credit, funding — nhưng cái lõi *không cần drift* thì vẫn đúng). Drift thật của cổ phiếu ($\mu$) biến mất khỏi công thức Black-Scholes — đó là điều kỳ diệu của risk-neutral pricing.

P-world chơi trò ngược lại, và khó hơn theo một nghĩa sẽ làm rõ ở 1.2 — *nhận thức luận*, không phải kỹ thuật toán: **dự báo phân phối thật của giá tương lai, và kiếm tiền từ chỗ dự báo của mình tốt hơn cái mà giá thị trường đang ngầm định**. Không có phép màu replication nào cứu ta cả. (Lưu ý: so sánh "P khó hơn Q" ở đây đang đặt P-world thực tế cạnh một Q-world đã lý tưởng hóa; Q thực tế cũng có phần khó riêng.) Ta phải đoán $\mu$ — chính cái mà Q-world vứt đi — và đoán đúng thường xuyên hơn sai một chút.

"P" là **physical measure** (còn gọi là real-world measure hay historical measure): xác suất **thật** của các kịch bản — ẩn dụ quen dùng là "con số Chúa ghi trong sổ". Nhưng đừng hiểu theo nghĩa Platonic: physical measure không phải một hằng số quan sát được, nó tự thân là một *đối tượng cần mô hình hóa và ước lượng*, và không ai biết chính xác nó. "Q" là **risk-neutral measure**: một xác suất "nhân tạo" được xây sao cho mọi tài sản đều có kỳ vọng return bằng lãi suất phi rủi ro, tiện cho việc định giá. Hai measure liên hệ nhau qua **Radon-Nikodym derivative** $dQ/dP$ — một *mật độ ngẫu nhiên*, theo định lý Girsanov có dạng lũy thừa ngẫu nhiên $\exp\!\big(-\int_0^t \lambda\,dW_s - \tfrac12\int_0^t \lambda^2\,ds\big)$, được **tham số hóa** bởi market price of risk $\lambda$ (chứ không *bằng* $\lambda$). $\lambda$ đo phần bù rủi ro mà nhà đầu tư đòi hỏi để nắm giữ tài sản rủi ro. Để thấy khoảng cách giữa hai thế giới bằng số cụ thể: một cổ phiếu có drift thật $\mu = 8\%$/năm (P-world tin thế, dựa trên equity risk premium lịch sử), vol $\sigma = 20\%$/năm, và lãi suất phi rủi ro $r = 4\%$/năm. Dưới measure P, cổ phiếu drift ở $8\%$; dưới measure Q nó "drift" đúng bằng $r = 4\%$. Chênh lệch $8\% - 4\% = 4\%$ chính là risk premium. Đại lượng nối hai thế giới là **market price of risk** (Sharpe của thị trường dưới P):
$$\lambda = \frac{\mu - r}{\sigma} = \frac{0.08 - 0.04}{0.20} = 0.20.$$
Con số 0.20 này chính là "tỷ giá quy đổi" giữa P và Q: nó nói mỗi đơn vị rủi ro (vol) được thị trường thưởng 0.20 đơn vị return vượt trội. Girsanov dịch chuyển drift đúng $\lambda\sigma = 0.20 \times 0.20 = 0.04 = 4\%$ — đúng bằng risk premium. **Một phần lớn nghề P-world là ước lượng những risk premium như $\lambda$ ở trên** — nhưng *không phải tất cả*: một nguồn lợi nhuận khác biệt hẳn là **alpha/mispricing**, phần return vượt trội *không* giải thích được bằng risk premium (thị trường định giá sai rồi tự sửa). Đừng gộp hai kênh: $\lambda$ là kênh phần-bù-rủi-ro, alpha là kênh sai-giá. Còn Q-world thì cố tình **khử phần bù rủi ro**: dưới Q, excess return trên $r$ bằng 0 (asset drift về đúng $r$) — tức Girsanov triệt tiêu đóng góp của $\lambda$ vào drift, *chứ không phải bản thân $\lambda$ "bằng 0"* ($\lambda$ là đại lượng P-world, việc đổi measure không làm nó biến mất).
...
**Thứ nhất: tín hiệu cực yếu.** Thị trường tài chính là hệ thống gần-hiệu-quả: hàng chục nghìn người thông minh, được trang bị máy tính và dữ liệu như nhau, cùng săn một con mồi. Mọi pattern kiếm được tiền đều tự hủy dần khi bị khai thác — khác vật lý, nơi định luật hấp dẫn không suy yếu đi khi bạn công bố nó. Correlation giữa dự báo tốt và thực tế, gọi là **information coefficient** ($IC$), cỡ 0.02–0.05 đã là hàng xịn của một tín hiệu độc lập (đo bằng rank correlation, trên cross-section rộng cỡ nghìn cổ phiếu, horizon ngày–tháng) — con số cụ thể phụ thuộc universe, horizon và cách đo, nên đừng coi 0.02–0.05 là hằng số phổ quát. Nó nhỏ đến mức phản trực giác: một tín hiệu với $IC = 0.03$ nghĩa là khi ta xếp hạng 1000 cổ phiếu theo dự báo và so với return thực tế, hệ số tương quan hạng chỉ là 0.03 — gần như không thấy bằng mắt thường. Để cảm nhận độ mỏng: với một *Pearson* IC trong dự báo tuyến tính, phần phương sai của return giải thích được đúng là $IC^2$ ($= 0.03^2 = 0.0009$, **chín phần vạn**); với **rank**-IC (Spearman) thì $IC^2$ không phải $R^2$ chính xác mà chỉ là ước lượng bậc-độ-lớn của độ nhỏ. Dù đo cách nào, thông điệp là một: đây là khai thác mỏ quặng nồng độ chưa tới một phần nghìn, không phải nhặt vàng cục.

**Thứ hai: nhiễu thống trị ở mọi thang thời gian bạn quan tâm.** Sharpe ratio bằng 1 — một con số đáng mơ ước — vẫn có nghĩa là mỗi năm còn khoảng 16% xác suất lỗ. Ta tính (giả định return năm xấp xỉ **chuẩn** và quá trình **ổn định** — bỏ hai giả định này, đuôi trái dày hơn và con số đổi): với $SR = 1$ (annualized), return kỳ vọng một năm là $1\sigma_{\text{năm}}$, nên xác suất năm âm là $P(Z < -1) = \Phi(-1) \approx 15.9\%$. Nghĩa là cứ sáu năm lại có một năm lỗ, **ngay cả khi chiến lược hoàn toàn đúng và không hề hỏng**. Phân biệt may mắn với kỹ năng đòi hỏi lượng dữ liệu khổng lồ — mà dữ liệu tài chính thì ngắn, không dừng (non-stationary, phân phối trôi theo thời gian), và chỉ có **một** lịch sử duy nhất (không làm lại thí nghiệm được, không có "vũ trụ song song" để lấy thêm mẫu).
...
Đọc bảng này cho kỹ, vì nó là bản đồ của cả nghề. Với 100 cược một năm, edge 2% cho Sharpe 0.2 — gần như vô dụng, bị nhiễu nuốt chửng. Nhưng với 2.500 cược (10 cổ phiếu mỗi ngày trên 250 ngày giao dịch), Sharpe lên 1.0 — một quỹ đáng nể. Với 10.000 cược, Sharpe 2.0 — hàng đầu ngành. Và 250.000 cược một năm (địa hạt của high-frequency market making), edge 2% biến thành Sharpe 10 *trên giấy* — bậc độ lớn mà các hãng market-making tần suất cao như Citadel Securities hay Jane Street hướng tới (chúng vốn là *prop/market maker*, không phải hedge fund). Sharpe cụ thể của các hãng này không công khai; đây là minh họa *cơ chế* "edge nhỏ × số cược khổng lồ", không phải số liệu đã kiểm chứng. **Cùng một edge tí hon, số lượng biến nó thành cỗ máy in tiền hoặc thành rác, tùy bạn cược được bao nhiêu lần.**
...
**Chỗ gãy 2 — edge không hằng số.** Đồng xu 51/49 không bao giờ đổi. Nhưng edge trên thị trường **decay**. McLean & Pontiff (2016 — kết quả kinh điển ta gặp lại ở Ch7) tách được hai phần đừng gộp làm một: khoảng **26%** suy giảm là *out-of-sample decay* thuần túy (phần bias in-sample biến mất khi ra ngoài mẫu, xảy ra dù có công bố hay không), và tổng cộng khoảng **58%** thấp hơn *sau khi công bố* — phần dôi ra so với 26% mới là **hiệu ứng publication** (người khác đọc paper rồi giao dịch theo, làm cạn alpha). Alpha là tài nguyên bị khai thác cạn, không phải hằng số vật lý.
...
trong đó $IR$ là **information ratio** (return vượt benchmark chia cho tracking error — *không* đồng nhất với Sharpe, vốn đo return trên cash), $IC$ là chất lượng dự báo (edge), $BR$ là **breadth** (số cược *độc lập* mỗi năm), và $TC$ là **transfer coefficient** (mức độ danh mục thực tế truyền tải được tín hiệu, luôn $<1$ khi có ràng buộc và chi phí). Dạng gọn $IR \approx IC\sqrt{BR}$ ngầm giả định $TC = 1$ và các cược độc lập — nó chính là $0.02\sqrt{N}$ khoác áo học thuật: $IC$ thay cho 0.02, $\sqrt{BR}$ thay cho $\sqrt{N}$. Ví dụ: momentum 12-1 mà ta dùng xuyên suốt sách (Ch7, Phụ lục A) có rank-$IC$ trung bình ~0.025 và, nếu rebalance hàng tháng trên ~1000 cổ phiếu với các cược không quá tương quan, breadth hiệu dụng cỡ vài trăm/năm. Lấy $BR \approx 400$: $IR \approx 0.025\sqrt{400} = 0.5$. Sharpe thực nghiệm của momentum thường cao hơn (~0.75), nhưng hai con số **không trùng nhau** — chúng khác định nghĩa (IR so benchmark, Sharpe so cash) và ước lượng thô này bỏ qua cả $TC<1$ lẫn cấu trúc tương quan — nên chỉ đọc là *cùng bậc độ lớn*, không phải một phép khớp chính xác. Nâng $IC$ (tín hiệu tốt hơn) hay nâng $BR$ (nhiều cược độc lập hơn) đều tăng $IR$ — và cả cuốn sách này chỉ làm hai việc đó.
...
**Q-world có neo; P-world thì không.** Người định giá option có một mỏ neo tuyệt đối: giá của underlying *hôm nay*, quan sát được, không tranh cãi. Từ đó no-arbitrage ràng buộc giá derivative trong một khoảng hẹp. Nếu bạn định giá sai, arbitrageur sẽ trừng phạt bạn ngay và bạn biết mình sai. Người P-world dự báo *tương lai*, thứ chưa xảy ra và không có neo nào cả. Bạn nói cổ phiếu này sẽ outperform 2% trong tháng tới; một tháng sau bạn biết *kết cục* của riêng lần đó — nhưng một outcome đơn lẻ gần như vô nghĩa, vì ngay cả khi nó đi đúng hướng, bạn không tách được giỏi khỏi may. Cái mất *nhiều năm* không phải chờ một forecast ngã ngũ, mà là gom đủ số lần dự báo độc lập để chứng minh mình có *skill* thật chứ không phải trúng số.

**Signal-to-noise của Q cao hơn P nhiều bậc** (đây là so sánh trực giác giữa hai đại lượng *khác bản chất* — pricing error của Q so với return-forecast noise của P — nên đọc như một cảm nhận độ khó, không phải một bất đẳng thức chặt). Trong Q-world, sai số định giá điển hình là fraction của một vol point — nhỏ. Trong P-world, cái ta cố dự báo (return tuần tới) có tỷ lệ signal-to-noise thảm hại. Định lượng: một cổ phiếu điển hình có vol ~2%/ngày, tức ~$2\%\sqrt{5} \approx 4.5\%$/tuần. Alpha dự báo hàng tuần giỏi lắm cỡ 0.3%/tuần. Tỷ số signal/noise mỗi quan sát (biên độ signal so với biên độ noise) là $0.3/4.5 \approx 0.067$. Đây là tỷ số *biên độ*, không phải tỷ lệ phương sai: quy ra variance thì phần signal chỉ chiếm $0.067^2/(1+0.067^2) \approx 0.4\%$ — tức **hơn 99% phương sai mỗi tuần là nhiễu** (con số "93%" kiểu $1-0.067$ là nhầm giữa tỷ số và tỷ lệ). Điều này có hệ quả tàn nhẫn cho việc kiểm định. Coi tỷ số 0.067 như "Sharpe mỗi tuần" của tín hiệu; t-statistic sau $n$ tuần là $t = 0.067\sqrt{n}$. Để đạt $t = 2$ (ngưỡng "có ý nghĩa" tối thiểu), cần
$$n = \Big(\frac{2}{0.067}\Big)^2 \approx 900 \text{ tuần} \approx 17 \text{ năm dữ liệu.}$$
Chín trăm tuần — khoảng mười bảy năm — chỉ để *chớm* chắc rằng một tín hiệu tuần đơn lẻ không phải nhiễu. Và trong 17 năm đó thị trường đã đổi chế độ nhiều lần, tín hiệu có thể đã decay. Đây là lý do sâu xa vì sao breadth (nhiều cổ phiếu cùng lúc) quan trọng hơn lịch sử dài: ta không có 17 năm để chờ, nên phải mượn số lượng cross-section. Q-world hiếm khi phải vật lộn với signal-to-noise thấp đến thế.

**Q-world có neo thị trường để tự sửa; P-world sai là mất tiền.** Một mô hình pricing sai lệch nhẹ vẫn được calibrate lại về giá vanilla quan sát được và hedge động, nên *một phần* sai số bị mark-to-market hấp thụ. Nhưng đừng nói quá: calibration và dynamic hedging **không** khử hết model risk — mô hình sai vẫn cho hedge ratio sai, sinh hedging P&L lỗ, và định giá exotic lệch (đó chính là lý do XVA và model validation tồn tại trong cuốn Q). Khác biệt thật không phải "Q sai vẫn hòa vốn", mà là Q có *neo* (giá thị trường quan sát được) để phát hiện và giới hạn cái sai; một dự báo P-world sai thì lỗ thật, tiền thật, và thường không có neo nào báo cho bạn kịp.

**Kẻ thù thích nghi.** Đây là điểm sâu nhất. Định luật vật lý không quan tâm bạn có khám phá ra chúng không — hằng số hấp dẫn không đổi khi bạn công bố. Nhưng "định luật" của P-world là hành vi tập thể của những con người khác, những người cũng đang tối ưu và sẽ **thay đổi hành vi ngay khi bạn khai thác họ**. Ta có thể hình dung thị trường là một trò chơi mà các luật tự viết lại mỗi khi ai đó tìm ra cách thắng. Một QR do đó không bao giờ được nghỉ: một alpha tốt là tài sản đang khấu hao, và không tìm alpha mới nghĩa là chết chậm. Q-world *cũng* có phần thích nghi — vol surface, thanh khoản, dealer gamma và biên lợi nhuận của structured product đều dịch chuyển theo người tham gia, và một *trading edge* trên derivative cũng decay như alpha. Cái khác là **quan hệ định giá lõi** của Q được neo bởi no-arbitrage nên không tự-hủy-khi-bị-biết theo kiểu một tín hiệu P-world tự-hủy; nhưng nói Q "gần như không thích nghi" thì quá mạnh.

**Chỉ có một lịch sử.** Nhà vật lý lặp lại thí nghiệm nghìn lần, mỗi lần là một mẫu độc lập mới. Nhà P-world thì chỉ có đúng **một** chuỗi giá S&P từ 1927 đến nay. Nghe tưởng nhiều — gần trăm năm, hơn 20.000 phiên — nhưng tất cả vẫn là **một mẫu duy nhất**: năm 2008 chỉ xảy ra một lần, theo đúng một kịch bản, và bạn không bao giờ quan sát được những "năm 2008 khác" lẽ ra đã có thể xảy ra. Số *quan sát* thì nhiều, nhưng số lần *vũ trụ chạy lại từ đầu* thì bằng một — mà muốn tách kỹ năng khỏi may rủi, cái đáng đếm là vế thứ hai. Tệ hơn, chuỗi ấy còn **không dừng** (non-stationary): luật chơi tự trôi theo thời gian, nên ngay cả hơn 20.000 phiên đó cũng không rút ra từ cùng một phân phối cố định để mà gộp chung lại tính toán. Bạn không thể "chạy lại năm 2008" với điều kiện khác để xem chiến lược của mình thật sự giỏi hay chỉ trúng số đúng một lần. Điều này khiến mọi khẳng định thống kê trong P-world mong manh hơn nhiều so với trực giác từ khoa học tự nhiên, và là gốc rễ của toàn bộ nỗi ám ảnh về overfitting.
...
Trước khi học kỹ thuật, phải biết bức tranh: ai trả tiền, cấu trúc tổ chức nào, và vì sao điều đó định hình loại alpha mà mỗi nơi đi tìm. "Buy-side" theo lối nói tắt là phía tìm return từ việc *ôm* rủi ro thị trường, "sell-side" là ngân hàng làm giá và bán sản phẩm thu phí (địa hạt của cuốn Q). Ranh giới không sạch: thực tế **cả hai phía đều có thể mua, bán và warehouse rủi ro** — market maker sell-side ôm inventory risk, còn buy-side cũng bán rủi ro (mua bảo hiểm, bán vol, viết option). Đây là nhãn tổ chức tiện dùng, không phải một phân đôi chặt. Dưới đây là sáu nhóm chính — và lưu ý ngay: **taxonomy này chồng lấn**, nhiều hãng nằm ở nhiều nhóm.

**Multi-strategy / multi-manager ("pod shops").** Đại diện: **Citadel, Millennium, Point72, Balyasny, ExodusPoint, Schonfeld**. Cấu trúc: hàng trăm đội độc lập (mỗi đội gọi là "pod"), mỗi pod là một PM cùng vài analyst/quant, chạy chiến lược riêng với vốn được cấp. Quản trị rủi ro trung tâm cực chặt — các ngưỡng cắt vốn (tiêu biểu là drawdown ~5% bị cắt vốn, ~10% mất việc) **thay đổi theo hãng, pod, mandate và hợp đồng**, đây chỉ là mức minh họa. Thuộc nhóm trả lương cao nhất industry, áp lực tương xứng. Phí thu theo mô hình "pass-through": nhà đầu tư trả mọi chi phí vận hành của quỹ cộng phần chia lợi nhuận. Đây là một trong những mô hình nổi bật nhất của thập kỷ 2015–2025 — Citadel và Millennium mỗi hãng quản lý hàng chục tỷ USD và nhiều năm trả về lợi nhuận tương đối ổn định (thành tích quá khứ, không đảm bảo tương lai). Ta sẽ mổ xẻ kinh tế học một pod ngay dưới đây vì nó giải thích phần lớn "văn hóa áp lực" của ngành.

**Quant thuần hệ thống.** Đại diện: **Renaissance** (quỹ Medallion huyền thoại — được đồn ~66%/năm trước phí; từ giữa thập niên 2000 đã **trả lại vốn cho nhà đầu tư ngoài và chỉ còn mở cho nhân viên**), **Two Sigma, DE Shaw, AQR, PDT, WorldQuant, Man AHL/Numeric, Squarepoint, Qube**. (AQR ở đây chỉ là một mặt — nó đồng thời là CTA và asset manager factor, minh họa cho tính chồng lấn đã nói ở trên. Còn **XTX** về bản chất là một *electronic market maker*, xếp đúng hơn vào nhóm prop/market maker ngay dưới, chứ không phải "quant thuần hệ thống".) Văn hóa đặc trưng: "một mô hình lớn tập thể" (collaborative) — mọi researcher đóng góp vào một hệ thống chung, thay vì cạnh tranh theo pod. RenTec và Two Sigma nổi tiếng kiểu này; nó đổi lấy tính cạnh tranh nội bộ để lấy sự phối hợp.

**Prop trading / market makers.** Đại diện: **Jane Street, Citadel Securities, XTX, Optiver, IMC, SIG, Hudson River Trading, Jump, Tower, DRW, Virtu**. Họ trade tiền của chính công ty (proprietary), chủ yếu làm market making và arbitrage tần suất cao. Tuyển thẳng sinh viên giỏi toán/CS/olympiad, không đòi biết tài chính trước — họ dạy lại từ đầu. Jane Street nổi tiếng với ngôn ngữ OCaml và văn hóa poker/mental-math. Đây là nơi công thức $0.02\sqrt{N}$ đạt cực hạn: số cược cực lớn (hàng triệu/năm) bù cho edge cực nhỏ mỗi cược.

**CTA / managed futures.** Đại diện: **AQR, Man AHL, Winton, Aspect, Transtrend**. Chủ yếu trend following trên futures (chỉ số, hàng hóa, lãi suất, FX), lịch sử dài từ thập niên 1980. Sharpe khiêm tốn (~0.5–0.7 dài hạn) nhưng có tính chất quý: thường sinh lời trong các khủng hoảng **kéo dài, có xu hướng rõ** khi cổ phiếu sập dần ("crisis alpha"). Nhưng đừng tuyệt đối hóa — trend following *không* bảo vệ được trước các cú sập-rồi-bật nhanh (đảo chiều chữ V), nơi nó có thể thua ở cả hai đầu. Tính divergent này khiến CTA là một cấu phần đa dạng hóa hơn là một cỗ máy Sharpe cao.

**Asset managers định lượng.** Đại diện: **BlackRock** (nền tảng Aladdin + nhóm Systematic), **AQR, Dimensional (DFA)** — factor investing gốc academic, ra đời từ nghiên cứu Fama-French — **Robeco**. Họ chơi "smart beta"/factor dài hạn (value, quality, low-vol), phí thấp, capacity lớn (riêng BlackRock quản lý cỡ chục nghìn tỷ USD tổng tài sản; các hãng còn lại nhỏ hơn nhiều, cỡ trăm tỷ, và không phải hãng nào cũng "nghìn tỷ"). Alpha mỏng nhưng capacity khổng lồ — mô hình ngược với prop shop.

**Crypto quant.** Đại diện: market maker chuyên (**Wintermute, GSR, Amber**) và desk crypto của các hãng lớn. Vi cấu trúc kiểu "miền Tây hoang dã" — thị trường non trẻ, thanh khoản phân mảnh qua nhiều sàn, nhiều mispricing lộ liễu hơn. Cơ hội cho người mới nhiều hơn — không phải *vì* lịch sử ngắn tự nó, mà vì thị trường phân mảnh qua nhiều sàn, rào cản hạ tầng/pháp lý cao và ít người chơi tinh vi, khiến nhiều anomaly chưa bị arbitrage hết — nhưng cũng rủi ro hạ tầng và đối tác cao hơn nhiều.
...
PM được cấp **1 tỷ USD "allocation"**. Lưu ý: đây không phải tiền mặt trao tay — nó là **hạn mức rủi ro** (risk budget), quyền được triển khai một lượng vốn với mức rủi ro cho phép. Pod chạy market-neutral với **gross ~6x**: khoảng 3 tỷ USD long cộng 3 tỷ USD short (tổng gross exposure $3+3 = 6$ tỷ trên allocation 1 tỷ, tức 6 lần; net exposure gần 0 để trung hòa market). (Cẩn thận quy ước: một số desk quote "gross" theo *mỗi chiều* — "3x long / 3x short" — nên khi nghe "3x" phải hỏi rõ là mỗi chiều hay tổng.)

Mục tiêu return trên allocation cỡ **6%/năm**, tức $0.06 \times 1\text{ tỷ} = 60$ triệu USD P&L một năm. Đội 5 người thường ăn chia khoảng **15% của P&L** $= 0.15 \times 60 = 9$ triệu USD/năm, chia theo thỏa thuận nội bộ với PM lấy phần lớn. (Mọi con số ở đây — payout, quy mô đội, mức chi phí — là **minh họa**, biến động lớn giữa các nền tảng và hợp đồng, không phải chuẩn ngành.) Nghe rất đẹp — nhưng đây là chỗ áp lực lộ ra.
...
Quan trọng hơn là **cơ chế cắt vốn không khoan nhượng**. Drawdown −5% (mất 50M trên allocation 1 tỷ) thường khiến allocation bị cắt một nửa; −10% (100M) thường dẫn tới giải tán pod. Bây giờ nối với thống kê để thấy điều này đáng sợ đến mức nào. Giả sử chiến lược có vol ~4%/năm (nhất quán với mục tiêu 6% return, tức Sharpe $6\%/4\% = 1.5$ — đã rất tốt). Với vol năm 4%, một *return cả năm* −5% đã là chuyện thường: nó chỉ tương đương $5\%/4\% = 1.25$ độ lệch chuẩn, một cú trượt hơn một sigma. Nhưng phải cẩn thận — **drawdown** (đỉnh-đáy) *không* tính được bằng phép chia $5\%/4\%$ như vậy: nó là đại lượng **phụ thuộc toàn bộ đường đi**, và với cùng mức vol, drawdown tối đa trong năm thường **sâu hơn** con số return cuối năm. Nghĩa là chạm −5% *intra-year* còn dễ xảy ra hơn cả một năm âm −5%, gần như chắc chắn vài lần trong sự nghiệp. Ngay cả return cả năm cũng đủ đáng lo: với Sharpe 1.5, xác suất *cả năm* âm vẫn là $\Phi(-1.5) \approx 6.7\%$ — cứ 15 năm một lần, ngay cả khi chiến lược đúng hoàn hảo. Cắt vốn vì một cú trượt 1.25-sigma không phải vì PM dở, mà vì đó là bản chất của nhiễu (Ch3, Ch14).
...
Đối lập, một quỹ thuần collaborative (RenTec-style) *và* một asset manager factor — dù rất khác nhau về mandate, thanh khoản và risk budget, nên đừng coi là một khối — đều **không** có cơ chế cắt-pod-tàn-nhẫn này, nên có thể ôm những chiến lược drawdown sâu hơn nhưng edge bền hơn. Cùng một khoa học, hai cấu trúc tổ chức, hai loại alpha được ưa chuộng khác hẳn nhau.
...
**Execution / Microstructure Researcher.** Chuyên tối ưu *cách thực hiện* lệnh (Ch12–13). Alpha giỏi mấy cũng chết nếu trading cost nuốt hết, và một ví dụ số cho thấy khoảng cách này lớn cỡ nào. Lấy một chiến lược có gross return kỳ vọng 6%/năm và turnover cao (các mức impact dưới đây phụ thuộc turnover và participation rate cụ thể — mô hình chi phí đầy đủ ở Ch13; đây chỉ minh họa độ nhạy của net return với impact). Nếu market impact ăn 0.3%/năm, ta mất $0.3\%/6\% = 5\%$ của return — khó chịu nhưng sống được. Nhưng turnover cao khiến impact dễ phình: nếu impact leo tới 4%/năm, net return chỉ còn $6\% - 4\% = 2\%$ — mất hai phần ba alpha; và nếu impact chạm 7%/năm, net return là $6\% - 7\% = -1\%$, chiến lược **từ lãi thành lỗ dù tín hiệu không hề sai một chút nào**. Người execution researcher là người giữ cho cái khoảng cách backtest-vs-live đó không nuốt chửng alpha (recipe square-root impact ở Ch13).

**Risk.** Xây risk model, giám sát exposure theo factor, chạy stress test và scenario analysis. Buy-side chịu ít **vốn quy định kiểu Basel** hơn ngân hàng (đó là trọng tâm của cuốn Q), nhưng ranh giới không tuyệt đối — quỹ vẫn đối mặt margin rules (UMR), giới hạn leverage, quy định position/short-selling — và giám sát chặt drawdown, leverage, liquidity, concentration. Ở pod shop, chính đội risk trung tâm là người thực thi cơ chế cắt vốn −5%/−10%.

Danh sách vai trò trên thiên về research/trading — trục của cuốn sách — nhưng một quỹ quant thật còn sống nhờ nhiều vai khác không kém thiết yếu: **data engineering** (ingest, chuẩn hóa, point-in-time hóa dữ liệu), **platform/SRE** (hạ tầng chạy 24/7), **treasury/financing** (vốn, prime broker, chi phí vay và short), cùng **operations, compliance và legal**. Thiếu các vai này thì research cũng không biến thành P&L được.
...
Trong codebase `quantc` đi kèm, tầng P-world này sống trong `src/alpha` — signal, portfolio, backtest engine viết thuần TypeScript, **không chứa logic no-arbitrage/pricing Q**. Nó vẫn *dùng chung hạ tầng số* của repo (`src/numerics`: linalg, RNG, tối ưu, stats; `src/risk/pca`) và một vài helper toán thuần như `normalCdf` từ module Black-Scholes — nên "tách biệt" ở đây nghĩa là tách về *khái niệm và định giá*, không phải một cây import độc lập hẳn. Ta sẽ nhắc tới các module đó đúng lúc chúng minh họa một khái niệm, nhẹ nhàng, không sa đà vào chi tiết cài đặt — vì mục tiêu là hiểu *vì sao*, không phải học API.
...
**Các loại dữ liệu theo tần suất**: daily bars (OHLCV — open/high/low/close/volume) → intraday bars (1min/5min) → tick data (từng giao dịch) → **full order book** (L2 — độ sâu đã *gộp theo từng mức giá*; L3 — *từng lệnh* đặt/sửa/hủy ở cấp order; một ngày equity Mỹ cỡ terabyte). Tần suất càng cao, alpha càng "tươi" nhưng hạ tầng càng đắt.

Hãy hình dung cái tháp này một cách cụ thể để thấy khối lượng dữ liệu tăng thế nào khi ta đi xuống. Một cổ phiếu Mỹ trong một ngày cho **một** dòng daily bar. Cùng cổ phiếu đó, nếu lấy bar 1 phút cho phiên 9:30–16:00, cho $6.5 \times 60 = 390$ dòng. Xuống tick data, một large-cap như AAPL dễ dàng có vài trăm nghìn đến vài triệu trade một ngày. Xuống full order book (mọi lệnh đặt, sửa, hủy ở mọi mức giá), số message tăng thêm một đến hai bậc nữa — một tên đơn lẻ có thể sinh hàng chục triệu message/ngày, và toàn bộ thị trường equity Mỹ chạm mức terabyte mỗi ngày. Quy tắc kinh nghiệm **rất thô** (tỷ lệ thực phụ thuộc thị trường, feed và cách nén): mỗi bậc đi xuống thường nhân khối lượng dữ liệu lên khoảng 100–1000 lần, và kéo chi phí lưu trữ, xử lý, license lên theo — dù không nhất thiết cùng bậc. Đó là lý do một quỹ daily-equity có thể chạy trên một laptop, còn một market-maker HFT phải đặt server co-location cạnh sàn và trả hàng triệu đô cho feed.
...
1. **Corporate actions**: cổ phiếu split 2:1 → giá rớt 50% mà không ai mất tiền. Phải dùng **adjusted price** (điều chỉnh split + dividend) cho tính return, nhưng **raw price** cho mô phỏng giao dịch (bạn trade ở giá thật). Giữ cả hai chuỗi. Split và cash dividend chỉ là hai loại *dễ* nhất; một hệ thống thật còn phải xử lý spin-off, rights issue, special/return-of-capital distribution, merger, tender offer và mọi thay đổi số cổ phiếu lưu hành. Và "raw price" thôi *không đủ* để mô phỏng: split đổi *số cổ phiếu* nắm giữ, dividend sinh *cashflow* tiền mặt, các action khác có thể đổi cả bản thân instrument — mô phỏng đúng phải theo dõi các thứ đó, không chỉ một chuỗi giá.
...
5. Ticker tái sử dụng, đổi tên, đổi sàn → cần **security master** map ticker-tại-mỗi-thời-điểm sang identifier *ổn định hơn ticker* (CUSIP/ISIN/FIGI) — "ổn định hơn" chứ không bất biến: CUSIP vẫn đổi khi công ty đổi tên, sáp nhập hay tái cơ cấu, còn FIGI được thiết kế bền hơn; và một security master thật phân nhiều tầng (issuer → legal entity → security → share class → listing/venue), không phải ánh xạ phẳng. Đây là bài toán data engineering nhàm chán mọi quỹ phải giải trước khi kiếm được đồng nào — *cuốn sách này giả định lớp đó đã sạch*; `quantc/src/alpha` là tầng mô hình hóa, không bao gồm security master hay pipeline corporate-action.
...
*Survivorship bias bằng số*: đây là bẫy đắt nhất vì nó vô hình — dữ liệu trông sạch, backtest trông đẹp, mà toàn bộ là ảo. Cơ chế: mỗi năm một tỷ lệ nhỏ công ty biến mất (phá sản, bị mua lại giá rẻ, delisted vì rớt chuẩn niêm yết). Trong universe equity Mỹ, tỷ lệ delisting "xấu" (không phải do bị thâu tóm giá cao) rơi vào cỡ vài phần trăm/năm. Nếu dataset của bạn chỉ chứa các tên **còn sống hôm nay**, backtest của bạn đã ngầm bán trước mọi công ty sắp chết — một siêu năng lực tiên tri mà không chiến lược thật nào có. Định lượng: giả sử mỗi năm 3% universe bị delist với return trung bình −60% trong quý cuối trước khi biến mất. Việc "không bao giờ nắm" các tên này thổi phồng return danh mục lên khoảng $0.03 \times 0.60 = 0.018 = 1.8\%/$năm (ước lượng thô, ngầm giả định equal-weight, tỷ lệ delisting ổn định, và danh mục loại sạch toàn bộ phần lỗ đó) — rơi vào biên độ 1–4%/năm mà các nghiên cứu học thuật ước lượng. Con số 1.8% nghe nhỏ nhưng hãy đặt nó lên nền một chiến lược thật: nếu chiến lược có mean excess return thật 5.4%/năm và vol 18%/năm (Sharpe thật $5.4/18 = 0.3$), thì cộng thêm 1.8% ảo đẩy mean lên 7.2% và Sharpe backtest lên $7.2/18 = 0.4$ — riêng hiệu ứng mean này chỉ đưa Sharpe từ 0.3 lên ~0.4. Để lên tới 0.6–0.7 còn cần vol backtest bị *hạ đáng kể* (chẳng hạn vol thật 18% tụt xuống ~10–12% trong backtest) — điều xảy ra nếu bias tập trung vào các năm khủng hoảng (khi delisting nhiều nhất), khiến backtest bỏ sót đúng những cú sập lớn nhất. Không tự động, nhưng hoàn toàn có thể. Cách chữa duy nhất là dùng dataset chứa **delisted names** kèm **delisting returns** — return thực nhà đầu tư nhận được khi cổ phiếu ngừng giao dịch (thường là một con số âm lớn, đôi khi −100%). CRSP có trường này; nhiều feed rẻ tiền thì không, và đó là lý do đầu tiên bạn nên nghi ngờ một backtest "quá đẹp".

*PIT bằng dòng thời gian*: Q1 kết thúc 31/3; earnings công bố 15/5; số liệu bị restate 20/8. Backtest đứng ở ngày 10/4 được biết gì? — Số Q4 năm trước, **chưa** biết Q1, và mãi mãi không được dùng bản restate cho các quyết định trước 20/8. Dataset PIT chuẩn (ví dụ Compustat Point-in-Time) lưu **cả ba lớp thời gian**: kỳ báo cáo, ngày công bố, ngày mỗi bản sửa — và backtest phải join theo *thời điểm công bố*, không phải kỳ báo cáo. Đây là một cột `as_of_date` trong schema — quên nó là toàn bộ nghiên cứu fundamental thành rác. Lưu ý độ phân giải: `as_of_date` ở mức *ngày* là chưa đủ cho chiến lược intraday — một earnings công bố *sau giờ đóng cửa* chỉ trade được từ phiên hôm sau, nên cần cả *timestamp + timezone + độ trễ vendor*, nếu không backtest có thể dùng số trước khi nó thực sự ra.

Ba lớp thời gian ấy đáng được đặt tên rõ ràng vì chúng là xương sống của toàn bộ data engineering nghiêm túc, và ta sẽ quay lại chúng ở cuối chương như một pipeline hoàn chỉnh. Lớp một, **valid time / event time** (kỳ báo cáo) — số liệu này *nói về* quãng thời gian nào ("quý này là quý mấy"). Lớp hai, **knowledge time** hay `as_of_date` (ngày thông tin thực sự đến tay công chúng) — thứ duy nhất backtest được phép dùng để quyết định. Lớp ba, **transaction time / system time** — thời điểm *hệ thống ghi nhận* mỗi phiên bản (mỗi lần restate là một bản ghi mới). Đây đúng là mô hình *bitemporal* chuẩn: "valid time" là khi sự việc đúng trong thế giới thực (ở đây là kỳ báo cáo), còn `revision_date` gần với **transaction/system time** hơn là valid time — đừng lẫn hai khái niệm. Vì mỗi phiên bản là *một hàng riêng*, dữ liệu PIT của một kỳ trông như **nhiều hàng**:
`(ticker, Q1, report_date=2026-05-15, revision_date=2026-05-15, revenue=100M)`
`(ticker, Q1, report_date=2026-05-15, revision_date=2026-08-20, revenue=60M)`
— bản gốc 100M (ghi 15/5) và bản restate 60M (ghi 20/8) *cùng tồn tại*, chứ không phải một trường `revenue` duy nhất. Backtest ở ngày $t$ được phép nhìn mọi hàng có `report_date` $\le t$, và với mỗi kỳ báo cáo lấy bản có `revision_date` mới nhất mà vẫn $\le t$ — tức là bản số liệu **như nó tồn tại vào ngày $t$**, không phải bản đẹp nhất mà ta biết hôm nay. Đây chính là ý nghĩa vật lý của "point-in-time": tái dựng lại đúng trạng thái tri thức của quá khứ.
...
Về mặt "ai trả tiền cho alpha", đáng một ví dụ số để thấy nowcast tạo edge như thế nào. Giả sử panel thẻ tín dụng phủ được 2% doanh số bán lẻ Mỹ của một chuỗi nhà hàng, và consensus của analyst dự same-store-sales quý này tăng +3% YoY. Panel của bạn — sau khi debias và khử mùa vụ — đo được +6% YoY, và feed cho bạn con số này vào cuối tháng 6, trước ngày công bố earnings 15/7 những hai tuần. Bạn "biết trước" rằng công ty nhiều khả năng beat consensus. Nếu một earnings beat cỡ đó lịch sử đẩy giá lên trung bình +4% *và một miss đẩy giá xuống khoảng −4% đối xứng* (giả định phải nói rõ — thiếu nó thì không tính được edge) trong hai ngày quanh công bố, và tín hiệu panel dự đúng hướng, nói, 60% số lần (so với 50% của tung đồng xu), thì cược long khi dự báo beat cho edge kỳ vọng cỡ $0.60\times(+4\%) + 0.40\times(-4\%) = (0.60 - 0.40) \times 4\% = 0.8\%$ — nhỏ, nhưng lặp qua hàng trăm cái tên và nhiều quý là một dòng alpha thật (đây chính là logic "edge nhỏ × breadth" mà cả cuốn sách nối lại: một con xúc xắc lệch nhẹ, cược thật nhiều lần). Cạnh tranh ở đây là cuộc đua ai chuyển raw thành signal sạch nhanh nhất; và vì alpha decay khi nhiều quỹ cùng mua một feed — cái edge 0.8% teo dần khi phía bên kia của cược cũng cầm chính con số đó — giá trị nằm ở nguồn **độc quyền** hoặc ở kỹ thuật xử lý mà người khác không có. Đây là lý do các pod shop lớn có đội data sourcing riêng đi săn nguồn trước khi nó lên sàn data marketplace.

## 2.2 Returns — đơn vị tiền tệ của P-world

P-world **chủ yếu** làm việc trên **returns** hơn là giá — vì returns mới (gần) dừng và cùng đơn vị giữa các tài sản. (Không tuyệt đối: một nhánh quan trọng — cointegration, pairs-spread, price ratio, nhiều mô hình state-space — làm việc *trực tiếp trên mức giá*, xem chương 3.)

Trực giác đằng sau khẳng định này đáng được nói rõ, vì nó là lý do toàn bộ ngành làm việc trên returns. Giá là một chuỗi **non-stationary**: giá Apple 5 đô năm 2000 và 200 đô năm 2025 không thể so sánh trực tiếp, và các thống kê *vô điều kiện* (trung bình, phương sai) của một chuỗi giá thô là vô nghĩa vì chúng trôi theo mức giá. (Lưu ý điều này *không* mâu thuẫn với việc một **tổ hợp dừng** của các giá — residual cointegration, spread — lại có thống kê rất có nghĩa; đó chính là nền của pairs trading ở chương sau.) Return thì (gần) dừng: "+2% hôm nay" mang cùng ý nghĩa dù giá là 5 hay 500. Nhưng "cùng đơn vị" *không* đồng nghĩa "so sánh trực tiếp được": +2% của Apple và +2% của một cổ phiếu khác chỉ so được sau khi chuẩn theo vol, currency, liquidity và horizon — +2% của một tài sản vol 1%/ngày khác hẳn +2% của một tài sản vol 5%/ngày. Return chuẩn hóa về mức giá và đơn vị, biến một mớ chuỗi giá không đồng nhất thành các đại lượng cùng đơn vị để gộp, trung bình và mô hình hóa. Đó là nghĩa của "đơn vị tiền tệ của P-world".

- **Simple return**: $r_t = \frac{P_t}{P_{t-1}} - 1$. Cộng được **giữa các tài sản** trong danh mục (return danh mục = trung bình trọng số simple returns — *với điều kiện* trọng số xác định đầu kỳ, danh mục self-financing và cashflow xử lý đúng) — dùng cho portfolio math.
...
- **Excess return**: $r_t - r_{f,t}$ (trừ lãi phi rủi ro) — **Sharpe** tính trên excess return này. Đừng gộp ba thứ: **information ratio** dùng *active return* so với **benchmark** (không phải trừ riskfree), còn **alpha** là *intercept* của một hồi quy factor/asset-pricing — khác nhau, không cùng một "excess".
- **Annualization**: mean × 252 (đây là *arithmetic* annualized mean — **không** phải compounded annual return, vốn thấp hơn cỡ $\tfrac12\sigma^2$), volatility × $\sqrt{252}$ (lại quy tắc $\sqrt{t}$ — cùng quy tắc chương 3 cuốn Q). Sharpe daily → yearly: × $\sqrt{252}$ (cần return xấp xỉ dừng và không phụ thuộc chuỗi — cả autocorrelation lẫn vol clustering đều làm lệch).

Điểm dễ nhầm nhất của người mới là *khi nào dùng loại nào*, nên đáng dẫn xuất tại sao mỗi loại "cộng được" theo một chiều khác nhau — đây là bất đối xứng đẹp và hữu ích nhất của toàn chương. Xét **theo thời gian**: giá trị sau hai ngày là $P_2 = P_0 \times (1+r_1)(1+r_2)$ — simple return **nhân** nhau, không cộng. Nhưng lấy log: $\ln(P_2/P_0) = \ln(1+r_1) + \ln(1+r_2) = \tilde r_1 + \tilde r_2$ — log return **cộng** nhau qua thời gian. Đó là lý do phần lớn phân tích chuỗi thời gian (tính tổng return kỳ hạn, nhiều mô hình AR/GARCH, chuẩn hóa vol) *thường* dùng log return: phép cộng đơn giản hơn phép nhân — dù simple return cũng được dùng phổ biến (nhiều GARCH và mô hình thực nghiệm chạy thẳng trên simple return). Bây giờ xét **giữa các tài sản** tại một thời điểm: danh mục với trọng số $w_i$ có return $r_p = \sum_i w_i r_i$ — nhưng đẳng thức này chỉ đúng với **simple** return, vì giá trị danh mục là tổng tuyến tính giá trị các thành phần. Log return **không** cộng được ngang tài sản: $\ln(\sum_i w_i P_i)$ không bằng $\sum_i w_i \ln P_i$. Vậy nên portfolio math (trọng số, tối ưu hóa danh mục, covariance) sống trên simple return. Nhớ hai câu này là đủ: **log cộng theo thời gian, simple cộng theo tài sản**. Trộn hai loại là bug backtest phổ biến thứ hai sau look-ahead — bạn sẽ tính đúng theo hướng này, sai theo hướng kia, và sai số tích lũy im lặng.

Xấp xỉ $\tilde r \approx r - r^2/2$ cũng đáng dẫn xuất một dòng vì nó cho ta cảm giác về "khi nào được phép lười". Khai triển Taylor $\ln(1+r) = r - r^2/2 + r^3/3 - \dots$ Với $r$ nhỏ, số hạng bậc hai là hiệu chỉnh chính. Ví dụ số: $r = 1\%$ → $\tilde r = \ln(1.01) = 0.00995$, sai lệch so với $r = 0.01$ chỉ 0.005 điểm phần trăm (và $r - r^2/2 = 0.01 - 0.00005 = 0.00995$ khớp đến chữ số thứ năm) — hoàn toàn bỏ qua được ở tần suất daily nơi return điển hình dưới 2%. Nhưng $r = -50\%$ → $\tilde r = \ln(0.5) = -0.693 = -69.3\%$, lệch tận 19 điểm phần trăm — không thể lười. Ranh giới thực dụng (chỉ là *quy tắc ngón tay cái*, không phải hằng số): dưới ~5% mỗi kỳ hai loại thường thay thế được — nhưng ngay ở 5%, chênh $\tfrac12 r^2 \approx 12$ bps cũng có thể *rất lớn* tùy ứng dụng (tích lũy qua nhiều kỳ, hay khi so Sharpe sát nhau); trên ngưỡng đó (return dài hạn, tài sản biến động mạnh, drawdown lớn) càng phải dùng đúng loại.

**Các quy đổi bằng số dùng hằng ngày** (làm nhanh không cần máy tính là kỹ năng phỏng vấn):

- Daily vol 1% → annual $1\% \times \sqrt{252} = 1\% \times 15.87 \approx 15.9\%$. Ngược lại, một cách nhẩm nhanh: chia annual vol cho ~16 ra daily vol, nên "vol 32%" nghĩa là *độ lệch chuẩn* ngày cỡ $32\%/16 = 2\%$ — hiểu đúng là một-sigma, không phải biên độ cố định "ngày nào cũng ±2%"; độ lớn dịch chuyển điển hình (trung vị $|r|$) thực ra nhỏ hơn, cỡ $0.8\sigma$ nếu phân phối gần chuẩn.
...
- Log vs simple ở biên độ lớn: chuỗi +50% rồi −50% simple → về $100 \times 1.5 \times 0.5 = 75$ (lỗ 25%), trong khi tổng log return $= \ln 1.5 + \ln 0.5 = 0.405 - 0.693 = -0.288$ → $e^{-0.288} = 0.75$ ✓ — log return "tự động" nói thật về compound (−0.288 tương ứng lỗ 25%), còn *phép lấy trung bình cộng* các simple return qua thời gian mới là chỗ đánh lừa ("trung bình cộng của +50% và −50% là 0%", nghe như hòa vốn nhưng thực tế lỗ 25%) — bản thân simple return không sai, sai là ở việc cộng-trung-bình nó theo thời gian thay vì nhân.
...
Quy tắc $\sqrt{t}$ trong annualization không phải quy ước tùy tiện mà là hệ quả trực tiếp của việc return xấp xỉ độc lập qua thời gian, và đáng dẫn xuất vì nó tái xuất khắp cả sách. Nếu return các ngày độc lập với cùng phương sai $\sigma_d^2$, thì phương sai của tổng $T$ ngày là $\text{Var}\left(\sum_{t=1}^T \tilde r_t\right) = \sum_{t=1}^T \sigma_d^2 = T\sigma_d^2$ (phương sai của tổng các biến độc lập là tổng phương sai). Lấy căn: độ lệch chuẩn kỳ $T$ là $\sigma_d\sqrt{T}$. Còn **trung bình** thì cộng tuyến tính: kỳ vọng tổng là $T\mu_d$. Đó là toàn bộ bí mật: mean scale theo $T$, vol scale theo $\sqrt{T}$, nên Sharpe (tỉ số mean/vol) scale theo $T/\sqrt{T} = \sqrt{T}$. Với $T = 252$ ngày giao dịch/năm, hệ số vol là $\sqrt{252} = 15.87$. Cùng công thức này xuất hiện ở cuốn Q-world (chương 3) khi scale vol option — hai thế giới dùng chung một quy tắc. Lưu ý điều kiện: nếu return **có** autocorrelation (trend thì dương, mean-revert thì âm), quy tắc $\sqrt{t}$ đánh giá sai vol thật — một tài sản trending có vol dài hạn cao hơn $\sigma_d\sqrt{T}$, một tài sản mean-reverting thì thấp hơn. Ở tần suất daily equity autocorrelation gần 0 nên $\sqrt{t}$ dùng tốt cho *điểm ước lượng* vol; nhưng ngoài autocorrelation còn một điều kiện nữa — **conditional heteroskedasticity** (vol clustering): nó không làm lệch vol trung bình nhưng khiến ước lượng Sharpe/vol trong mẫu hữu hạn kém ổn định hơn con số $\sqrt{t}$ gợi ý. Annualization là một *giả định*, không phải một hằng đẳng thức.

Một ví dụ excess return bằng số để cột toàn bộ lại. Giả sử một chiến lược có return gộp năm là 12%, và lãi phi rủi ro (T-bill) năm đó là 5%. Excess return là $12\% - 5\% = 7\%$. Nếu vol năm là 15.9% (đúng bằng vol 1%/ngày ở trên), Sharpe là $7\%/15.9\% = 0.44$. Chú ý: nếu ai đó quên trừ risk-free và báo *total-return* Sharpe $= 12\%/15.9\% = 0.75$, con số đẹp hơn hẳn nhưng **sai**, và sai nhiều nhất đúng vào những năm lãi suất **cao** (khi phần riskfree bị bỏ quên lớn). Đây là bẫy khi so chiến lược qua các thời kỳ lãi suất khác nhau: hai chiến lược cùng kỹ năng nhưng đo bằng *total-return* Sharpe ở hai nền lãi suất khác nhau sẽ cho con số lệch nhau, dù *excess* Sharpe của chúng bằng nhau. (Chiều đúng phải nhấn: chính năm lãi suất cao mới bị thổi phồng nếu quên trừ riskfree — nên một khi đã tính đúng trên excess, mức lãi suất **không** còn tự động bơm Sharpe; đừng nói "Sharpe của năm lãi suất 0% bị thổi lên bởi lãi suất thấp".) Sharpe tính trên excess return chính vì lý do này. Một lưu ý cuối: "trừ một T-bill rate" chỉ gọn gàng với tài sản *fully funded* long-only; với market-neutral, có đòn bẩy, hay derivatives, cái phải trừ là chi phí financing/collateral/benchmark thực tế, phức tạp hơn một con T-bill.

## 2.3 Stylized facts — returns thật trông như thế nào

Trước khi model, phải biết đối tượng. Các sự thật thực nghiệm lặp lại trên *rất nhiều* thị trường và thời kỳ (Cont 2001) — "rất nhiều" chứ không "mọi": một số fact (đặc biệt leverage effect) không đồng đều giữa các asset class, ví dụ nhiều hàng hóa lại có *inverse leverage* (giá tăng → vol tăng):

1. **Đuôi dày (fat tails)**: Pearson kurtosis daily returns ~5–30 (Gaussian = 3; con số tùy universe, tần suất và thời kỳ). Sập −20%/ngày (1987) là "không thể" dưới Gaussian ($\sim 20\sigma$) nhưng xảy ra thật. Hệ quả: mọi risk model Gaussian đánh giá thấp thảm họa; dùng Student-t hoặc EVT cho đuôi.
2. **Volatility clustering**: return hôm nay lớn (bất kể dấu) → mai thường lớn. Vol dự báo được khá tốt (khác với *hướng* — gần như không dự báo được). Đây là chỗ GARCH sống (chương 3) và là lý do vol targeting hoạt động (chương 14, risk management).
...
5. **Aggregational Gaussianity**: return tháng/quý gần Gaussian hơn return ngày (CLT gom dần). Cẩn thận cách đọc: đây chỉ là phát biểu về *hình dạng phân phối return khi đổi horizon*, **không** phải "chiến lược tần suất thấp an toàn hơn" — aggregation không xóa regime risk, phụ thuộc vol, jump hay drawdown.
6. **Non-stationarity**: mọi tham số trôi theo thời gian — regime thay đổi (2008, 2020, chu kỳ lãi suất). Mô hình fit 20 năm mượt mà có thể vô dụng cho năm tới; các pipeline nghiêm túc chống điều này bằng nhiều cách — rolling window, regime awareness, nhưng cũng expanding window có decay, shrinkage, cập nhật Bayesian, hay ensemble để ổn định tham số — không chỉ một công thức duy nhất.
...
Hệ quả vận hành đáng một con số cụ thể để thấy nó không phải chuyện học thuật. Value-at-Risk 99% một ngày dưới giả định Gaussian là $2.33\sigma$ (phân vị 1% của phân phối chuẩn); với vol 1%/ngày, đó là VaR $= 2.33\%$ — nghĩa là mô hình Gaussian dự báo bạn chỉ lỗ quá 2.33% trong đúng 1% số ngày, tức khoảng $0.01 \times 252 \approx 2.5$ ngày/năm. Nhưng với đuôi dày thật, số ngày lỗ vượt ngưỡng đó thực tế cao hơn hẳn — quan sát thực nghiệm trên equity thường gấp hai đến ba lần dự báo Gaussian, cỡ 5–7 ngày/năm thay vì 2.5. (Lưu ý: bản thân một con kurtosis ~12 *không* đủ để suy ra chính xác bội số này — cùng một kurtosis có thể đi với nhiều hình dạng đuôi và xác suất phân vị khác nhau; 2–3× là mức *thực nghiệm điển hình*, không phải hệ quả toán học của kurtosis 12.) Nói cách khác, cái "biến cố 1%" của bạn xảy ra thường xuyên như biến cố 2–3%, và những ngày tệ nhất tệ hơn nhiều so với mức $2.33\sigma$ mà Gaussian cho phép. Đó là lý do risk desk dùng Student-t (đuôi dày điều chỉnh được qua bậc tự do) hoặc Extreme Value Theory cho phần đuôi thay vì tin vào Gaussian VaR.

Về **volatility clustering** và mối liên hệ với điểm 3, một cặp con số làm rõ nghịch lý "thị trường vừa ngẫu nhiên vừa dự báo được". Autocorrelation bậc 1 của *return* daily equity index gần 0 — điển hình trong khoảng $\pm 0.05$ (số cụ thể tùy index/single-stock, tần suất và estimator), thống kê gần như không phân biệt được với nhiễu. Đây là "market gần efficient": bạn không đoán được *hướng* ngày mai từ hướng hôm nay. Nhưng autocorrelation bậc 1 của *bình phương return* (hay trị tuyệt đối) lại lớn và dương rõ rệt — thường 0.2–0.4 ở bậc 1 và tắt chậm qua hàng chục ngày. Nghĩa là: *độ lớn* của biến động có trí nhớ dài, dù *dấu* thì không. Một ngày biến động 3% thường theo sau bởi những ngày biến động lớn; một ngày yên ả thường theo sau bởi yên ả. Đây là món quà lớn nhất mà thị trường tặng quant: hướng gần như bất khả đoán, nhưng **vol thì đoán được khá tốt** — và toàn bộ ngành risk (GARCH ở chương 3, vol targeting và position sizing ở chương 14) được xây trên chính sự bất đối xứng này.

Về **leverage effect**, đây là cầu nối đẹp sang cuốn Q-world nên đáng một câu định lượng. Correlation giữa return hôm nay và thay đổi vol ngày mai là âm và không nhỏ — điển hình cỡ $-0.3$ đến $-0.7$ với chỉ số equity. Một cú $-3\%$ đẩy vol lên mạnh hơn một cú $+3\%$ hạ vol; nỗi sợ bất đối xứng với lòng tham. Hiện tượng này **liên quan chặt** — nhưng *không đồng nhất* — với **volatility skew** của thị trường option (implied vol của put out-of-the-money cao hơn call cùng độ lệch; xem cuốn Q-world). Leverage effect là chuyện của *physical measure* (chuỗi return lịch sử); skew là chuyện của *risk-neutral measure* và còn chứa thêm tail-risk premium, cung–cầu option, và khoảng cách P–Q. Hai thế giới soi cùng một gốc bất đối xứng trước rủi ro giảm giá, nhưng skew *không* chỉ là leverage effect đọc lại — đừng đánh đồng chúng.

Về **aggregational Gaussianity**, con số minh họa là kurtosis tự giảm khi ta gộp thời gian. Cơ chế là Central Limit Theorem: tổng của $n$ biến (gần) độc lập có excess kurtosis giảm cỡ $1/n$ so với từng biến. Với return **thật sự** iid, công thức lý thuyết cho excess kurtosis giảm theo $1/n$: một chuỗi daily excess kurtosis 9 (tức kurtosis 12) khi gộp 5 ngày về $\approx 9/5 = 1.8$ (kurtosis ~4.8), gộp 21 ngày còn $\approx 9/21 = 0.4$ (kurtosis ~3.4). Trên thực tế return **không** iid (vol clustering làm các ngày phụ thuộc nhau), nên hội tụ *chậm hơn* $1/n$ — theo quan sát điển hình (con số minh họa, không rút từ công thức), daily kurtosis ~12 có thể chỉ về cỡ ~7 ở tuần và ~4–5 ở tháng: chậm hơn nhưng cùng chiều, đuôi vẫn mỏng dần khi gộp. Một hệ quả *có giới hạn*: phân phối return của chiến lược tần suất thấp gần Gaussian hơn về *hình dạng* — nhưng điều đó **không** miễn cho nó regime risk, jump hay drawdown (một danh mục factor tháng vẫn có thể mất 30% trong 2008). Còn việc nhiều chiến lược factor cổ điển "vỡ" khi ép xuống intraday thì *chủ yếu* do signal horizon không khớp, microstructure noise, turnover và transaction cost — chứ không phải chủ yếu do đuôi non-Gaussian.

Về **non-stationarity**, đây là stylized fact khiêm tốn nhất mà tàn khốc nhất, nên đáng một ví dụ cụ thể. Một mô hình fit trên dữ liệu 2003–2007 (thị trường bò yên ả, vol thấp, correlation cổ phiếu vừa phải) bước vào 2008 gặp một thế giới hoàn toàn khác: vol nhân ba (từ cỡ 1%/ngày lên 3%/ngày, tức từ ~16%/năm lên gần 50%/năm), correlation trung bình giữa các cổ phiếu vọt từ cỡ 0.2–0.3 lên gần 0.6–0.8 (các mức minh họa, tùy universe và cửa sổ đo; ý chính: mọi thứ rơi cùng nhau, diversification biến mất đúng lúc cần nhất), và nhiều quan hệ factor đảo chiều. Tham số không phải hằng số — chúng trôi theo regime, và các cú chuyển regime (2008, cú sốc COVID tháng 3/2020, các chu kỳ lãi suất) là nơi backtest mượt mà đi chết. Đây là lý do mọi pipeline nghiêm túc không fit một lần trên toàn lịch sử rồi tin mãi, mà dùng các kỹ thuật thích nghi tham số — **rolling window** (chỉ dùng dữ liệu gần đây), **regime awareness** (nhận diện chế độ hiện tại — chương 4, Regime & structural change), cùng shrinkage, cập nhật Bayesian, hay expanding-window có decay. Non-stationarity cũng là lý do sâu xa vì sao "Sharpe backtest 2.0 trên 20 năm" nên khiến bạn nghi ngờ nhiều hơn là hào hứng: 20 năm mượt mà thường có nghĩa mô hình đã fit trùng lên các regime đã biết, chứ không phải nắm được quy luật bền.

## 2.4 Sampling: đồng hồ thời gian không phải đồng hồ duy nhất

Bar theo thời gian (daily, 5-min) là quy ước lịch sử (tiện cho con người và cho bảng giá cũ) hơn là một lựa chọn thống kê tối ưu: thị trường "sống" không đều — hoạt động và biến động dồn về đầu và cuối phiên theo hình chữ U đã được ghi nhận rộng rãi, nên một bar 30 phút đầu phiên thường chứa nhiều thông tin hơn hẳn một bar giữa trưa. Lấy mẫu theo đồng hồ khiến bar giữa trưa thừa (toàn noise) và bar quanh sự kiện thiếu (một bar nuốt cả cú nổ). Các lựa chọn thay thế (AFML phổ biến hóa):

- **Tick bars**: đóng bar mỗi $n$ giao dịch.
- **Volume bars**: mỗi $n$ đơn vị khối lượng — "đồng hồ" chạy theo hoạt động.
- **Dollar bars**: mỗi $n$ USD giá trị — ổn định qua thời kỳ giá thay đổi lớn; một mặc định phổ biến và thường hợp lý, nhưng "tốt nhất" hay không còn tùy asset, venue, mục tiêu mô hình và chất lượng phân loại trade.
- **Imbalance bars**: đóng bar khi mất cân bằng mua/bán tích lũy vượt ngưỡng — đồng bộ với dòng thông tin.

Lý do thống kê: returns lấy theo volume/dollar clock thường gần IID-Gaussian hơn theo time clock (*một phần đáng kể* vol clustering là hiện tượng của đồng hồ sai — nhưng chỉ một phần: vol clustering vẫn quan sát được cả trên đồng hồ hoạt động lẫn ở nhiều thang intraday/overnight/tháng, nên không phải thuần artifact của time bar) — mô hình phía sau (chương 3, 12) làm việc trên nguyên liệu "thuần" hơn. Với dữ liệu daily bài toán này ít gay gắt; xuống intraday nó trở thành quyết định thiết kế đầu tiên của data layer.

Một ví dụ số làm rõ dollar bar "ổn định" *cái gì*. Giả sử ta muốn mỗi bar chứa cùng "lượng hoạt động kinh tế". Với volume bar, ta cố định số cổ phiếu — nói, 1 triệu cổ mỗi bar. Nhưng khi giá cổ phiếu tăng dần từ 50 lên 100 qua vài năm, 1 triệu cổ ngày xưa chỉ là $50$ triệu đô giá trị, còn 1 triệu cổ bây giờ là $100$ triệu đô — *cùng một bar* đại diện cho lượng giá trị kinh tế khác gấp đôi, nên **nội dung kinh tế mỗi bar** (và do đó phân phối return trên mỗi bar) trôi theo mức giá. Dollar bar cố định **giá trị** — nói, 50 triệu đô mỗi bar — nên ở giá 50 cần 1 triệu cổ để đầy bar, ở giá 100 chỉ cần 500 nghìn cổ: *nội dung kinh tế mỗi bar* giữ nguyên qua các thời kỳ giá rất khác nhau, và đó mới là thứ được ổn định. (Lưu ý điều dollar bar **không** hứa: số bar mỗi ngày *không* cố định — nó theo tổng dollar volume trong ngày, nên một ngày sôi động vẫn sinh nhiều bar hơn. Cái ổn định là giá-trị-trên-mỗi-bar, không phải số-bar-mỗi-ngày.)

Còn về khẳng định "return theo volume/dollar clock gần IID-Gaussian hơn", cơ chế đáng nói vì nó tinh tế và đẹp. Phần lớn vol clustering — cái autocorrelation mạnh trong return² ở mục 2.3 — thực ra là hệ quả của việc **hoạt động giao dịch** không đều theo đồng hồ. Những giờ và ngày sôi động (nhiều trade, nhiều volume) trùng đúng với những giờ và ngày biến động mạnh; đồng hồ thời gian gộp các giai đoạn hoạt động rất khác nhau vào các bar bằng nhau, tạo ra ảo giác rằng vol "cụm lại". Khi ta chuyển sang đồng hồ chạy theo hoạt động (volume/dollar bar), *theo giả thuyết* mỗi bar chứa gần cùng lượng thông tin (dollar volume làm proxy cho dòng thông tin — đây là một *giả định mô hình*, không phải sự thật quan sát trực tiếp), nên biến động trên mỗi bar đồng đều hơn — *một phần đáng kể* vol clustering giảm đi, và return trên mỗi bar tiến gần phân phối IID-Gaussian hơn (không biến mất hoàn toàn). Đây không phải mẹo làm đẹp số liệu mà là một cách chọn đúng "đơn vị thời gian" mà thị trường thực sự vận hành theo: thị trường đo thời gian bằng lượng giao dịch, không bằng số giây. Mô hình phía sau (ước lượng vol ở chương 3, microstructure ở chương 12) làm việc trên nguyên liệu thuần hơn, ít phải "dọn dẹp" vol clustering giả tạo. Với dữ liệu daily hiệu ứng này nhẹ và ta hầu như dùng time bar cho tiện; nhưng khi đội nghiên cứu xuống intraday, chọn đồng hồ là **quyết định thiết kế đầu tiên** của data layer, trước cả khi bàn đến signal.
...
**Bước 1 — Security master và identifier bền.** Trước khi làm gì, ta cần một cách gọi tên tài sản không đổi khi ticker đổi. Ticker được tái sử dụng (một ticker chết có thể được gán cho công ty khác vài năm sau), đổi khi công ty đổi tên, khác nhau giữa các sàn. Giải pháp là một bảng `security_master` map ticker-tại-mỗi-thời-điểm sang một identifier *ổn định hơn ticker* như CUSIP, ISIN, hoặc FIGI (ổn định hơn, *không* bất biến: CUSIP vẫn đổi khi đổi tên/sáp nhập/tái cơ cấu; FIGI bền hơn), kèm `start_date`/`end_date` cho mỗi ánh xạ. Một security master thật còn phân tầng issuer → legal entity → security → share class → listing/venue, không phải một ánh xạ phẳng. Ví dụ cụ thể của cạm bẫy: ticker "FB" là Facebook đến 2022 rồi thành "META"; một pipeline join theo ticker thô sẽ đứt chuỗi lịch sử ở đúng ngày đổi tên, hoặc tệ hơn, nối nhầm nếu "FB" sau này được cấp cho công ty khác. Đây là công đoạn nhàm chán nhất mọi quỹ phải làm xong trước khi kiếm được đồng nào — *nhưng nằm ngoài phạm vi code của cuốn này*: `quantc/src/alpha` là tầng mô hình hóa (signal, portfolio, backtest) và **giả định** dữ liệu đầu vào đã sạch, PIT; nó không chứa security master, PIT schema hay pipeline corporate-action.
...
**Bước 4 — Join fundamental và alt-data theo `as_of_date`.** Đây là trái tim PIT. Mọi bảng dữ liệu ngoài giá (fundamental, ước lượng phân tích, panel alt-data) phải có cột `as_of_date` = ngày thông tin **thực sự có sẵn**, và backtest chỉ được join hàng có `as_of_date` $\le t$. Với dữ liệu bị restate, giữ đủ ba lớp thời gian (event time, knowledge time, valid time như mục 2.1) và với mỗi kỳ báo cáo lấy bản mới nhất mà `revision_date` vẫn $\le t$. Với alt-data, `as_of_date` phải tính cả độ trễ feed (dữ liệu giao dịch tuần này thường chỉ có sẵn sau vài ngày đến vài tuần), nếu không ta lại rơi vào look-ahead qua cửa sau. Và với chiến lược intraday, `as_of_date` phải ở độ phân giải *timestamp* (kèm timezone), không phải chỉ *ngày* — một tin ra lúc 16:05 không được dùng cho lệnh lúc 15:00 cùng ngày.

**Bước 5 — Point-in-time test cho chính pipeline.** Cách kiểm tra dứt khoát rằng pipeline không rò rỉ tương lai: chạy backtest tính đến một ngày $t_0$ trong quá khứ, lưu lại mọi signal nó sinh ra; rồi chạy lại pipeline như thể hôm nay là $t_0$ (chỉ dùng dữ liệu có `as_of_date` $\le t_0$). Nếu hai bộ signal cho $t_0$ khớp nhau, đó là bằng chứng *mạnh* — nhưng **không phải chứng minh dứt khoát** — rằng pipeline PIT-sạch: một pipeline rò rỉ *nhất quán* (cả hai lần chạy đều dùng chung một bước rò tương lai) vẫn cho kết quả khớp và lọt qua bài test này. Ngược lại, một vendor correction *hợp lệ* (số liệu được sửa đúng quy trình PIT) có thể làm hai lần chạy *khác nhau* mà pipeline vẫn sạch. Vì thế: nếu chúng khác — ví dụ signal tháng 6 đổi khi bạn thêm dữ liệu tháng 8 — đó là *cờ đỏ* cần điều tra (thường là rò tương lai), không tự động là án tử; và nếu chúng khớp, hãy coi là đã qua một smoke test quan trọng chứ đừng coi là giấy chứng nhận. Dù vậy đây vẫn là một trong những bài kiểm tra rẻ và hữu ích nhất tách các quỹ nghiêm túc khỏi phần còn lại.

Năm bước trên là *xương sống*, không phải danh sách đầy đủ: một pipeline production còn phải lọc bad tick, khử trùng lặp và sự kiện đến sai thứ tự, xử lý missing data, tôn trọng exchange calendar và timezone, quy đổi FX, resolve entity nhiều tầng, và version hóa dữ liệu để tái lập được (cùng một backtest chạy lại phải ra cùng kết quả). Toàn bộ pipeline này không sinh ra một điểm alpha nào; nó chỉ đảm bảo rằng những điểm alpha bạn *nghĩ* mình có là thật, chứ không phải quà tặng vô tình từ tương lai. Đó là lý do một quant researcher giỏi coi việc dựng và audit data pipeline không phải là công việc lặt vặt để giao cho người khác, mà là phần nền của chính nghiên cứu — vì mọi mô hình đẹp ở các chương sau đều mặc định nguyên liệu đầu vào đã sạch và point-in-time, và giả định đó là nơi phần lớn chiến lược chết trước khi kịp sống.

# Chương 3: Thống kê và econometrics

Bộ công cụ tay nghề của quant researcher. Trọng tâm không phải "biết công thức" mà là **biết công cụ nào gãy khi nào** — vì dữ liệu tài chính vi phạm gần như mọi giả định textbook. Một sinh viên thống kê giỏi bước vào buy-side thường mắc đúng một sai lầm: tin vào con số $R^2$ và t-stat mà máy in ra, quên mất rằng các con số *suy luận* (t-stat, p-value, khoảng tin cậy) được dựng trên giả định IID, homoskedastic, stationary — ba thứ mà giá cổ phiếu, spread, và return chiến lược đều vi phạm thô bạo. ($R^2$ thì hơi khác: nó là thống kê *mô tả*, tính được mà **không** cần các giả định suy luận đó — nhưng *diễn giải* nó vẫn dính bẫy, như spurious regression ở 3.3 cho thấy.) Chương này đi qua từng công cụ nền — ước lượng, kiểm định, hồi quy, time series, cointegration, state space — và ở mỗi công cụ đặt cùng một câu hỏi: *nó nói dối bạn ở đâu, và giá của việc tin nó bằng bao nhiêu tiền?*
...
**Mean return gần như không ước lượng được từ lịch sử.** Ước lượng mean return $\mu$ từ $T$ năm dữ liệu có sai số chuẩn $\sigma/\sqrt{T}$ (dưới giả định iid; serial correlation, stochastic volatility và regime change làm long-run variance khác $\sigma^2$, nên đây là *xấp xỉ*, không phải giới hạn cứng tuyệt đối). Với $\sigma = 16\%$/năm: để SE tụt xuống $1.6\%$ (tức bằng một phần mười của vol) cần $\sigma/\sqrt{T} = 1.6\%$, tức $\sqrt{T} = 10 \Rightarrow T = 100$ **năm** dữ liệu. Kết luận gây sốc mà mọi người trong nghề thuộc lòng: **mean return gần như không ước lượng được từ lịch sử**; volatility và correlation thì ước lượng được tốt hơn — dù "tốt hơn" chỉ tương đối: sample correlation trong *chiều cao* (nghìn tài sản) rất bất ổn và trôi mạnh theo regime, nên nó không hề "dễ" như vol một chiều (đó là lý do cần shrinkage ở 3.4). Toàn bộ thiết kế của nghề xoay quanh sự thật này: đừng tin dự báo return của chính mình, hãy đa dạng hóa nó; nhưng risk model thì đáng tin hơn.

Vì sao mean khó mà vol dễ? Chỗ này đáng dẫn xuất kỹ vì nó là bất đối xứng nền tảng của toàn P-world. Giả sử ta có $n$ quan sát return trong một khoảng thời gian tổng cộng $T$ năm, lấy mẫu với tần suất $\Delta = T/n$ (năm). Ước lượng mean có sai số chuẩn $\sigma/\sqrt{T}$ — chú ý mẫu số là $\sqrt{T}$, **tổng độ dài lịch sử**, không phải $\sqrt{n}$. Lấy mẫu dày hơn (daily thay vì monthly) làm tăng $n$ nhưng $T$ không đổi, nên SE của mean **không giảm**. Trực giác (đúng cho *drift* / trung bình **log**-return, không phải trung bình cộng của simple return): tổng log-return telescope thành $\ln(P_T/P_0)$, chỉ phụ thuộc điểm đầu và cuối, nên trung bình của nó — ước lượng drift — thêm bao nhiêu điểm ở giữa cũng không cải thiện. (Trung bình *số học* của simple returns thì *có* phụ thuộc các điểm giữa; nhưng SE của nó vẫn cỡ $\sigma/\sqrt T$ dưới mô hình iid, vì phương sai vẫn bị chi phối bởi tổng độ dài $T$.) Ngược lại, ước lượng của $\sigma^2$ có sai số chuẩn cỡ $\sigma^2\sqrt{2/n}$ — mẫu số là $\sqrt{n}$, **số quan sát**. Lấy mẫu dày hơn tăng $n$ tuyến tính, nên vol ước lượng được ngày càng chính xác. Một minh họa để thấy khoảng cách: với 30 năm dữ liệu daily ($n \approx 7560$ phiên), SE của vol chỉ cỡ $\sigma^2\sqrt{2/7560}$, tức sai số tương đối của $\sigma$ khoảng $\sqrt{1/(2n)} \approx 0.8\%$ — *dưới giả định iid-Gaussian, vol hằng, không microstructure noise*. Cảnh báo tự nhất quán: thực tế vol trôi theo thời gian (chính cái clustering ở 3.5), nên 0.8% là chặn lý tưởng cho vol *trung bình*; vol *hiện tại* — cái ta thật sự cần — luôn kém chắc hơn. Trong khi đó mean của cùng dữ liệu ấy vẫn còn sai số $\pm 2.9\%$ trên nền chỉ $8\%$. Đây là toàn bộ lý do vì sao ta *dự báo* risk và *đa dạng hóa* return: một cái đo được, một cái gần như không.

Con số cụ thể để cảm nhận: S&P 500 có **mean total return** $\mu \approx 8\%$/năm, $\sigma \approx 16\%$/năm. (Đừng gọi $8\%$ là "equity premium": premium là phần *vượt* risk-free rate, tức $\mu - r_f$, thấp hơn — cỡ $4$–$6\%$ tùy thời kỳ; $8\%$ ở đây là total return danh nghĩa, không phải excess.) Với 30 năm dữ liệu — một sự nghiệp đầy đủ — SE của mean là $16\%/\sqrt{30} = 2.92\%$. Khoảng tin cậy 95% cho mean return là $8\% \pm 1.96 \times 2.92\% = 8\% \pm 5.7\%$, tức **từ khoảng 2.3% đến 13.7%** — *với điều kiện* mean và vol ổn định suốt 30 năm và quan sát năm gần iid (bản thân các điều kiện này đáng ngờ). Sau ba thập kỷ quan sát, ta vẫn không biết chắc mean là 3% hay 12% — chênh nhau bốn lần, đủ để đảo lộn mọi quyết định phân bổ vốn. Đây không phải khiếm khuyết của dữ liệu Mỹ; đây là giới hạn cứng của bài toán.

**Sai số của chính Sharpe ratio.** Ta không đo mean trần trụi mà đo Sharpe $SR = \mu_{\text{ex}}/\sigma$ (với $\mu_{\text{ex}}$ là *excess* mean trên risk-free, nhất quán định nghĩa Chương 2); sai số của nó cũng phải biết. Công thức Lo (2002) nên thuộc lòng:

$$SE(\widehat{SR}) \approx \sqrt{\frac{1 + SR^2/2}{T}}$$

trong đó $T$ và $SR$ phải **cùng tần suất**: $T$ = *số quan sát* ở tần suất mà Sharpe được đo. Ở đây ta dùng quan sát năm (nên $T$ = số năm) và $SR$ niên hóa — hợp lệ nhưng *bảo thủ*: số hạng $SR^2/2$ phản ánh bất định của $\hat\sigma$, mà bất định đó phụ thuộc *số quan sát*; nếu ước lượng vol từ dữ liệu daily (nhiều quan sát hơn 252 lần) thì phần này co lại mạnh, nên công thức "SR niên hóa, $T$ = năm" cho SE thiên về *lớn* (chặn trên). Dẫn xuất trực giác: $\widehat{SR}$ là hàm của $\hat\mu$ và $\hat\sigma$; áp delta method, phần $1/T$ đến từ noise của $\hat\mu$, phần $SR^2/(2T)$ từ noise của $\hat\sigma$. Chiến lược Sharpe 1.0 đo trên 5 quan sát năm: $SE = \sqrt{(1 + 0.5)/5} = \sqrt{0.30} = 0.55$ → khoảng tin cậy 95% (Wald, chỉ là *xấp xỉ asymptotic* — với 5 quan sát nó rất thô) là $1.0 \pm 1.96 \times 0.55 = 1.0 \pm 1.07$, tức **từ −0.07 đến 2.07**. Đọc lại lần nữa: sau 5 năm live tốt đẹp, dữ liệu vẫn chưa loại trừ được khả năng chiến lược vô giá trị. Đây là con số nên nhớ khi đọc pitch deck của bất kỳ quỹ nào, và là lý do allocator nhìn quy trình (process) nhiều hơn track record ngắn.

Đảo ngược cho ta một quy tắc thiết kế — nhưng phải cẩn thận dùng **đúng SE**. Để *kiểm định* giả thuyết "$\mu = 0$", ta cần SE **dưới null**, nơi $SR = 0$ nên số hạng $SR^2/2$ biến mất và $SE_0 = \sqrt{1/T}$; khi đó t-stat $= \widehat{SR}/SE_0 = \widehat{SR}\sqrt{T}$ (đúng bằng công thức của mục 3.2). Với Sharpe thực 1.0: cần $\sqrt{T} = 2 \Rightarrow T = 4$ năm. Với Sharpe 0.5: cần $0.5\sqrt{T} = 2 \Rightarrow T = 16$ năm. (Đừng cắm $SR^2/2$ tính tại *giá trị thực khác 0* vào bài toán significance — đó là SE của **khoảng tin cậy** quanh điểm ước lượng, không phải SE dưới null; lẫn hai cái là lý do một số tài liệu ra "6 năm / 18 năm" thay vì 4 / 16.) Một Sharpe khiêm tốn 0.5 — hoàn toàn đáng giao dịch, nhiều quỹ sống bằng nó — vẫn cần gần hai thập kỷ live mới đạt significance thống kê tiêu chuẩn. Nghề này chạy trên bằng chứng mỏng manh hơn bất kỳ ngành khoa học nào chấp nhận, và đó chính là vì sao kỷ luật quy trình quan trọng hơn kết quả.

## 3.2 Hypothesis testing và multiple testing — cái bẫy factor zoo

**Hypothesis testing và t-statistic.** Chiến lược có Sharpe $\widehat{SR}$ trên $T$ năm → t-stat $\approx \widehat{SR}\sqrt{T}$. Công thức này đến trực tiếp từ mục trước: t-stat là ước lượng chia cho sai số của nó, và với return IID zero-mean thì test "$\mu = 0$" quy về $\hat\mu/(\hat\sigma/\sqrt{T}) = \widehat{SR}\sqrt{T}$ — *chỉ đúng* khi $\widehat{SR}$ và $T$ cùng tần suất (ở đây Sharpe niên hóa, $T$ = số năm) và return **không** phụ thuộc chuỗi; có serial dependence thì phải hiệu chỉnh (Newey-West, mục 3.4). Sharpe 0.5 trên 4 năm: $t = 0.5\sqrt{4} = 1.0$ — hoàn toàn có thể là noise. Sharpe 1 cần $T = (2/1)^2 = 4$ năm để đạt $t \approx 2$. Nhưng — điểm chết người — ngưỡng $t = 2$ chỉ đúng khi bạn test **một** giả thuyết định trước.

Đây là chỗ trực giác của người mới sụp đổ. Thử 100 biến thể chiến lược rồi lấy cái đẹp nhất → kỳ vọng cái đẹp nhất có t ≈ 2.5 (và không hiếm khi vượt 3) **thuần túy do may mắn** (multiple testing). Ta có thể tính con số này. Nếu thử $N$ chiến lược độc lập, mỗi cái có t-stat rút từ phân phối chuẩn $N(0,1)$ (giả thuyết null: tất cả vô giá trị), thì kỳ vọng của giá trị lớn nhất trong $N$ mẫu chuẩn có số hạng dẫn đầu (leading-order) là $\sqrt{2\ln N}$. **Lưu ý đây chỉ là xấp xỉ tiệm cận và *phóng đại* ở $N$ nhỏ**: $\sqrt{2\ln 100} = 3.03$ nhưng kỳ vọng thực của max 100 mẫu chỉ $\approx 2.5$; $\sqrt{2\ln 20} = 2.45$ nhưng kỳ vọng thực $\approx 1.9$ (số hạng hiệu chỉnh $-\tfrac{\ln\ln N + \ln 4\pi}{2\sqrt{2\ln N}}$ kéo nó xuống đáng kể). Dù lấy con số đúng, thông điệp giữ nguyên: chỉ thử ~20 biến thể vô giá trị, cái tốt nhất đã kỳ vọng $t \approx 1.9$ và *thường xuyên* vượt 2 (xác suất max-of-20 vượt 1.96 là $\approx 40\%$) — số 0 trá hình. Đây là cỗ máy sản xuất alpha giả của cả ngành.

Harvey-Liu-Zhu (2016) khảo sát "factor zoo" học thuật — hàng trăm factor được công bố — và đề nghị ngưỡng **t > 3** cho khám phá mới. Cách họ ra ngưỡng đó *không* phải phép $\sqrt{2\ln N}$ đơn giản: họ áp các hiệu chỉnh multiple-testing đúng nghĩa (Bonferroni, Holm, BHY/false-discovery-rate) lên chính lịch sử phát hiện factor, có tính **correlation giữa các test** và **publication bias**. Con số $\sqrt{2\ln 90} = 3.00$ chỉ là một cách *đọc ngược* thô ("t>3 cỡ như trừ hao ~90 test độc lập"), một minh họa trực giác chứ không phải phương pháp của họ — và vì các test factor tương quan cao, "số test độc lập tương đương" thực tế khác xa số test thô. Phần định lượng đầy đủ — **deflated Sharpe ratio** — nằm ở **Chương 9** (không phải Chương 7). Lưu ý $SR_0 = \sqrt{2\ln N/T}$ chỉ là *ngưỡng do-may leading-order*, **không** phải DSR đầy đủ (DSR còn phụ thuộc variance giữa các trial, skewness, kurtosis và sampling distribution của Sharpe). Chương 9 cho con số vận hành: thử $N=1000$ cấu hình trên 10 năm → $SR_0 = \sqrt{2\ln 1000 / 10} = \sqrt{13.82/10} = 1.18$; nếu Sharpe quan sát chỉ 1.2 thì deflated Sharpe rơi về ~50% — nửa nửa là đồ giả.

Nguyên tắc văn hóa của các quỹ tốt rút ra từ toán này: **đếm mọi thí nghiệm, kể cả thất bại** — vì phân phối của "cái tốt nhất trong N lần thử" phụ thuộc N, và nếu không ghi lại N thì không cách nào deflate đúng. Một researcher thử 50 lookback windows trong đầu rồi báo cáo "cái 60 ngày cho Sharpe 1.3" đang tự lừa mình và lừa PM: cái tốt nhất trong 50 cửa sổ vô giá trị đã kỳ vọng $t$ cỡ $2.2$–$2.4$ (leading-order $\sqrt{2\ln 50} = 2.8$ là chặn trên), thừa sức trông "đẹp". Nhiều nơi nghiêm túc vì thế log số backtest chạy, và một số áp hẳn "budget" thí nghiệm cho mỗi ý tưởng — mức độ áp dụng khác nhau giữa các hãng, đây là thực hành được khuyến nghị hơn là một chuẩn phổ quát có nguồn.

## 3.3 Stationarity, spurious regression, và bộ đôi ADF/KPSS

**Stationarity.** Hai định nghĩa, đừng đảo quan hệ: **strict stationarity** = toàn bộ *phân phối* bất biến theo thời gian (điều kiện *mạnh*); **weak (covariance) stationarity** = chỉ mean, variance và autocovariance bất biến (điều kiện *yếu hơn*, và là định nghĩa làm việc thông dụng). Weak là *nới lỏng* của strict, không phải "phiên bản chính xác hơn". Giá thường KHÔNG dừng (random walk — variance nổ theo $t$); returns thường gần dừng — nhưng "thường" chứ không tuyệt đối: điều này phụ thuộc tài sản, phép biến đổi, mẫu và regime (một số spread/tỷ giá được neo, một số return có unit-root-gần trong vol). Đây không phải chi tiết kỹ thuật vụn: nó quyết định biến nào được phép đưa vào hồi quy. Cụ thể vì sao variance của giá "nổ": nếu $P_t = P_{t-1} + \epsilon_t$ với $\epsilon_t$ IID variance $\sigma^2$, thì $P_t = P_0 + \sum_{i=1}^{t}\epsilon_i$ có $\text{Var}(P_t) = t\sigma^2$ — lớn dần vô hạn theo $t$, không có mức cân bằng để "phân phối không đổi" bám vào. Return $\epsilon_t = P_t - P_{t-1}$ thì variance cố định $\sigma^2$ — dừng.

Vì sao giá không dừng lại nguy hiểm đến thế? Vì hồi quy hai chuỗi không dừng lên nhau → **spurious regression**: $R^2$ cao, t-stat đẹp, vô nghĩa hoàn toàn. Granger và Newbold (1974) đã cho chạy mô phỏng kinh điển: lấy hai random walk **hoàn toàn độc lập** (không có liên hệ nhân quả nào), hồi quy cái này lên cái kia. Với mẫu đủ dài (nghiên cứu gốc dùng chuỗi cỡ vài chục–vài trăm quan sát), kết quả điển hình: $R^2$ dễ đạt $0.2$–$0.3$ và t-stat của hệ số thường vượt 4, "significant" rực rỡ — trên hai chuỗi theo xây dựng chẳng liên quan gì nhau (các con số này phụ thuộc độ dài mẫu và thiết kế mô phỏng, tăng dần theo $T$). Lý do sâu: *inference* của OLS (công thức SE cổ điển) giả định residual dừng và IID; khi hồi quy hai I(1) không cointegrated, residual bản thân là I(1) (không dừng), mọi công thức SE sụp đổ, t-stat phân kỳ theo $\sqrt T$ thay vì hội tụ. Bạn càng có nhiều dữ liệu, "bằng chứng" giả càng mạnh — đúng ngược với trực giác.
...
Quy tắc thực dụng rút ra: **làm việc trên biến dừng (returns/spread), thận trọng khi hồi quy giá lên giá**. "Không bao giờ" là cách nói cho nhớ, không tuyệt đối: cointegration (mục 3.6) là ngoại lệ chính, nhưng còn có deterministic-trend models, error-correction frameworks, và các phép biến đổi khác (sai phân, detrend, fractional differencing) hợp lệ trên level — điểm cốt là phải *kiểm định* residual dừng, không phải cấm tiệt. Cách kiểm tra tính dừng bằng con số: hai kiểm định bổ sung nhau.

- **ADF (Augmented Dickey-Fuller)** — null là "có unit root / không dừng". Nó hồi quy $\Delta y_t = \phi\, y_{t-1} + \sum \delta_i \Delta y_{t-i} + \epsilon_t$ và test $\phi = 0$ (unit root). Nếu $\hat\phi$ đủ âm (giá kéo về mức cũ) → bác bỏ null → chuỗi dừng. Ví dụ (các con số phụ thuộc sample period, lag chọn và deterministic term, nên là *minh họa* chứ không phải hằng số): chạy ADF trên chuỗi giá SPY thô cho t-stat cỡ $-1$ tới $-2$ (không bác bỏ được → giá không dừng, đúng kỳ vọng); chạy trên chuỗi return cho t-stat rất âm, cỡ $-20$ trở xuống (bác mạnh → return dừng). Chú ý phân phối của thống kê ADF **không** phải Student-t chuẩn — nó là phân phối Dickey-Fuller lệch trái, nên giá trị tới hạn 5% không phải $-1.96$ mà cỡ $-2.86$ (có hằng số); dùng nhầm ngưỡng t thường sẽ bác bỏ null quá dễ.
- **KPSS** — null **ngược lại**: "chuỗi dừng". Dùng ADF và KPSS **cùng nhau** là thực hành chuẩn vì chúng đặt cược ngược nhau, giúp tránh kết luận sai do power thấp. Bốn khả năng (diễn giải mang tính hướng dẫn, không phải phán quyết chắc chắn — kết quả còn nhiễu vì lag sai, deterministic term sai, size distortion, heteroskedasticity, hay nonlinear dynamics): ADF bác + KPSS không bác → nghiêng về dừng; ADF không bác + KPSS bác → nghiêng về không dừng; cả hai không bác → dữ liệu chưa đủ để kết luận; cả hai bác → có thể fractional integration hoặc structural break, cần đào sâu (fracdiff, chương 10). Bộ đôi này trong repo là module `stationarity` (`adfTest`, `kpssTest`).

Một tinh tế thực chiến: nhiều chuỗi hữu ích ở lưng chừng — không hẳn I(1) như giá, không hẳn I(0) như return. Dividend yield, credit spread, term spread, thậm chí vol, có memory rất dài (near-unit-root). Fractional differencing (chương 10) sinh ra chính để *đánh đổi* giữa giữ memory dự báo và ép chuỗi về dừng — nhưng nó không **bảo đảm** đạt cả hai: kết quả phụ thuộc việc chọn bậc $d$ và phải *kiểm định lại tính dừng sau biến đổi* (một $d$ quá nhỏ vẫn để chuỗi non-stationary, quá lớn thì mất tín hiệu). Đó là câu trả lời hiện đại cho căng thẳng "dừng để hồi quy đúng" chọi "đừng dừng quá tay mà mất tín hiệu", không phải một nút bấm tự động.

## 3.4 Hồi quy tuyến tính — con ngựa thồ và các chỗ gãy

OLS: $y = X\beta + \epsilon$, $\hat\beta = (X^\top X)^{-1}X^\top y$. Công thức này là chiếc búa mà mọi quant cầm suốt ngày. Trong nghề, hồi quy dùng cho: ước lượng beta/factor exposure, kiểm tra alpha ("hồi quy return chiến lược lên các factor đã biết — phần chặn còn sống không?"), neutralize tín hiệu, và là baseline của mọi mô hình dự báo. Một kinh nghiệm phổ biến đáng in đậm (heuristic, không phải định lý): **trên dữ liệu ít và nhiễu như tài chính, mô hình tuyến tính + feature tốt thường đánh bại mô hình phức tạp + feature tồi.** Đây là quy tắc ngón tay cái đã cứu nhiều người, không phải chân lý thống kê phổ quát — có bài toán (phi tuyến mạnh, đủ dữ liệu) mô hình phức tạp thắng rõ. Người mới muốn nhảy ngay vào gradient boosting; người có kinh nghiệm biết phần lớn giá trị thường nằm ở chọn đúng biến và xử lý đúng các chỗ gãy dưới đây.
...
| Cross-sectional correlation (mọi cổ phiếu cùng nhảy theo market) | "N = 3000 cổ phiếu" thực ra N hiệu dụng ~ vài chục | Clustered SE theo ngày; Fama-MacBeth (chương 6.1) |

Bảng này liệt các chỗ gãy của *inference* khi giả định phụ (homoskedastic/iid residual) bị vi phạm — nhưng nó **bỏ qua điều kiện trung tâm nhất** để bản thân $\hat\beta$ không thiên lệch: **exogeneity / conditional mean zero** ($\mathbb{E}[\epsilon\mid X] = 0$). Omitted-variable bias, simultaneity/endogeneity, measurement error (errors-in-variables) và selection bias phá đúng điều kiện này và làm $\hat\beta$ *sai lệch* chứ không chỉ SE sai — nguy hiểm hơn mọi dòng trong bảng, và không robust SE nào cứu được. Dưới đây lấy ba chỗ gãy của *inference* để cảm nhận *giá bằng con số*, nhưng luôn nhớ exogeneity đứng trên tất cả.

**Heteroskedasticity và White SE.** Return tài chính có vol clustering — variance của residual không hằng số mà co giãn theo regime. OLS vẫn cho $\hat\beta$ không thiên lệch *miễn là exogeneity giữ* (heteroskedasticity một mình không gây bias; thiếu exogeneity mới gây), nhưng công thức SE cổ điển $\hat\sigma^2(X^\top X)^{-1}$ giả định variance đồng đều nên sai. Giá của việc bỏ qua bằng con số: hình dung ước lượng beta của một cổ phiếu, nửa mẫu bình lặng (vol 10%/năm) và nửa kia khủng hoảng (vol 40%/năm — variance gấp 16 lần). Lưu ý $X^\top X$ chỉ phụ thuộc *regressors*, không phụ thuộc residual — cái đúng là những ngày khủng hoảng có residual khổng lồ nên đóng góp lệch vào ước lượng *variance của $\hat\beta$* (qua $\sum \hat\epsilon_t^2 x_t x_t^\top$), khiến SE cổ điển "bình quân hóa" sai. Trong các cấu trúc như thế t-stat có thể lệch đáng kể (một ví dụ minh họa cho lệch cỡ hàng chục phần trăm, không phải quy luật cố định). White (heteroskedasticity-consistent) SE dùng $\widehat{\text{Var}}(\hat\beta) = (X^\top X)^{-1}\big(\sum_t \hat\epsilon_t^2 x_t x_t^\top\big)(X^\top X)^{-1}$, để mỗi quan sát đóng góp đúng độ nhiễu của nó. Nó là mặc định hợp lý cho hồi quy tài chính — gần như không mất gì; lưu ý robust SE *không phải luôn lớn hơn* SE cổ điển (nó có thể nhỏ hơn), nó chỉ *đúng hơn* dưới heteroskedasticity.

**Newey-West và cái bẫy overlapping returns.** Giả sử ta dự báo return 21 ngày (một tháng) bằng dữ liệu daily, dùng cửa sổ trượt chồng lấn — mỗi ngày một quan sát, nhưng return 21 ngày của hôm nay và hôm qua chia sẻ 20 ngày chung. Residual của các quan sát liền kề tương quan cao; số quan sát *độc lập* xấp xỉ tổng số ngày chia 21. Trong **cấu trúc overlapping-sum lý tưởng**, OLS ngây thơ phóng đại bậc tự do lên ~21 lần → SE bị chia cho $\sqrt{21} \approx 4.58$ → **t-stat phồng ~4.6 lần**. (Hệ số $\sqrt{21}$ này là *trần lý tưởng* — predictive regression thật với forward return 21 ngày hiếm khi phồng đúng $\sqrt{21}$, tùy cấu trúc phụ thuộc thực tế.) Đây là nguồn "t-stat 8" ảo phổ biến trong paper alpha: một tín hiệu t-stat thật cỡ $8/\sqrt{21} \approx 1.75$ hiện lên thành 8. Newey-West sửa bằng cách ước lượng hiệp phương sai có tính autocorrelation tới một số lag. Một quy tắc ngón tay cái *thường dùng* (không phải chuẩn phổ quát): **lag ≈ 1.5 × độ dài chồng lấn** → lag $\approx 32$; các quy tắc khác ($T^{1/3}$, Newey-West 1994 data-driven) cũng phổ biến. Với ví dụ trên, Newey-West kéo t-stat 8 *xuống gần* mức thật ~1.75 — con số chính xác phụ thuộc residual covariance, kernel và bandwidth, nên đừng kỳ vọng nó rơi đúng 1.75. Quên Newey-West với overlapping returns là lỗi số một khiến backtest paper không sống được ngoài đời.

**Cross-sectional correlation và N hiệu dụng.** Khi hồi quy cross-section (một ngày, nhiều cổ phiếu) lặp qua nhiều ngày — đừng pool tất cả vào một OLS khổng lồ. Vì trong cùng một ngày, 3000 cổ phiếu không phải 3000 quan sát độc lập: chúng cùng nhảy theo market, theo sector, theo vài factor chung. N hiệu dụng thực ra chỉ cỡ vài chục "chiều" độc lập; nếu correlation trung bình giữa các cổ phiếu trong ngày là $\rho \approx 0.3$, số quan sát hiệu dụng gần với $1/\rho \approx 3$ tới vài chục "khối" độc lập chứ không phải 3000. Pool tất cả → SE bị đánh giá thấp thảm hại → t-stat ảo lần nữa. Cách chuẩn của toàn ngành: chạy **từng ngày một rồi lấy trung bình và SE của chuỗi hệ số theo ngày** — đây là **Fama-MacBeth** (chi tiết chương 6.1). Cụ thể: mỗi ngày $t$ hồi quy return cross-section lên factor exposure, thu được một $\hat\beta_t$; rồi ước lượng premium là $\bar\beta = \frac{1}{T}\sum_t \hat\beta_t$ với SE $= \text{std}(\hat\beta_t)/\sqrt{T}$. Cách này xử lý *cross-sectional* correlation trong ngày (mỗi ngày chỉ đóng góp *một* con số, correlation giữa cổ phiếu đã bị "nuốt" vào $\hat\beta_t$). Nhưng đừng coi nó là thuốc chữa bách bệnh: SE $= \text{std}(\hat\beta_t)/\sqrt{T}$ vẫn giả định *chuỗi $\hat\beta_t$ theo thời gian không autocorrelated* (nếu có, phải Newey-West trên chuỗi này); và Fama-MacBeth vẫn chịu **first-stage estimation error / errors-in-variables** (betas ở bước một là ước lượng nhiễu), time-series dependence của premia, và cần **Shanken correction** khi factor loadings được ước lượng.

**Shrinkage — tư tưởng thống kê quan trọng nhất P-world.** Với dữ liệu ít/nhiễu, ước lượng "kéo về prior" (Ridge/Lasso/Bayes/Ledoit-Wolf) *thường* thắng ước lượng "trung thực" (OLS/sample covariance). Có một *hạt nhân* là định lý — nhưng đừng phóng đại nó: **James-Stein (1961)** chứng minh, **dưới squared-error loss và mô hình Gaussian với variance biết trước**, rằng khi ước lượng $k \geq 3$ means đồng thời, một ước lượng shrink dominate ước lượng sample-mean (expected risk nhỏ hơn với *mọi* giá trị thật). Đây là kết quả tồn-tại chặt cho một setup *cụ thể*; nó **không** tự động suy ra "mọi Ridge/Lasso/Bayes/Ledoit-Wolf gần như luôn thắng" dưới mọi loss và mọi phân phối — cái đó là heuristic được cổ vũ bởi tinh thần JS, không phải hệ quả của định lý. Dạng shrink phụ thuộc *target*: về một target **cố định** (gốc 0) thì hệ số là $(k-2)$; về **sample grand mean** $\bar\mu$ (một tham số *được ước lượng*) thì mất thêm một bậc tự do, thành $(k-3)$:

$$\hat\mu_i^{JS} = \bar\mu + \left(1 - \frac{(k-3)\sigma^2}{\|\hat\mu - \bar\mu\|^2}\right)(\hat\mu_i - \bar\mu)$$

kéo mỗi ước lượng về trung bình chung $\bar\mu$ với lực mạnh khi noise $\sigma^2$ lớn so với độ tán $\|\hat\mu - \bar\mu\|^2$. (Dùng $(k-2)$ với target $\bar\mu$ là trộn hai phiên bản.)

Con số minh họa sức mạnh, tính từng bước để thấy nó là số học. Ta ước lượng expected return của $k = 10$ chiến lược; giá trị **thật** của cả 10 đều là $5\%$/năm, do noise (SE mỗi ước lượng $\sigma = 2\%$/năm) các sample means rơi rải đều từ $1\%$ đến $9\%$, trung bình chung $\bar\mu = 5\%$. Độ tán $\|\hat\mu - \bar\mu\|^2 = \sum(\hat\mu_i - 5)^2 = (4^2 + 3^2 + 2^2 + 1^2 + 0 + 0 + 1^2 + 2^2 + 3^2 + 4^2) = 60$ ($\%^2$). Hệ số shrink (target = grand mean, dùng $k-3$): $1 - (k-3)\sigma^2/60 = 1 - 7 \times 4/60 = 1 - 0.467 = 0.533$. Mỗi ước lượng bị kéo **47% quãng đường** về $5\%$: 'tốt nhất' $9\%$ hạ xuống $5 + 0.533 \times 4 = 7.13\%$; 'tệ nhất' $1\%$ nâng lên $5 - 0.533 \times 4 = 2.87\%$. SSE với giá trị thật: raw $= 60$; shrunk $= 0.533^2 \times 60 = 17.1$ → cắt **~72%** sai số. **Cảnh báo diễn giải:** ví dụ này được dựng *thuận lợi* — sample grand mean ($5\%$) tình cờ trùng đúng true mean ($5\%$), nên shrink về nó gần như hoàn hảo. Định lý James-Stein nói về **expected risk trung bình qua nhiều mẫu**, không phải bảo đảm cho một mẫu cụ thể; khi grand mean lệch true mean (trường hợp thường gặp), lợi ích nhỏ hơn và một mẫu đơn lẻ đôi khi tệ hơn. Con số 72% ở đây là kịch bản thuận, không phải mức điển hình. Điều đắt giá: nó cắt đúng cái chiến lược "tốt nhất" mà một PM ngây thơ sẽ đổ hết vốn vào. Trong covariance, Ledoit-Wolf shrink sample covariance về một target có cấu trúc (thường là constant-correlation hoặc identity scaled) — chương 5 cho thấy điều này biến một ma trận không khả nghịch/bất ổn thành thứ dùng được cho mean-variance optimization. Nghề này về bản chất là nghệ thuật shrinkage: **tin dữ liệu ít thôi, tin structure nhiều hơn** — hệ quả trực tiếp của mục 3.1 (mean gần như không đo được, nên đừng để optimizer tin quá vào ước lượng mean thô).

## 3.5 Time series models: ARMA, GARCH, và realized volatility

**ARMA.** AR($p$) — return phụ thuộc chính nó trễ $p$ bước; MA($q$) — phụ thuộc shock cũ. Sự thật thực dụng cần nói thẳng để người mới không phí thời gian: ARMA trên returns daily gần như **không có gì để bắt** (autocorrelation ~0, đây là stylized fact — return khó dự báо ở first moment). Một con số để đóng đinh điều này (điển hình, tùy mẫu/định nghĩa return/estimator): autocorrelation bậc 1 của daily return S&P 500 cỡ $\rho_1 \approx -0.02$ tới $0.03$; SE $\approx 1/\sqrt{T}$ **chỉ là xấp xỉ dưới null white-noise** (Bartlett) — với $T = 2500$ ngày là $0.02$, nên $\rho_1 = 0.03$ cho t-stat $\approx 1.5$, không phân biệt được với 0. Đúng cho *return* vì return ~ white noise ở first moment; nhưng **không** được bê SE $1/\sqrt T$ đó sang $r_t^2$: $r_t^2$ *có* dependence mạnh nên SE thật của autocorrelation của nó lớn hơn $1/\sqrt T$ (cần Bartlett-corrected SE). May là autocorrelation của $r_t^2$ lớn đến mức vẫn significant áp đảo dù hiệu chỉnh: $\rho_1$ của $r_t^2$ (proxy cho vol) thường $0.2$–$0.3$ — tín hiệu thật, dày đặc, nơi AR bắt được. Giá trị thật của ARMA vì thế không nằm ở dự báo mean return, mà ở làm nền cho residual analysis và mô hình hóa các chuỗi *có* cấu trúc thật — vol, volume, spread, order flow imbalance.
...
"Vol hôm nay = nền + cú sốc hôm qua + quán tính vol hôm qua". (Nói chặt, số hạng cú sốc là **squared innovation** $\epsilon_{t-1}^2$ với $\epsilon_t = r_t - \mathbb{E}[r_t\mid \mathcal F_{t-1}]$; ta viết $r_{t-1}^2$ vì với daily return conditional mean $\approx 0$ nên $\epsilon \approx r$ — nhưng ở tần suất/tài sản có mean đáng kể thì phải trừ mean trước.) Đọc kỹ ba số hạng: $\omega$ là mức vol nền dài hạn; $\alpha$ là mức độ vol phản ứng với cú sốc mới nhất; $\beta$ là quán tính — vol hôm nay thừa hưởng bao nhiêu từ vol hôm qua. Điển hình $\alpha \approx 0.08, \beta \approx 0.9$; tổng $\alpha + \beta \to 1$ nghĩa là vol rất dai (persistent). Biến thể có leverage effect: GJR-GARCH, EGARCH nắm bắt việc **shock âm (thị trường rơi) làm vol tăng mạnh hơn shock dương cùng độ lớn** — một stylized fact rõ rệt của equity. (Bản thân GJR/EGARCH chỉ *mô tả* bất đối xứng qua một tham số; câu "panic bán tháo đẩy vol lên" là một *diễn giải hành vi* khả dĩ — cùng hiện tượng còn được giải thích bằng đòn bẩy tài chính cơ học hay volatility feedback — mô hình không tự nói cơ chế nào đúng.) Dùng làm gì trong thực tế: vol forecast cho **vol targeting** (chương 14 — điều chỉnh đòn bẩy để giữ vol danh mục cố định), chuẩn hóa returns (return/σ — "de-GARCHing" trước khi phân tích để tách tín hiệu khỏi nhịp thở vol), và VaR.
...
- **Cú sốc phai nhanh thế nào.** Độ lệch của *conditional-variance forecast* khỏi mức dài hạn phai với tốc độ $(\alpha+\beta)^n = 0.98^n$ mỗi ngày. Half-life $= \ln 0.5/\ln 0.98 \approx 34$ ngày phiên. (Chính xác thì đây là half-life của độ lệch *dự báo phương sai có điều kiện*, không hẳn của bản thân volatility — vol là căn của nó nên phai với nhịp hơi khác; nhưng cùng bậc độ lớn "dai hơn một tháng".) Đó là "clustering" được định lượng: sau một tuần biến động lớn, vol vẫn còn cao đáng kể suốt tháng sau. Half-life dài gợi ý *nên* điều chỉnh thường xuyên hơn quý — nhưng tần suất rebalance tối ưu của vol targeting **không** suy ra chỉ từ half-life: nó cân half-life với turnover, transaction cost, độ trễ forecast và mandate (chương 14). "Theo tuần" là một lựa chọn hợp lý phổ biến, không phải hệ quả toán học của con số 34.

**Đối thủ hiện đại: realized volatility và HAR.** GARCH ước lượng vol từ *một* quan sát return mỗi ngày (return bình phương là proxy rất nhiễu cho vol thật của ngày đó). Khi có dữ liệu intraday, ta làm tốt hơn nhiều: $RV_t = \sum_{i} r_{t,i}^2$ — tổng bình phương của, chẳng hạn, 78 return 5-phút trong ngày (6.5 giờ × 12 khoảng/giờ = 78). Gọi cho đúng: $RV_t$ là **realized *variance*** (ước lượng của $\sigma^2$); realized *volatility* là $\sqrt{RV_t}$ — đừng lẫn hai cái. Và $RV$ open-to-close *bỏ qua overnight return* (khoảng nghỉ đóng–mở cửa), nên nó là vol của phiên giao dịch, không phải của trọn 24 giờ; muốn "vol cả ngày" phải cộng riêng phần overnight. Trực giác về độ lợi: proxy "daily squared return" chỉ dùng **một** con số nên sai số khổng lồ; RV cộng dồn nhiều mẩu trong ngày. Con số $\sqrt{1/78}$ hay được trích như mức giảm sai số **chỉ đúng dưới giả định 78 return intraday là iid** — thực tế intraday seasonality (chữ U), jumps, bid–ask bounce và microstructure noise phá vỡ giả định đó, nên độ lợi thực nhỏ hơn $1/\sqrt{78}$ (và cần các estimator chịu-noise như realized kernel/pre-averaging). Dù vậy RV vẫn chính xác hơn daily squared return *nhiều bậc*. Mô hình **HAR (Heterogeneous AutoRegressive, Corsi 2009)** dự báo RV ngày mai bằng trung bình RV của ba tầm nhìn — ngày qua, tuần qua, tháng qua:

$$RV_{t+1} = c + \beta_d\, RV_t + \beta_w\, \overline{RV}_t^{(5)} + \beta_m\, \overline{RV}_t^{(22)} + \epsilon_t$$

trong đó $\overline{RV}^{(5)}$ và $\overline{RV}^{(22)}$ là RV trung bình 5 và 22 ngày. Ba tầm nhìn này được *motivate* bằng cách hình dung ba loại người chơi (day trader, swing, đầu tư dài) tạo vol ở ba nhịp — nhưng đó là *câu chuyện diễn giải* của mô hình heterogeneous-market, không phải một cơ chế đã được chứng minh thực nghiệm rằng ba hệ số ứng đúng ba nhóm đó. HAR chỉ là một OLS ba biến — đơn giản đến khiêm tốn — nhưng trong **nhiều nghiên cứu, với dữ liệu intraday, HAR dự báo RV tốt hơn GARCH** (kết quả cụ thể tùy asset, horizon, loss function và biến thể GARCH so sánh — không phải "luôn thắng"), vì input của nó (RV) ít nhiễu hơn hẳn return bình phương. Bài học nghề lặp lại chủ đề mục 3.4: một OLS đơn giản trên feature tốt (RV) thắng một mô hình tinh vi (GARCH) trên feature tồi (daily squared return).

## 3.6 Cointegration, Ornstein-Uhlenbeck, và half-life — nền của pairs trading

**Cointegration — nền của pairs trading.** Ở mục 3.3 ta thề không bao giờ hồi quy giá lên giá. Cointegration là ngoại lệ duy nhất, và nó là ngoại lệ quý giá nhất trong toàn P-world. Hai chuỗi giá không dừng $X, Y$ gọi là cointegrated nếu tồn tại tổ hợp $Y - \gamma X$ **dừng** — hình dung hai con thuyền neo chung một mỏ neo dưới đáy, mỗi con dập dềnh theo sóng riêng (mỗi giá là I(1), lang thang không giới hạn) nhưng khoảng cách giữa chúng bị kéo về mức cũ (spread dừng, I(0)). Coca-Cola và Pepsi là một *cặp ứng viên* (cùng ngành gợi ý khả năng cointegrated, nhưng đó là **giả thuyết phải kiểm định**, không phải hệ quả tất yếu của việc cùng ngành — nhiều cặp cùng ngành *không* cointegrated); những cặp neo chung *đáng tin* nhất là loại có ràng buộc cơ học: hai class share của cùng công ty, hay một ETF và rổ cấu thành của nó.

**Engle-Granger 2 bước** — recipe cụ thể làm lại được:
1. Hồi quy $Y$ lên $X$ (OLS trên level) lấy $\hat\gamma$ — đây là hedge ratio. Phải khai báo rõ **intercept/trend** trong hồi quy này (có hằng số? có trend?), vì lựa chọn đó ảnh hưởng residual, hedge ratio *và* bảng critical values ở bước 2. Lưu ý: đây chính là hồi quy giá-lên-giá mà ta cấm ở 3.3; nó *chỉ* hợp lệ nếu bước 2 xác nhận residual dừng.
2. Test ADF trên residual $\hat u_t = Y_t - \hat\gamma X_t$. **Cảnh báo quan trọng:** vì $\hat u_t$ dùng $\hat\gamma$ *đã ước lượng ở bước 1*, phân phối của thống kê **không** phải phân phối ADF thông thường — phải dùng **critical values Engle-Granger/MacKinnon riêng** (gắt hơn ADF chuẩn, và phụ thuộc số regressor lẫn deterministic term). Dùng nhầm ngưỡng ADF thường sẽ kết luận cointegration quá dễ. Nếu bác được null unit root → residual dừng → cặp **cointegrated**; nếu không → hai random walk tình cờ, hồi quy bước 1 là spurious, vứt.

(Với nhiều chuỗi thì Engle-Granger không đủ — cần Johansen, mục 3.8.)

Một khi có spread dừng, ta *thường chọn* mô hình hóa động học của nó bằng **Ornstein-Uhlenbeck** (gặp lại từ cuốn Q — cùng quá trình mean-reverting ở short rate models). Lưu ý đây là một *lựa chọn mô hình*, không phải hệ quả: cointegration chỉ bảo đảm *tồn tại một tổ hợp dừng*, nó **không** bảo đảm spread tuân theo OU (spread thật có thể có mean-reversion phi tuyến, vol thay đổi, hay memory dài hơn AR(1)). OU là xấp xỉ bậc một tiện dụng:

$$ds = \kappa(\mu - s)\,dt + \sigma\, dW$$

$\kappa$ là tốc độ kéo về (mean-reversion speed): spread lệch khỏi $\mu$ càng xa, lực kéo về càng mạnh, tỷ lệ với $\kappa$. Từ $\kappa$ ta suy ra đại lượng quan trọng nhất của trò chơi — **half-life** $= \ln 2/\kappa$: spread lệch bao lâu thì về được nửa đường. Half-life quyết định holding period và độ "trade được" của cặp. Ước lượng $\kappa$ trong thực tế: hồi quy $\Delta s_t = a + b\, s_{t-1} + \epsilon_t$ (một AR(1) trên spread) rồi $\kappa \approx -b$. Cẩn thận: đây là **xấp xỉ Euler**, không phải đẳng thức chính xác. Quan hệ *exact* giữa AR(1) $s_t = c + (1+b)s_{t-1} + \dots$ và OU là $1 + b = e^{-\kappa\Delta t}$, tức $\kappa = -\ln(1+b)/\Delta t$; chỉ khi $|b|$ nhỏ thì $\ln(1+b) \approx b$ và $\kappa \approx -b$. Với half-life dài (b nhỏ) sai lệch không đáng kể, nhưng với mean-reversion nhanh (b khá âm) nên dùng công thức log exact.

**Half-life OU bằng số và quy tắc trade từ nó.** Fit spread một cặp cổ phiếu được $\kappa = 0.05$/ngày → half-life $= \ln 2/0.05 \approx 14$ ngày. Giả sử spread có **độ lệch chuẩn cân bằng** (stationary std) $\sigma_{\text{eq}} = 2.4\%$ — chú ý đây *không* phải $\sigma$ (diffusion coefficient) trong SDE OU ở trên; hai đại lượng liên hệ qua $\sigma_{\text{eq}} = \sigma/\sqrt{2\kappa}$, và cái dùng để tính z-score là $\sigma_{\text{eq}}$. Các ngưỡng dưới đây là **quy ước desk stat-arb** (heuristic được dùng rộng rãi, *không* có nền tảng tối ưu-hóa chặt chẽ — mức tối ưu phụ thuộc chi phí, half-life và phân phối spread cụ thể):
...
- **Kỳ vọng giữ ~1–2 half-life (2–4 tuần)** rồi spread về gần 0. Cụ thể: half-life là thời gian để *kỳ vọng* độ lệch giảm một nửa — $\mathbb{E}[s]$ đi từ z=2 về z=1 sau ~14 ngày, về z=0.5 sau ~14 ngày nữa. Nhấn mạnh **kỳ vọng**: đây là trung bình theo lý thuyết OU, *không* bảo đảm một đường đi cụ thể chạm z=1 hay z=0 đúng lịch — đường thực dao động quanh kỳ vọng đó (thậm chí lệch xa hơn trước khi về), nên "1–2 half-life" là *thang thời gian trung bình*, không phải cam kết.
...
**Half-life là bộ lọc đầu tiên của mọi pipeline pairs.** Half-life 100+ ngày → vốn bị giam quá lâu, mỗi vòng quay vốn kéo dài nửa năm, Sharpe/vốn tệ, bỏ. Half-life 1–2 ngày → tín hiệu đảo nhanh, turnover cao nên chi phí giao dịch *có nguy cơ* ăn hết biên lợi nhuận — nhưng không tự động: điều đó còn tùy biên độ spread, liquidity và execution (một spread rất rộng vẫn có thể lãi dù half-life ngắn). Vùng "ngọt" ~5–30 ngày là quy ước kinh nghiệm, không phải ngưỡng cứng. Trước khi tính bất cứ điều gì khác, desk lọc universe cặp qua half-life — nó rẻ để tính và loại ngay phần lớn rác.

**Cảnh báo nghề — cointegration gãy được.** Đây không phải rủi ro lý thuyết: nó là DNA của thảm họa. Tháng 8/2007, "quant quake" xảy ra khi nhiều quỹ *quant/stat-arb* cùng nắm những vị thế tương quan cao, một (vài) quỹ lớn bị buộc deleveraging, và các vị thế mọi người tưởng sẽ hội tụ lại **cùng đi ngược đồng loạt**. Nói chính xác: đây là hiện tượng **crowded factor/strategy deleveraging** ở diện rộng (nhiều loại tín hiệu quant, không chỉ các cặp cointegrated), chứ không đơn thuần là "các cặp cointegrated đồng loạt gãy" — đừng thu hẹp một cú sốc thanh khoản toàn ngành thành một câu chuyện pairs. Bài học vẫn đúng: những vị thế "giống nhau" hết giống trong vài ngày không vì fundamental mà vì cấu trúc sở hữu (ai bị ép bán) thay đổi. Mọi hệ stat-arb thật vì thế có cơ chế phát hiện break — nhưng lưu ý giới hạn công cụ: **rolling cointegration test không trực tiếp "chứng minh" cointegration đã gãy** (rolling ADF power thấp trên cửa sổ ngắn và tạo nhiều test tuần tự, dễ báo động giả); nó là *một* tín hiệu cần kết hợp với structural break tests (chương 4) và giám sát crowding (spread giãn *đồng loạt* trên nhiều cặp là dấu hiệu deleveraging của cả đám, không phải cơ hội).
...
**Kalman filter** giải bài toán này *tối ưu trong phạm vi cụ thể*: nó là bộ lọc **tuyến tính** MMSE nói chung, và là **posterior chính xác / tối ưu toàn cục chỉ khi mô hình linear-Gaussian**. Ngoài phạm vi đó (phi tuyến, nhiễu không Gaussian) nó chỉ còn là xấp xỉ tuyến tính tốt nhất, không phải "lời giải tối ưu" theo nghĩa rộng — cần EKF/UKF/particle filter. Mỗi bước gồm hai pha — *predict* và *update*. Viết cho trường hợp một chiều quen nhất — **hedge ratio động** (state $\gamma_t$, quan sát $Y_t = \gamma_t X_t + \epsilon_t$, lấy $F=1$ nên state đi random walk). **Cảnh báo:** mô hình này bỏ intercept và tự nó *không thiết lập cointegration* — nếu $X, Y$ không cointegrated, filter vẫn "bám" rất đẹp một quan hệ **spurious** giữa hai price level đang trôi. Kalman làm hedge ratio *thích nghi*, nó không thay cho bước kiểm định cointegration ở 3.6:
...
Đọc bằng lời: mỗi ngày, niềm tin về hedge ratio được kéo về phía bằng chứng mới với trọng số $K_t$ — tự động **lớn** khi mình không chắc ($P$ lớn) và **nhỏ** khi quan sát nhiễu ($R$ lớn). Số hạng $Y_t - \hat\gamma_{t|t-1}X_t$ là **innovation** — phần bất ngờ, chênh giữa quan sát thực và dự đoán; toàn bộ việc học nằm ở đây. Tỷ lệ $Q/R$ đóng vai "tốc độ quên": $Q$ lớn (cho phép state trôi nhanh) → filter phản ứng nhanh, bám dữ liệu gần, quên quá khứ mau — như half-life của EWMA, nhưng có khung xác suất đầy đủ (variance $P_t$ đi kèm miễn phí). Lưu ý $Q/R$ **không phải một hằng số vô đơn vị bất biến**: ý nghĩa của nó phụ thuộc scale của state, của observation matrix $H_t$ và đơn vị dữ liệu — đổi đơn vị (ví dụ giá từ đô sang cent) làm đổi con số $Q/R$ cần thiết dù bài toán kinh tế y hệt, nên phải chuẩn hóa/tinh chỉnh $Q,R$ theo dữ liệu cụ thể chứ đừng bê một tỷ lệ "magic" từ bài toán khác.
...
Đọc kết quả: một quan sát kéo hedge ratio từ 1.50 lên 1.58 — gần như nhảy hẳn tới giá trị innovation gợi ý ($2.4/30 = 0.08$), vì $K_t X_t = 0.9956 \approx 1$. Cẩn thận diễn giải "$X_t = 30$ lớn nên quan sát nhiều thông tin": thông tin **không** đến từ độ lớn *tuyệt đối* của $X$ (đó phụ thuộc đơn vị — đổi giá từ đô sang cent làm $X$ gấp 100 nhưng không làm dữ liệu giàu thông tin hơn, vì $R$ cũng đổi theo bình phương đơn vị). Cái quyết định là **tỷ số tín hiệu/nhiễu vô đơn vị** $X_t^2 P/(X_t^2 P + R)$; ở ví dụ này nó gần 1 vì SNR cao *tương đối với* $R$, không vì "30 to". Variance co mạnh (0.0101 → $4.4\times10^{-5}$). Ngày mai variance lại nở thêm $Q$ — khe hở này giữ filter không "đóng băng" niềm tin. So với rolling OLS 60 ngày, Kalman quên **mượt** và cho thanh sai số $\sqrt{P_t} \approx 0.0066$. Nhưng đừng dùng $\sqrt{P_t}$ như thước đo *trực tiếp và duy nhất* để size vị thế: nó chỉ là bất định của $\gamma$ **có điều kiện $Q, R$ đúng**, và bỏ qua observation noise, spread risk, covariance giữa hai chân, cùng chính bất định trong $Q, R$ (vốn phải được ước lượng). Nó là *một* đầu vào cho sizing, không phải toàn bộ. Trong repo, đây là module `kalman`, chuẩn trong pairs hiện đại và nowcasting.

## 3.8 Nhiều biến: VECM và Johansen

Engle-Granger (mục 3.6) *có thể* chạy với nhiều regressor (hồi quy $Y$ lên nhiều $X$), nhưng dù vậy nó chỉ **xác định được một** quan hệ cointegration và vẫn vướng ba giới hạn khi lên nhiều chuỗi: (1) bất đối xứng — hồi quy $Y$ lên $X$ cho hedge ratio khác với hồi quy $X$ lên $Y$; (2) với $n$ chuỗi có thể có tới $n-1$ quan hệ cointegration độc lập, Engle-Granger chỉ bắt được một; (3) test tuần tự (hồi quy rồi test residual), power kém. Khi ta có một rổ — cả đường cong lãi suất (nhiều kỳ hạn cointegrated), một nhóm cổ phiếu cùng ngành, một basket ETF/cấu thành — cần công cụ đa biến đúng nghĩa.
...
$$\Delta \mathbf{y}_t = \Pi\,\mathbf{y}_{t-1} + \sum_{i=1}^{k}\Gamma_i\,\Delta\mathbf{y}_{t-i} + \mathbf{d}_t + \boldsymbol\epsilon_t$$

(ở đây $\mathbf{d}_t$ gộp các **deterministic terms** — intercept, restricted intercept, trend — mà bản viết gọn hay bỏ; đừng bỏ trong thực hành: chúng ảnh hưởng cả rank test lẫn diễn giải "cân bằng".) Trái tim nằm ở ma trận $\Pi$. Nếu $\Pi = 0$ thì **không có quan hệ error-correction** — nhưng lưu ý điều này *không* đồng nghĩa "các chuỗi là random walk độc lập": sai phân vẫn có động học qua các $\Gamma_i$ và các $\boldsymbol\epsilon_t$ vẫn có thể tương quan chéo. $\Pi = 0$ chỉ nghĩa không có mức cân bằng dài hạn kéo về. Nếu $\Pi$ có hạng đầy đủ thì các chuỗi vốn đã dừng. Trường hợp thú vị là **hạng suy biến** $0 < r < n$: khi đó $\Pi = \alpha\beta^\top$ tách thành hai ma trận $n\times r$. Cột của $\beta$ là **các vector cointegration** — mỗi cột định nghĩa một tổ hợp $\beta_j^\top \mathbf{y}_{t-1}$ dừng (một "spread" cân bằng); $\alpha$ là **tốc độ điều chỉnh** — mỗi chuỗi kéo về cân bằng nhanh cỡ nào khi spread lệch. Hạng $r$ chính là *số quan hệ cointegration độc lập* trong rổ. Đây là tổng quát hóa của OU theo *tinh thần*: $\beta^\top\mathbf{y}$ đóng vai spread, $\alpha$ đóng vai loading kéo-về. Nhưng đừng đồng nhất $\alpha = -\kappa$ một cách chặt: $\kappa$ trong OU một chiều là một vô hướng, còn $\alpha$ ở đây là cả một **ma trận loading** $n\times r$, và hệ còn có short-run dynamics $\Gamma_i$ — tốc độ điều chỉnh thực của mỗi chuỗi là kết hợp của $\alpha$ và các $\Gamma_i$, không phải riêng $\alpha$.

**Johansen test** tìm $r$ (qua maximum likelihood, đối xứng — không thiên vị chuỗi nào làm biến phụ thuộc). Nói chính xác nó **không** đơn thuần lấy eigenvalue của một $\hat\Pi$: nó giải một bài toán **generalized eigenvalue / canonical-correlation** giữa các *residual* của $\Delta\mathbf y_t$ và $\mathbf y_{t-1}$ (sau khi đã hồi quy bỏ các lag $\Delta\mathbf y_{t-i}$ và deterministic terms) — các eigenvalue $\lambda_i$ là bình phương canonical correlation. Nó cho dãy $\lambda_1 \geq \lambda_2 \geq \dots$; mỗi $\lambda_i$ đáng kể ứng với một chiều dừng, tức một quan hệ cointegration. Hai thống kê: **trace test** (null: "có nhiều nhất $r$ quan hệ") và **maximum eigenvalue test** (null: "đúng $r$" chọi "$r+1$"), so với bảng giá trị tới hạn.

**Johansen bằng số — đường cong lãi suất.** Lấy ba lãi suất kỳ hạn — 2 năm, 5 năm, 10 năm. Cả ba đều I(1) (lãi suất lang thang như random walk ở scale này). Chạy Johansen thu được, chẳng hạn, eigenvalue $\lambda = (0.08,\ 0.03,\ 0.002)$ trên $T = 1000$ ngày. Trace statistic cho giả thuyết $r=0$ (không cointegration) là $-T\sum_i \ln(1-\lambda_i)$, tính từng số hạng: $\ln(1-0.08) = \ln 0.92 = -0.0834$, $\ln(1-0.03) = \ln 0.97 = -0.0305$, $\ln(1-0.002) = \ln 0.998 = -0.0020$; cộng lại $-0.1159$, nhân $-T = -1000$ cho trace $= 115.9$ — vượt xa giá trị tới hạn ~29.8 → bác bỏ "không cointegration". Test tiếp $r \leq 1$ (bỏ eigenvalue lớn nhất, chỉ cộng hai cái sau): $-1000(-0.0305 - 0.0020) = 32.5$, vẫn vượt tới hạn ~15.5 → bác. Test $r \leq 2$ (chỉ eigenvalue nhỏ nhất): $-1000 \times (-0.0020) = 2.0$, **dưới** tới hạn ~3.8 → không bác. Kết luận: $r = 2$ quan hệ cointegration. (Các giá trị tới hạn 29.8 / 15.5 / 3.8 **không cố định** — chúng phụ thuộc deterministic specification (có hằng số? trend?) và lag structure, hai thứ phải khai báo cùng bảng tới hạn; đừng bê một bộ số duy nhất cho mọi trường hợp.) Kết quả "$r=2$, tức **một** trend phi-dừng chung" *khớp* với bức tranh thực nghiệm quen thuộc rằng đường cong lãi suất chủ yếu bị chi phối bởi một nhân tố "level" — nhưng đây là một *phát hiện thực nghiệm* của mẫu này, **không** phải hệ quả tất yếu của "lý thuyết term structure" (việc ba yield là I(1), có đúng một trend chung, và slope/curvature dừng đều là giả thuyết cần kiểm định, không phải định lý). Và hai vector $\beta$ mà Johansen trả về *span* không gian cointegration nhưng **chưa** tự động là 2s10s slope và 2s5s10s butterfly — chúng chỉ trở thành các spread quen thuộc đó sau khi *chuẩn hóa/xoay* (identification), một bước tách bạch mà bản thân eigenvalue/rank không cung cấp.

Có một cầu nối *gợi ý* giữa hai thế giới, nhưng đừng phát biểu quá mạnh: Johansen phát hiện *có bao nhiêu* chiều dừng; PCA của cùng dữ liệu (chương 6) cho một tập hướng *phương sai lớn* (thường diễn giải thành level/slope/curvature). Hai thứ **không** tự động trùng nhau — PCA tìm hướng phương sai lớn, cointegration tìm tổ hợp *dừng*, và tổ hợp dừng thường nằm ở các hướng phương sai *nhỏ* và phụ thuộc tính chất time-series, không phải variance. Nên PCA *không* nói cho ta các cointegration vector "là gì"; nó chỉ là một lăng kính bổ trợ. Trong repo, module `cointegration` bọc `johansen`, và nó là công cụ nền cho relative-value trên rổ — curve trades, basket arbitrage, index arbitrage. Cảnh báo của mục 3.6 còn gắt hơn ở đa biến: một vector cointegration ổn định 5 năm có thể gãy trong một tuần khi cấu trúc thị trường đổi. Vì thế nên *giám sát* bằng rolling Johansen và theo dõi $\alpha$ (tốc độ điều chỉnh tiến về 0 báo hiệu cân bằng đang tan) — nhưng lưu ý rolling Johansen bản thân rất **bất ổn** theo window, lag và deterministic spec, nên nó là công cụ cảnh báo cần đọc thận trọng, không phải một "phải làm" đảm bảo đúng.

---

Điểm chung xuyên suốt chương này, đáng gói lại thành một câu để mang sang các chương sau: mọi công cụ econometric đều đưa ra một con số — t-stat, $R^2$, hedge ratio, vol forecast — kèm một **giả định** về dữ liệu, và trên dữ liệu tài chính giả định đó gần như luôn bị vi phạm theo hướng khiến con số *lạc quan hơn sự thật*. Sai số của mean lớn hơn ta tưởng (30 năm vẫn không phân biệt được mean return 3% với 12%); t-stat phồng lên vì overlapping (tới cỡ $\sqrt{21}$ lần trong trường hợp lý tưởng) và multiple testing (thử 20 thứ vô giá trị, cái tốt nhất kỳ vọng $t \approx 1.9$ và thường vượt 2); $R^2$ cao có thể hoàn toàn spurious; cointegration ổn định 5 năm gãy trong một tuần đúng lúc ta cần nó nhất. Người làm nghề giỏi không phải người thuộc nhiều công thức hơn, mà là người phản xạ hỏi "công cụ này nói dối ở đâu, và tôi đang trả bao nhiêu tiền cho lời nói dối đó" — rồi vá bằng Newey-West, Fama-MacBeth, shrinkage, rolling test, và Kalman. Đó là tinh thần mang vào chương 4 (regime và structural change), nơi chính giả định "tham số cố định" của cả chương này bị đặt lên bàn mổ.

# Chương 4: Regime và structural change

## Vì sao chương này tồn tại

Có một giả định lặng lẽ nằm dưới phần lớn những gì bạn học ở Chương 3: rằng các tham số bạn ước lượng — trung bình return, độ biến động, hệ số beta, tốc độ mean-reversion — là những hằng số của tự nhiên, chỉ bị che mờ bởi noise. Bạn lấy nhiều dữ liệu hơn để nhìn xuyên qua noise và tiến gần hơn tới "chân lý". Đây là thế giới quan i.i.d.: mỗi ngày là một lần rút độc lập từ cùng một cái bình. (Chương 3 đã bắt đầu nứt giả định này ở vài chỗ — GARCH cho vol *thay đổi theo thời gian có điều kiện*, Kalman cho state ẩn trôi dần — nhưng ngay cả ở đó, *cấu trúc* và các siêu tham số của mô hình vẫn được coi là cố định. Chương này tấn công thẳng vào chính sự thay đổi cấu trúc đó.)

Thị trường tài chính không hoạt động như vậy. Cái bình bị tráo giữa chừng. Tháng 8/2007 quant quake bùng phát cấp tính trong tuần 6–8/8 (dù deleveraging đã âm ỉ từ tháng 7 và dư chấn còn kéo dài sau đó — xem Khandani-Lo). Tháng 9–10/2008 Lehman sụp và tương quan giữa các tài sản *rủi ro* tăng vọt về gần 1 chỉ trong ít tuần (safe-haven như Treasury thì chạy ngược chiều). Tháng 2–3/2020 VIX (thước đo vol kỳ vọng) nhảy từ ~14 lên đỉnh 82.7 trong khoảng một tháng, còn realized vol của S&P tăng nhiều lần. Chu kỳ lãi suất Fed từ 0% (2020) lên 5.25% (2023) đảo ngược lợi nhuận của phần lớn chiến lược carry và duration đã fit đẹp suốt thập kỷ trước — tùy hướng vị thế và hedge. Trong mỗi biến cố này, một mô hình được fit "mượt" trên lịch sử — nghĩa là fit lên trung bình của cả một bình đã trộn lẫn nhiều bình con — trở thành vô dụng, hoặc tệ hơn, dự báo tự tin và sai.

Đây là **regime**: những đoạn thời gian mà quá trình sinh dữ liệu (data-generating process) có tham số ổn định. Hai cách hình dung sự chuyển đổi giữa chúng khác nhau tinh tế: một **regime** kiểu Markov có thể *tái diễn* (calm → stress → calm), trong khi một **structural break** thường chỉ một thay đổi tham số mang tính cấu trúc, một chiều, không nhất thiết quay lại (chế độ chính sách tiền tệ đổi). Chương này dùng cả hai lăng kính. Một QR giỏi, khi có đủ dữ liệu để ước lượng đáng tin, không hỏi "return kỳ vọng của momentum là bao nhiêu?" mà hỏi "return kỳ vọng của momentum *có điều kiện lên regime hiện tại* là bao nhiêu, và tôi có bao nhiêu độ tin rằng regime hiện tại là cái tôi nghĩ?". Cả chương này là bộ công cụ để trả lời câu hỏi thứ hai: mô hình hóa regime khi bạn biết trước có bao nhiêu (Markov chain), khi bạn không quan sát được regime mà phải suy ra từ return (Hidden Markov Model, Markov-switching), và phát hiện đúng lúc một break vừa xảy ra (changepoint và structural break tests). Kết chương trả lời câu hỏi thực chiến: điều chỉnh vốn, leverage, và tín hiệu theo regime thế nào — và vì sao **vol** thường là biến regime hữu dụng nhất trong thực hành.
...
Đọc ma trận này như một bản đồ. Hàng đầu: khi đang calm, 97% khả năng ngày mai vẫn calm — regime có tính **persistence** cao, đây là đặc điểm định nghĩa của regime tài chính và là lý do chúng đáng để mô hình hóa. Chỉ 1% khả năng nhảy thẳng từ calm sang crisis — trong ma trận minh họa này, crash "leo thang" qua stress chứ hiếm khi ập tới từ trời quang (một giả định cấu trúc của ví dụ, không phải định lý; ma trận thực fit từ dữ liệu có thể khác). Hàng cuối: crisis cũng dính, 80% ở lại, nhưng khi thoát thì hay rơi vào stress (15%) hơn là bật thẳng về calm (5%) — thị trường "chữa lành" từ từ. Mỗi hàng cộng lại đúng bằng 1 vì từ một trạng thái, ngày mai chắc chắn phải rơi vào một trong ba trạng thái; đó là ràng buộc duy nhất một transition matrix phải thỏa (mọi phần tử không âm, mỗi hàng tổng bằng 1 — gọi là ma trận stochastic).

### Stationary distribution: thị trường dành bao nhiêu thời gian ở mỗi regime

Nếu để chain chạy mãi, tỷ lệ thời gian ở mỗi regime hội tụ về **stationary distribution** $\pi$, nghiệm của $\pi P = \pi$ với $\sum_i \pi_i = 1$. Đây là left eigenvector của $P$ ứng với eigenvalue 1. (Sự hội tụ về một $\pi$ *duy nhất* không phải mặc nhiên: nó cần chain irreducible và positive recurrent để $\pi$ tồn tại và duy nhất, thêm aperiodic để phân phối ở bước $n$ hội tụ chứ không dao động tuần hoàn — một transition matrix tài chính với mọi phần tử dương như ví dụ dưới đây thỏa cả ba nên ta yên tâm.) Ta giải bằng tay để thấy nó không phải phép thuật.
...
Vậy về dài hạn thị trường dành **73.8% thời gian calm, 18.0% stress, 8.2% crisis**. Lưu ý con số 8.2% chỉ có nghĩa một khi ta đã cố định cách định nghĩa "crisis" (ở đây là state có emission vol-cực-cao, xem bảng emission bên dưới) — đổi định nghĩa thì đổi con số. Với sojourn 5 ngày, 8.2% ngụ ý khoảng $0.082\times252/5\approx4$ đợt vol-cao mỗi năm: đó không phải nghĩa thông tục "crisis một thập kỷ một lần" mà là các đợt vol-spike (kiểu 8/2011, 12/2018, cùng với 2008/2020 lớn hơn) — vol clustering làm những ngày này dồn cục. Dù vậy nó vẫn là một sanity check đắt giá: nếu bạn fit một mô hình regime và stationary distribution ra 30% ở state vol-cực-cao, hoặc bạn định nghĩa crisis quá lỏng, hoặc mô hình đang overfit noise thành regime.
...
Với calm, $1/(1-0.97) = 33.3$ ngày. Với stress, $1/(1-0.85) = 6.7$ ngày. Với crisis, $1/(1-0.80) = 5.0$ ngày. Đọc ra: một đợt bình yên trung bình kéo dài khoảng một tháng rưỡi giao dịch, còn crisis trung bình chỉ năm ngày — ngắn, dữ dội, rồi tan. Con số này cho bạn một thứ tự độ lớn vận hành (không phải một quy tắc cứng, vì đây là *kỳ vọng* của một phân phối geometric có đuôi dài — nhiều đợt ngắn hơn, một số dài hơn hẳn): nếu bạn de-risk khi vào crisis, thang thời gian phòng thủ hợp lý là hàng tuần chứ không phải hàng quý; ai cắt hết vị thế rồi ngồi ngoài ba tháng có nguy cơ bỏ lỡ cú hồi phục — mà crisis *thường* (không phải luôn) theo sau bởi hồi phục nhanh kiểu V (nghĩ tháng 4/2020, nhưng 2000–2002 thì không).
...
(Annualize bằng $\sigma_{\text{năm}} = \sigma_{\text{ngày}}\sqrt{252}$: ví dụ $0.7\%\times\sqrt{252} = 0.7\times15.87 = 11.1\%$, và $3.5\%\times15.87 = 55.6\%$.) Đây là các tham số *minh họa theo thứ tự độ lớn*, không phải một fit công bố với dataset/cửa sổ/xử lý cổ tức cụ thể — và chúng không được calibrate chung với transition matrix ở trên: ghép stationary distribution $(0.738,0.180,0.082)$ với ba mean $(+5,-8,-25)$ bps cho unconditional drift chỉ $\approx0.2$ bps/ngày $\approx0.5\%$/năm, thấp hơn nhiều mức lịch sử của S&P — nhắc rằng đừng đọc các số này như một mô hình đã fit nhất quán. Một cảnh báo mô hình quan trọng hơn: emission Gaussian mâu thuẫn với fat tails đã nhấn ở Chương 2, nên một HMM-Gaussian có thể dựng ra một "crisis state" *chỉ để hấp thụ outliers* — regime khi đó là artefact của distributional misspecification chứ chưa chắc là một chế độ kinh tế thật; dùng emission đuôi dày (Student-t) là một cách phòng. Với dè dặt đó, nhìn bảng này bạn thấy vì sao HMM "nhìn thấy" điều mắt thường bỏ lỡ. Một return $-2\%$ trong một ngày là hoàn toàn bình thường ở regime crisis ($-2\%$ chỉ cách mean crisis $|-2 + 0.25|/3.5 = 0.5\sigma$, tức trong tầm dao động thường ngày), nhưng là biến cố $|-2-0.05|/0.7 = 2.93\sigma$ ở regime bull — cực hiếm (xác suất *một đuôi* cỡ $0.17\%$, hai đuôi cỡ $0.34\%$). HMM dùng chính độ "bất thường" này, cộng với persistence của chain, để suy ra state.

### Filtering: suy ra regime hiện tại từ quan sát

Giả sử ta đã biết $P$, $\mu_k$, $\sigma_k$ (fit sau). Câu hỏi vận hành là: cho chuỗi return *đến phiên vừa đóng cửa gần nhất*, xác suất tôi đang ở mỗi regime là bao nhiêu? (Chú ý timing: daily return của một phiên chỉ quan sát được *sau* khi phiên đó đóng, nên quyết định sáng nay chỉ được điều kiện lên các return tới hết hôm qua — dùng "return hôm nay" để filter rồi hành động trong chính phiên hôm nay là look-ahead.) Đây là **filtering**, tính bằng **forward algorithm** — đúng cái mà `forwardFilter` trong module `hmm` của src/alpha trả về.
...
Một return $-2\%$ đã kéo niềm tin từ 80% calm xuống 21% calm, và đẩy stress từ 15% lên 60%. Nhưng để ý ba điều tinh tế. Thứ nhất, niềm tin *không* nhảy thẳng sang 100% stress dù $-2\%$ thoạt nhìn "trông giống bear" — persistence của prior neo nó lại. Thứ hai, dù density của stress (0.294) và crisis (0.252) suýt soát nhau (một $-2\%$ hợp với cả hai regime "xấu"), posterior của crisis vẫn thấp hơn hẳn (18.9% vs 60%) vì prior của crisis quá mỏng (5.55%) — bằng chứng một ngày chưa đủ vượt qua tiền định persistence rằng crisis hiếm. Thứ ba, cơ chế "prior neo lại" này có xu hướng làm HMM mượt hơn việc phân loại regime bằng một cửa sổ vol trượt đơn thuần — nhưng "mượt tới đâu" phụ thuộc persistence của $P$ và độ tách biệt của các emission, không phải tự động. Để ý sắc thái: một cú $-2\%$ đơn lẻ *đã* đủ dời posterior stress từ 15% lên 60% trong đúng một ngày (filter không hề ì); cái persistence chặn lại là bước *cam kết chắc chắn* — để posterior stress lên ngưỡng cao (chẳng hạn >90%, đủ để bấm nút de-risk cứng) thường cần thêm vài ngày xấu xác nhận, đúng như trực giác rằng một $-2\%$ lẻ giữa chuỗi calm phần nhiều là noise.
...
đúng là "trung bình return, mỗi ngày cân theo mức độ ta tin ngày đó thuộc regime $k$". Variance cập nhật tương tự với $(r_t - \mu_k)^2$ làm giá trị được cân. Transition cập nhật là $P_{jk}^{\text{mới}} = \frac{\sum_{t=1}^{T-1} \xi_t(j,k)}{\sum_{t=1}^{T-1} \gamma_t(j)}$ — tỷ lệ số lần (mềm) chuyển $j\to k$ trên số lần (mềm) ở $j$. Chú ý giới hạn tổng chỉ chạy tới $T-1$: quan sát cuối cùng không có bước chuyển kế tiếp nên occupancy của nó không được tính vào mẫu số (lệch một quan sát là lỗi hay gặp; trong code, tổng chạy đúng qua $t-1$ bước chuyển).

Ví dụ số cho M-step một regime. Giả sử sau E-step, trên 5 ngày cuối, responsibility crisis $\gamma(\text{crisis}) = (0.1, 0.6, 0.95, 0.9, 0.3)$ và returns $(-1.0, -3.0, -4.5, -3.8, -1.2)\%$. Tử số $\mu$: $0.1(-1.0)+0.6(-3.0)+0.95(-4.5)+0.9(-3.8)+0.3(-1.2) = -0.1-1.8-4.275-3.42-0.36 = -9.955$. Mẫu số: $0.1+0.6+0.95+0.9+0.3 = 2.85$. Vậy $\mu_{\text{crisis}}^{\text{mới}} = -9.955/2.85 = -3.49\%$. Những ngày mà mô hình tin chắc là crisis (return $-4.5$ với $\gamma=0.95$, $-3.8$ với $\gamma=0.9$) đóng góp gần trọn, ngày mơ hồ ($-1.0$ với responsibility 0.1) gần như bị bỏ qua. Lý do responsibility của ngày $-1\%$ thấp *không* phải vì $-1\%$ khó xảy ra dưới crisis (thực ra nó chỉ cách mean crisis $|-1+0.25|/3.5=0.21\sigma$, rất bình thường với crisis) — mà vì $-1\%$ còn *khả dĩ hơn* dưới các regime dịu hơn, nên khối likelihood dồn về đó. So sánh nhanh: nếu ta ngây thơ lấy trung bình đơn giản của đúng năm ngày này thì được $-2.70\%$, kém âm hơn nhiều — chính trọng số mềm đã kéo ước lượng crisis về những ngày thảm khốc nhất. Nhưng đừng đọc weighted mean như đang tiến về "giá trị đúng" một cách vô điều kiện: cả responsibility lẫn tham số đều sinh ra từ *chính model hiện tại*, nên EM có thể tự củng cố một phân hoạch sai (một local optimum tồi cũng "tự nhất quán"). Với dè dặt đó, đây là ma thuật của EM: mỗi vòng, tham số được kéo về phía dữ liệu mà nó "sở hữu", làm log-likelihood tăng đơn điệu cho tới khi hội tụ (module dừng khi thay đổi log-likelihood dưới tolerance).

Hai cạm bẫy thực chiến. Thứ nhất, EM chỉ đảm bảo tìm **local optimum**; khởi tạo khác nhau ra mô hình khác nhau, nên trong thực tế người ta chạy nhiều seed rồi giữ log-likelihood cao nhất (module cho tham số `seed` và khởi tạo mean theo percentile của dữ liệu chính vì lý do này — đặt sẵn ba mean gần các phân vị thấp/giữa/cao để mỗi regime "sinh ra" gần đúng chỗ của nó). Lưu ý chọn seed likelihood cao nhất chỉ chữa vấn đề *local optimum trên tập train*; nó không giải quyết overfitting (log-likelihood in-sample luôn tăng theo số state) hay non-identifiability giữa các state — hai thứ cần out-of-sample và số state nhỏ để kiểm soát. Thứ hai, **label switching**: nhãn "regime 0/1/2" là tùy tiện, EM có thể đặt crisis thành regime 0 lần này, regime 2 lần khác. Sắp lại theo một quy ước cố định — thường là theo $\sigma$ tăng dần — trước khi diễn giải; nhưng quy ước này chỉ ổn định khi các state tách biệt rõ theo $\sigma$: nếu hai state có variance sát nhau (hoặc khác chủ yếu ở mean/dynamics), sort-by-$\sigma$ vẫn có thể tráo nhãn, khi đó cần một khóa nhãn vững hơn (ví dụ theo mean, hoặc ghép cặp state gần nhất giữa các lần fit).

### Viterbi: con đường regime khả dĩ nhất

Filtering và smoothing cho *phân phối* state ở mỗi thời điểm rời rạc. Đôi khi bạn cần một câu chuyện mạch lạc: chuỗi state *duy nhất* khả dĩ nhất giải thích toàn bộ quan sát. Đó là **Viterbi algorithm** (`viterbi` trong module), một quy hoạch động chạy trong không gian log để tránh **underflow** (nhân hàng nghìn xác suất nhỏ hơn 1 sẽ tiến về 0 dưới mức biểu diễn được của số dấu phẩy động — mất chính xác chứ không phải overflow; lấy log biến tích thành tổng nên tránh được).
...
Điểm phân biệt tinh tế mà nhiều người bỏ qua: Viterbi cho chuỗi *chung* khả dĩ nhất (MAP path), không phải chuỗi các state khả dĩ nhất từng thời điểm. Hai cái này khác nhau. Chuỗi smoothing "argmax mỗi ngày" có thể chứa một bước chuyển $j\to k$ mà $P_{jk}=0$ — tức bất khả thi như một câu chuyện liền mạch — trong khi Viterbi phạt mạnh các bước như vậy nên gần như luôn ra một quỹ đạo liền mạch. (Một lưu ý implementation trung thực: code floor mọi transition tại $10^{-300}$ trước khi lấy log, nên một cạnh $P_{jk}=0$ không bị cấm *tuyệt đối* — nó chỉ mang chi phí $\log 10^{-300}\approx-691$, đắt tới mức thực tế không bao giờ được chọn trừ khi mọi lối khác còn tệ hơn.) Và vì Viterbi là một MAP path, nó *vứt bỏ toàn bộ posterior uncertainty* — cho một câu chuyện sắc nét nhưng che đi việc nhiều ngày biên giới vốn mập mờ. Vậy nên: với gán nhãn regime lịch sử để nghiên cứu (kiểu "đợt bear này bắt đầu ngày nào"), Viterbi tiện vì ranh giới sắc nét; với size vị thế real-time, filtering probability là công cụ đúng vì bạn muốn dùng cả sự bất định, không ép về một nhãn cứng.
...
Điểm mới so với HMM thuần: mỗi regime có cả một tốc độ mean-reversion $\phi_{s_t}$ riêng, không chỉ mean và vol. Với một quá trình AR(1), một cú lệch khỏi mean co lại theo hệ số $\phi$ mỗi bước, nên **half-life** (số bước để cú lệch giảm còn một nửa) là nghiệm của $\phi^h = \tfrac12$, tức $h = \ln 2 / (-\ln \phi)$; khi $\phi$ gần 1 thì $-\ln\phi \approx 1-\phi$ nên xấp xỉ tiện dùng là $h \approx \ln 2/(1-\phi)$. (Công thức này giả định $0<\phi<1$ — trường hợp mean-reversion trơn thường gặp với spread; nếu $\phi<0$ thì lệch dao động đổi dấu mỗi bước và ta phải xét $|\phi|$ cho biên độ suy giảm.) Điều này khớp trực giác thị trường sâu sắc. Ví dụ số minh họa: fit MS-AR(1) lên chuỗi spread của một cặp pairs trade cho hai regime.

- Regime "mean-reverting nhanh" với $\phi_1 = 0.95$: half-life $\approx \ln 2/(1-0.95) = 0.693/0.05 = 13.9$ ngày (công thức chính xác $\ln 2/(-\ln 0.95) = 13.5$ ngày cho gần như cùng con số). Con số này khớp running example pairs của chúng ta — một OU với $\kappa \approx 0.05$/ngày cũng cho half-life $\ln 2/\kappa \approx 13.9$ ngày. Spread hồi về mean nhanh; đặt cược mean-reversion sinh lời.
- Regime "gần random walk" với $\phi_2 = 0.999$: half-life $\approx \ln 2/(1-0.999) = 693$ ngày $\approx$ 2.75 năm. Về mặt mô hình $|\phi|<1$ nên đây *vẫn* là một quá trình stationary — half-life dài tự nó không "chứng minh" cointegration đã gãy; nhưng trên mọi horizon giao dịch thực tế nó không phân biệt được với random walk, nên coi như spread đã ngừng hồi quy *cho mục đích giao dịch*.

Lưu ý hai nhãn regime ở trên chỉ mô tả persistence của *một spread đã fit sẵn*; bản thân MS-AR(1) trên spread **không phải một test cointegration**: tính stationary của combination này không tự chứng minh hai chuỗi giá gốc cointegrated (muốn thế cần Engle-Granger/Johansen ở Chương 3), và nó chỉ phân loại persistence *theo đúng specification ta đã chọn*. Với dè dặt đó, giá trị vận hành vẫn rõ: một pairs trader mù regime dễ tiếp tục đặt cược mean-reversion khi cặp đã trôi sang regime persistence cao và thua nặng nếu spread trôi mãi không về (mức độ thua phụ thuộc sizing, stop, funding, horizon — không nhất thiết "phá sản"); MS model cho anh ta xác suất real-time rằng cặp đã rơi vào regime đó — tín hiệu để cắt lỗ và ngừng vào lệnh mới. Đây là ứng dụng đắt giá của regime trong stat-arb: không phải để dự báo spread về đâu, mà để biết *khi nào ngừng tin vào chính mô hình mean-reversion của mình*.

Ước lượng MS model dùng cùng bộ máy filter Hamilton — một forward pass gần giống HMM: mỗi bước, ta đẩy phân phối regime qua $P$ (predict), rồi cân lại bằng likelihood của $r_t$ dưới *mô hình AR có điều kiện lên regime* thay vì chỉ một Gaussian marginal (update). Vòng filter đó lồng trong EM hoặc maximum likelihood trực tiếp. Vì cơ học từng bước trùng với phần filtering HMM ta đã tính tay ở trên (chỉ khác chỗ likelihood bây giờ phụ thuộc cả $r_{t-1}$ qua số hạng $\phi(r_{t-1}-\mu)$), ta không lặp lại số học; điều đáng ghi nhớ là **cùng một khung** — chain ẩn Markov cộng emission có điều kiện lên state — bao trọn cả regime của phân phối return (HMM) lẫn regime của cả một mô hình động (Hamilton). Khi nghe "regime-switching GARCH", "regime-switching beta", "regime-switching factor loading", chúng chia sẻ *cùng một khung khái niệm*: lấy một mô hình bạn tin ở Chương 3, cho hệ số của nó nhảy theo một chain ẩn. (Cùng khung không có nghĩa cùng độ khó: regime-switching GARCH chẳng hạn có path-dependence trong likelihood — conditional variance phụ thuộc toàn bộ lịch sử regime — khiến ước lượng nặng hơn hẳn một MS-mean model, nên trên thực tế mỗi biến thể là một bài toán estimation riêng.)
...
Công cụ cổ điển và vẫn hiệu quả là họ **CUSUM (cumulative sum)**. Bản trong repo — `cusumEvents` của module `structural` — là biến thể **symmetric filter kiểu AFML**: nó tích lũy các *bước thay đổi* $x_t - x_{t-1}$ (đã trừ một drift allowance $\delta$) chứ không phải độ lệch so với một target cố định. Vì $\sum(x_i - x_{i-1}) = x_t - x_{\text{reset}}$ telescope, tổng tích lũy chính là *net move của $x$ kể từ lần reset gần nhất*: chừng nào $x$ đi ngang, tổng dao động quanh 0 nhờ biên $\max(0,\cdot)/\min(0,\cdot)$; khi $x$ bắt đầu trôi bền một hướng, tổng vượt ngưỡng và kích hoạt event. Công thức two-sided đúng như code implement (cả hai nhánh trừ cùng một $\delta$):

$$
S_t^+ = \max(0,\; S_{t-1}^+ + (x_t - x_{t-1}) - \delta), \qquad S_t^- = \min(0,\; S_{t-1}^- + (x_t - x_{t-1}) - \delta),
$$

báo event khi $S_t^+ > h$ hoặc $S_t^- < -h$, rồi reset cả hai về 0. Số hạng $-\delta$ là "phí trượt" chống noise. Hai điểm cần rạch ròi. (i) Đây là bộ phát hiện *trôi bền của mức $x$* (đổi slope/drift), không phải test cho một cú *nhảy mức một lần* quanh một target $\mu_0$ cố định — bản mean-shift CUSUM cổ điển của Page tích lũy $(x_t-\mu_0)-k$ với nhánh âm *đảo dấu* độ lệch, một họ hàng gần nhưng khác công thức. (ii) $\delta$ và $h$ mang đơn vị và scale của chính $x$ (và biến động của bước $x_t-x_{t-1}$): cùng một $h$ nghĩa rất khác nhau trên một chuỗi vol 1% so với 4%, nên phải chuẩn hóa theo độ biến động trước khi nói về false-alarm rate.

Chạy một ví dụ số. Giả sử ta theo dõi một chuỗi mà độ tăng bình thường là 0 (đã trừ drift, $\delta=0$), threshold $h=3$ (đơn vị: cùng đơn vị với $x$, ví dụ vol điểm phần trăm annualized). Chuỗi thay đổi từng bước $(x_t - x_{t-1})$: $+0.5, -0.3, +0.4, -0.2, +1.2, +1.5, +1.1, +0.8$ — bốn bước đầu là noise quanh 0, rồi từ bước 5 một break làm chuỗi drift lên đều. Tích lũy $S^+$ (mỗi bước lấy $\max(0,\ S^+_{\text{trước}} + \text{bước})$): $0.5,\ 0.2,\ 0.6,\ 0.4,\ 1.6,\ 3.1$. Ở bước thứ sáu $S^+ = 3.1 > 3$ → **event tại $t=6$**, tức CUSUM phát hiện break chỉ hai bước sau khi drift thật bắt đầu (bước 5). Đúng lúc event, code **reset $S^+$ (và $S^-$) về 0**, nên hai giá trị "4.2, 5.0" mà bạn có thể muốn viết tiếp *không* thuộc cùng một run — chúng chỉ là những gì $S^+$ sẽ thành *nếu không reset*, không phải trạng thái thật của detector sau $t=6$. Bốn bước noise đầu không bao giờ đẩy $S^+$ vượt 0.6 vì các bước âm liên tục kéo nó xuống và biên $\max(0,\cdot)$ chặn nó không cho tích lũy noise thành báo động giả — để ý bước 2 và bước 4, $S^+$ bị các bước âm $-0.3$ và $-0.2$ gặm bớt ngay, đúng cơ chế "reset ở biên" giữ CUSUM khỏi trôi vô cớ.

Đây là đặc tính quý của CUSUM: nó nhạy với **thay đổi bền vững, nhỏ** (mà một z-score một-điểm sẽ bỏ lỡ vì mỗi bước $+1.2$ hay $+1.5$ riêng lẻ chưa đủ dramatic) nhưng bền với noise nhất thời (mà một ngưỡng đơn giản sẽ báo giả). "Bền" ở đây là tương đối, không phải miễn nhiễm: với threshold hữu hạn và một chuỗi noise chạy đủ dài, $S^+$ vẫn có xác suất dương đáng kể vượt $h$ mà không có break nào (đây chính là average-run-length dưới null của CUSUM) — reset ở biên làm chậm chứ không triệt tiêu false alarm. Đánh đổi nằm ở cặp $(\delta, h)$: $h$ nhỏ → phát hiện nhanh nhưng nhiều false alarm; $h$ lớn → ít báo giả nhưng chậm. Trong AFML, CUSUM filter được dùng theo cách hơi khác — như một **event-based sampler** để chỉ lấy mẫu bar khi có biến động tích lũy đáng kể, tạo tập sự kiện cho triple-barrier labeling (Chương 10) — nhưng cơ học tích lũy-và-reset là một.
...
Ví dụ số về hazard. Với hazard rate cố định $H = 1/200$ (kỳ vọng một break mỗi 200 ngày — một lựa chọn quy ước, đáng calibrate lại theo dữ liệu chứ không phải hằng số có sẵn), xác suất tiên nghiệm không có break trong một năm giao dịch ($\approx 252$ ngày) là $(1 - 1/200)^{252} = 0.995^{252} = e^{252 \ln 0.995} = e^{-1.263} = 0.283$ — tức prior gán $\approx72\%$ khả năng có ít nhất một break mỗi năm. Con số $72\%$ này "khớp thực tế" hay không phụ thuộc hoàn toàn *định nghĩa* break (một regime shift lớn, hay bất kỳ dịch tham số nhỏ nào); nó là hệ quả của hazard ta đặt, không phải bằng chứng độc lập.

Ví dụ số về cơ chế "sập run length". Giả sử run hiện tại đã dài, khối lượng xác suất dồn ở $r=40$ với $P(r_{t-1}=40)=0.8$, và run này đã học được rằng vol thường ngày cỡ $\sigma=1\%$. Đến một ngày $x_t = -6\%$. Predictive likelihood dưới run hiện tại (một $-6\%$ là biến cố $6\sigma$) cực nhỏ, cỡ $\pi_{\text{cont}} \approx \frac{1}{1}e^{-6^2/2}=e^{-18}\approx 1.5\times10^{-8}$; còn predictive dưới "prior mới" (chưa cam kết vol nào, phân phối rộng hơn nhiều, giả sử $\sigma_0=4\%$) cho $\pi_{\text{new}} \approx \frac{1}{4}e^{-(6/4)^2/2}=0.25\,e^{-1.125}=0.081$. So hai khối: nhánh reset tổng qua *mọi* run length nên $\propto (\text{tổng }1.0)\times\tfrac1{200}\times0.081 = 4.05\times10^{-4}$; nhánh tiếp-tục-run của riêng $r=40$ là $\propto 0.8\times(1-\tfrac1{200})\times1.5\times10^{-8}\approx 1.2\times10^{-8}$. Đúng ra continuation còn 20% khối lượng ở các run length khác, nhưng những run đó cũng đã cam kết vol thấp tương tự nên predictive likelihood của chúng dưới một $-6\%$ cũng cỡ $10^{-8}$; tổng toàn bộ continuation vẫn $\sim10^{-8}$, không đổi kết luận. Reset thắng áp đảo (gấp hơn ba vạn lần), nên sau chuẩn hóa gần như toàn bộ khối lượng dồn về $r_t=0$ — bạn thấy break bằng cách nhìn phân phối run length "sập" từ 40 về 0 trong một bước. Cần trung thực rằng độ áp đảo này một phần do ta chọn "prior mới" rộng ($\sigma_0=4\%$): predictive của nhánh reset, và do đó tốc độ posterior nhảy về 0, phụ thuộc trực tiếp vào bề rộng prior đó. Ưu điểm so với CUSUM: BOCPD cho độ bất định (bạn biết mình *tin bao nhiêu* rằng vừa có break, không chỉ có/không), tự nhiên xử lý nhiều break nối tiếp, và không cần chọn threshold cứng. Nhưng "không threshold" không có nghĩa không tham số: BOCPD vẫn đòi bạn đặc tả observation model, conjugate prior (và bề rộng của nó), hazard rate, cùng quy tắc biến posterior run-length thành một cảnh báo hành động được — chỉ là các lựa chọn đó có diễn giải xác suất trực tiếp hơn một threshold trần trụi ([Adams-MacKay 2007](https://arxiv.org/abs/0710.3742)).
...
Ví dụ số. Fit CAPM $r_i = \alpha + \beta r_m + \varepsilon$ ($k=2$: alpha và beta) cho một cổ phiếu tech quanh nghi vấn beta đã tăng sau một biến cố (ví dụ chuyển sang mô hình kinh doanh rủi ro hơn). Toàn mẫu $n = 240$ tháng, $RSS_R = 0.180$. Chia tại $\tau$: đoạn 1 (120 tháng, beta cũ) $RSS_1 = 0.070$, đoạn 2 (120 tháng, beta mới cao hơn) $RSS_2 = 0.075$, nên $RSS_U = 0.145$. Tính từng phần: tử số $= (0.180 - 0.145)/2 = 0.0175$; mẫu số $= 0.145/(240 - 4) = 0.145/236 = 0.000614$; vậy $F = 0.0175/0.000614 = 28.5$. Với $(2, 236)$ bậc tự do, critical value 1% $\approx 4.70$; $F=28.5$ vượt xa, ta **bác bỏ giả thuyết ổn định của toàn bộ vector $(\alpha,\beta)$** tại $\tau$ với ý nghĩa cao. Chú ý test này là *joint*: $F$ lớn nói "có ít nhất một trong $\alpha,\beta$ đã đổi", *không* tự nó tách ra rằng chính $\beta$ (chứ không phải $\alpha$) đứt gãy — muốn quy cho riêng $\beta$ phải test riêng hệ số đó (ví dụ so sánh $\hat\beta_1$ và $\hat\beta_2$ với robust SE). Cắt nghĩa: $RSS$ giảm từ 0.180 xuống 0.145 (giảm 19%) là quá lớn để đổ cho may rủi khi chỉ thêm hai tham số. Một cảnh báo assumption: F-test cổ điển này giả định error homoskedastic, độc lập và mô hình đặc tả đúng; residual tài chính theo tháng thường heteroskedastic/autocorrelated, nên trong thực hành nên dùng biến thể Chow/Wald với robust (HAC) covariance thay vì công thức $RSS$ trần. Hạn chế chí mạng của Chow: bạn phải *biết trước* $\tau$. Chọn $\tau$ bằng cách nhìn dữ liệu rồi test tại chính điểm nhìn thấy là một dạng data-snooping làm hỏng phân phối null — cùng loại tội với việc chọn threshold sau khi thấy kết quả backtest.
...
Ví dụ số chọn $m$ bằng BIC. Fit mean của lãi suất 10-year Treasury yield, $n=600$ tháng, với $\sigma^2$ residual chuẩn hóa. Giả sử $RSS$ tối ưu theo số break: $m=0$: 12.0; $m=1$: 8.5; $m=2$: 6.2; $m=3$: 5.9. Dùng $\text{BIC} = n\ln(RSS/n) + (\text{số tham số})\ln n$; ở đây ta *quy ước* đếm mỗi vị trí break như một tham số tự do, nên số tham số $= (m+1)$ mean cộng $m$ vị trí break $= 2m+1$ (đây chỉ là một trong nhiều convention phạt của change-point BIC — Bai-Perron gốc và các biến thể LWZ dùng penalty khác, và số break "thắng" có thể dịch theo lựa chọn này), và $\ln 600 = 6.397$. Tính từng $m$:
...
Theo đúng BIC này, $m=3$ **thắng dứt khoát**, không phải "giảm nhẹ": chênh $-2728.4$ so với $-2711.4$ là 17 điểm, mà một khác biệt BIC $>10$ theo quy ước thông thường đã là bằng chứng rất mạnh. Nói cách khác, nếu bạn tuyên bố "chọn $m$ bằng BIC" thì câu trả lời trung thực là $m=3$ — không được lẳng lặng bỏ kết quả BIC rồi viện elbow. Vì sao vẫn có lý do cân nhắc $m=2$? Không phải vì BIC, mà vì một *tiêu chí khác*: cải thiện $RSS$ đã cạn (6.2→5.9, chỉ $-5\%$) so với cú rơi mạnh $m=1\to2$ (8.5→6.2, $-27\%$), nên một penalty bảo thủ hơn (LWZ), một sequential test $\sup F(3\mid2)$ không bác được, hoặc một prior kinh tế về số chế độ, đều có thể dừng ở 2. Trình bày cả hai và nói rõ tiêu chí nào chọn số nào; chớ để hai lập luận mâu thuẫn nhau. (Và lưu ý: số break thống kê *không* nhất thiết trùng số "chế độ tiền tệ" bạn kể — riêng danh sách Volcker disinflation, ZIRP 2008, lift-off 2015, lift-off 2022 đã là *bốn* biến cố, nên đừng ép $m$ khớp một câu chuyện định tính.) Bai-Perron là công cụ chuẩn khi bạn cần một câu trả lời có ý nghĩa thống kê cho "chuỗi này đã đứt gãy mấy lần và ở đâu", thay vì mắt thường vẽ đường thẳng qua đồ thị.

Một họ hàng gần mà src/alpha có sẵn (`sadfStatistic`, `bsadfSeries` trong `structural`) là **SADF/BSADF của Phillips-Shi-Yu**: thay vì test break của mean, chúng chạy ADF test (Chương 3) trên mọi cửa sổ con và lấy supremum để phát hiện *bubble*. Nói cho chính xác: ADF ở đây test null **unit root** (random walk) chống lại *alternative explosive* ($\phi>1$) — nên SADF bắt đoạn giá chuyển từ hành vi random-walk/không-bùng-nổ sang **explosive**, không phải "từ mean-reverting sang explosive". Và cần biết giới hạn của module: nó chỉ trả về *supremum của ADF statistic*; muốn kết luận "có bubble" bạn còn phải tự cung cấp right-tail critical values (thường bằng Monte Carlo/bootstrap) và logic date-stamping điểm bắt đầu/kết thúc bubble — những thứ module không làm sẵn. Cùng tinh thần "quét mọi cửa sổ tìm điểm cấu trúc đổi", nhưng nhắm vào tính bùng nổ chứ không phải dịch mức.
...
Câu trả lời thực hành phổ biến ở nhiều multi-manager: **volatility**. Đây là một lựa chọn thiết kế có lý do, không phải một định lý; ba lý do dưới đây giải thích vì sao vol thường được ưa hơn các ứng viên khác (return dự báo, macro indicator, sentiment) — chứ không phải nó "thắng" theo nghĩa đã kiểm định thống kê chặt.

Thứ nhất, **vol có persistence và dễ đo, còn return thì không**. Chương 3 đã cho ta GARCH(1,1) với $\alpha+\beta = 0.98$ và half-life $\approx 34$ ngày — chính xác thì đây là half-life của cú lệch *dự báo conditional variance* về mức trung bình dài hạn, không hẳn là "half-life của vol", nhưng nó nói lên cùng một điều: vol hôm nay dự báo vol ngày mai với độ chính xác thật (autocorrelation của $r_t^2$ dương và tắt chậm), trong khi return có autocorrelation gần 0 ở tần suất ngày. Regime chỉ hữu ích nếu *persistent* — bạn cần thời gian để phản ứng; một "regime" đảo mỗi ngày thì vô dụng vì đến lúc bạn nhận ra thì nó đã đổi. Vol thỏa (đợt vol cao dính hàng tuần), return không. Đây là lý do sâu xa: một biến regime tốt phải là biến mà "hôm nay giống hôm qua" — và vol clustering đúng là hiện tượng đó.

Thứ hai, **vol regime liên hệ trực tiếp tới cơ chế sinh P&L của bạn**, không chỉ là tương quan thống kê tình cờ (dù nói "nhân quả" thì cũng nên nhớ high-vol, correlation cao, thanh khoản rút và alpha suy giảm thường *cùng* bị kéo bởi một stress factor chung, khó tách nhân-quả một chiều). Ở high-vol regime: tương quan cross-sectional có xu hướng tăng vọt (mọi thứ rơi cùng nhau, diversification bốc hơi đúng lúc cần nhất — các nghiên cứu điển hình thấy correlation trung bình cặp cổ phiếu lớn nhảy từ cỡ 0.1–0.2 lúc calm lên 0.5+ trong crash; con số cụ thể tùy universe/cửa sổ/cách tính), market impact tăng (thanh khoản rút, xem Chương 12–13), tail risk béo lên, và — quan trọng nhất — *nhiều* alpha long-short đảo hành vi (momentum crash trong recovery, mean-reversion trở nên nguy hiểm vì trend mạnh); dù không phải mọi chiến lược đều đảo — một số defensive, vol-selling hay relative-value phản ứng khác. Vậy biết vol regime cho bạn thông tin *hành động được* về cả rủi ro lẫn kỳ vọng return của chính chiến lược mình.

Thứ ba, **vol ước lượng được với độ trễ nhỏ và sai số vừa phải** — gần "real-time" theo nghĩa cập nhật nhanh, chứ nói chặt thì vol vẫn là đại lượng *ẩn* ta suy ra chứ không đọc trực tiếp. Realized vol tính từ intraday nhưng chỉ *đầy đủ* sau khi phiên đóng (trong phiên chỉ có ước lượng bộ phận); VIX là *implied, forward-looking* — nó đo vol kỳ vọng 30 ngày của S&P 500 rút từ giá option SPX (một thước đo vol-kỳ-vọng, không phải "giá của regime"); còn HMM/GARCH không "quan sát" vol mà *ước lượng* latent state hoặc conditional variance từ return. Dù vậy cả ba đều hội tụ nhanh hơn nhiều so với ước lượng mean: Chương 3 (§3.1) đã cho thấy sai số ước lượng mean lấn át mọi thứ — cần hàng chục năm dữ liệu để tách mean khỏi noise, trong khi vài tháng đủ để ước lượng vol chấp nhận được. Bạn không bao giờ chắc mean đang là bao nhiêu; bạn khá chắc vol đang là bao nhiêu.

Với vế "làm gì", nguyên tắc trung tâm là **vol targeting / regime scaling**. Nếu mục tiêu là chạy danh mục ở vol không đổi $\sigma_{\text{target}}$ (giả sử 10% annualized), thì công thức bậc nhất cho leverage là tỷ lệ nghịch với vol hiện tại: $L_t = \sigma_{\text{target}} / \hat\sigma_t$. Đây là bản rút gọn: nó bỏ qua leverage cap, sai số của chính $\hat\sigma$ (bạn đang chia cho một đại lượng ước lượng), cấu trúc covariance của nhiều vị thế, và ràng buộc funding/thanh khoản — desk thật bọc thêm các lớp này (cap, hồi quy về vol trung hạn, floor). Ví dụ số minh họa: calm regime $\hat\sigma = 8\%$ → $L = 10/8 = 1.25\times$; stress $\hat\sigma = 24\%$ → $L = 10/24 = 0.42\times$; crisis regime $\hat\sigma = 55\%$ → $L = 10/55 = 0.18\times$. Cùng một tín hiệu, nhưng bạn nắm gấp gần bảy lần gross exposure ở calm ($1.25/0.18 \approx 6.9$) so với crisis — và chính điều này biến một chiến lược có drawdown thảm khốc trong crash thành một chiến lược mà exposure tự động rút về lúc nguy hiểm nhất. Đây là điều `regimeScaled` trong module `regime` mã hóa — nhân trọng số cơ sở với một scale phụ thuộc filtering probability của HMM. Và `regimeConditional` đi xa hơn: blend *nhiều chiến lược khác nhau* theo xác suất regime, ví dụ chạy momentum ở trending regime và mean-reversion ở range-bound regime, với trọng số blend chính là filtering probability — không bao giờ bật/tắt cứng mà pha trộn mượt theo độ tin. Nếu HMM cho $P(\text{trending})=0.7$, một cách blend đơn giản là 70% vốn theo momentum và 30% theo mean-reversion, chuyển dần khi niềm tin dịch, thay vì lật công tắc gây whipsaw. Hai lưu ý để công thức này không bị đọc quá ngây thơ: (i) xác suất regime $0.7/0.3$ *không* tự động là tỷ lệ vốn tối ưu — hai sleeve có thể khác gross exposure, vol và covariance với nhau, nên trọng số rủi ro-điều chỉnh mới là thứ cần cân, và nếu mỗi sleeve đã tự vol-target thì phải tránh nhân đôi scaling; (ii) **timing phải sạch look-ahead**: filtered probability dùng để đặt trọng số cho ngày $t$ chỉ được dựa trên thông tin tới hết ngày $t-1$ — nếu bạn dùng return ngày $t$ để filter rồi áp trọng số đó lên chính P&L ngày $t$, backtest sẽ nhìn trộm tương lai.

Ba cạm bẫy khép lại. Một, **timing lag**: mọi bộ phát hiện regime đều trễ ít nhiều (CUSUM vài bước như ví dụ $t=6$ ở trên, HMM cần vài ngày để prior chuyển như phép tính $-2\%$ đã cho thấy — một cú xấu chưa đủ lật niềm tin). Bạn không bao giờ de-risk đúng đỉnh; mục tiêu khiêm tốn hơn là cắt phần đuôi của một đợt kéo dài. Vì *kỳ vọng* sojourn crisis là 5 ngày (không phải 1), một phản ứng trễ hai-ba ngày còn kịp bảo vệ phần còn lại của những đợt dài — nhưng nhớ đó là kỳ vọng của một phân phối có đuôi: với các đợt ngắn hơn trung bình, độ trễ đó có thể ăn trọn cú giảm, nên "bảo vệ được bao nhiêu" là một kỳ vọng chứ không phải bảo đảm. Hai, **overfitting số regime**: fit năm regime lên mười năm dữ liệu có *nguy cơ cao* tạo ra "regime" là noise được đặt tên sang trọng — hãy phán xét bằng tiêu chí cụ thể (số tham số so với số quan sát độc lập ở tần suất bạn dùng, penalized likelihood, và quan trọng nhất là hiệu năng out-of-sample) chứ không bằng cảm giác; giữ $K$ nhỏ (hai hoặc ba) và validate OOS — một mô hình regime thật phải giúp trên dữ liệu chưa thấy, không chỉ kể chuyện đẹp về quá khứ. Ba, **whipsaw cost**: chuyển leverage theo regime tạo turnover, và turnover ăn phí (Chương 13); regime scaling chỉ đáng nếu tiết kiệm rủi ro vượt chi phí giao dịch nó gây ra — với vol targeting điều này *thường* đúng vì vol persistent nên leverage phần lớn thời gian đổi từ tốn (từ $1.25\times$ xuống $0.42\times$ diễn ra qua nhiều phiên khi vol leo thang dần), nhưng đừng coi "từ tốn" là chắc chắn: một gap qua đêm hay một vol shock có thể làm $\hat\sigma$ và do đó $L$ nhảy mạnh trong một bước, và một classifier bật/tắt cứng thì càng dễ tự thua vì phí. Chính vì vậy filtering probability của HMM, với prior neo lại như ta đã thấy ở phép tính $-2\%$ phía trên, thường được ưa hơn phân loại cứng: nó *có xu hướng* làm chậm các cú chuyển — dù, đúng như chính ví dụ $-2\%$ nhắc, một likelihood đủ cực đoan vẫn có thể dời posterior mạnh trong một ngày, nên nó là tay lái vững hơn chứ không phải một bộ giảm chấn tuyệt đối.
...
Toàn bộ portfolio construction gói trong một dòng: **trọng số tỷ lệ với $\Sigma^{-1}\mu$**. Đọc nó như một chỉ dẫn: $\mu$ nói "muốn cái gì", còn $\Sigma^{-1}$ là bộ lọc "risk-adjust" — nó phạt các vị thế correlation cao (vì $\Sigma^{-1}$ trừ đi phần chồng lấn) và khuếch đại các cược độc lập. Cùng một vector $\Sigma^{-1}\mu$, chỉ đổi $\lambda$, là ta trượt dọc frontier từ thận trọng sang hung hãn. Module `src/alpha` dùng đúng cái *hướng* $\Sigma^{-1}\mu$ này trong `portfolio.meanVariance`: nó giải $\Sigma^{-1}\mu$ rồi **chuẩn hóa gross exposure về 1** (tức tách riêng quyết định đòn bẩy $\lambda$ ra chỗ khác — `volTarget`), chứ không giữ nguyên độ lớn $1/\lambda$ của nghiệm không ràng buộc.
...
trong đó $F_k$ là các common factor (thị trường, size, value, momentum, hoặc các macro factor như thay đổi lãi suất). Điểm đẹp của APT so với CAPM là nền tảng lý thuyết **nhẹ hơn nhiều**: CAPM cần giả định mọi người đều tối ưu mean-variance trên cùng thông tin (một giả định nặng, gần như chắc chắn sai). APT về cốt lõi chỉ dựa trên **no-arbitrage** — cộng một giả định cấu trúc nhẹ hơn nhiều so với CAPM: return tuân theo một **factor structure xấp xỉ** và idiosyncratic risk **diversify được** qua nhiều tài sản. Trong khung đó: nếu hai danh mục có cùng vector exposure $\{\beta_{ik}\}$ tới mọi factor mà lại có return kỳ vọng khác nhau, thì tồn tại một arbitrage *tiệm cận* (long cái rẻ, short cái đắt, exposure factor triệt tiêu; rủi ro còn lại chỉ là idiosyncratic, và trải trên **nhiều** tài sản nó diversify gần về 0 — nên long-short spread là factor-neutral chứ không literally không rủi ro trên vài danh mục lẻ). Vì arbitrageur sẽ nhào vào cho tới khi chênh lệch biến mất, ở cân bằng return kỳ vọng **phải** là hàm tuyến tính của các factor loading (chính xác trong giới hạn factor structure hoàn hảo và idiosyncratic diversify hết):
...
| **Information Ratio (IR)** | $\dfrac{\mathbb{E}[r - r_b]}{\sigma(r - r_b)}$ (active return / tracking error) | Sharpe của phần *vượt benchmark* — thước đo đúng cho active manager, trung tâm của Chương 6 |
...
Một chi tiết annualization mà người mới hay sai: Sharpe hàng năm bằng Sharpe hàng ngày nhân $\sqrt{252}$ (giả định return i.i.d.), vì mean scale theo thời gian $T$ còn vol scale theo $\sqrt T$, nên tỷ số scale theo $T/\sqrt T = \sqrt T$. Một chiến lược Sharpe hàng ngày 0.063 nghe tầm thường nhưng annualized ra $0.063\cdot\sqrt{252} = 1.0$ — đáng nể. `src/alpha` tính đại lượng này trong `metrics.sharpe` — nó nhận thẳng chuỗi return truyền vào và annualize $\text{mean}/\text{std}\cdot\sqrt{252}$, **không** tự trừ $r_f$, nên để ra đúng nghĩa Sharpe bạn phải đưa vào chuỗi **excess return** $r-r_f$ đã trừ sẵn; cạm bẫy đời thực là return **không** i.i.d. (có autocorrelation dương do vị thế giữ nhiều ngày), khiến $\sqrt{252}$ phóng đại Sharpe — một trong nhiều cách một backtest trông đẹp hơn thực tế.
...
$$r_i - r_f = \alpha_i + \sum_{k} \beta_{ik}\, f_k + \epsilon_i$$

Đọc phương trình này cho kỹ vì cả chương xoay quanh nó — và để nguyên vế trái là **excess return** $r_i - r_f$ để $\alpha$ không lẫn phần bù risk-free (market factor cũng là market excess return; các style factor là chuỗi long-short tự tài trợ nên bản thân đã là excess): excess return của cổ phiếu $i$ bằng một phần **alpha** riêng ($\alpha_i$, cái mà nếu bạn là PM giỏi bạn muốn dương), cộng tổng các **phơi nhiễm** $\beta_{ik}$ nhân với **factor return** $f_k$ (phần return đến từ việc "cưỡi" các nguồn rủi ro chung), cộng **idiosyncratic** $\epsilon_i$ (nhiễu riêng của cổ phiếu, trung bình 0). Risk model **giả định** phần residual này gần như không tương quan chéo *sau khi đã bóc factor* — đó là điều kiện để ma trận $D$ chéo hóa được, chứ không phải một sự thật mặc định; residual thật vẫn có thể còn cấu trúc industry/crowding/liquidity chưa mô hình hóa.
...
**Time-series (kiểu academic / Fama-French).** Factor **chính là một chuỗi return** — thường là return của một danh mục long-short (long rổ value, short rổ growth) với các *style* factor; riêng market factor thì là **market excess return** $r_m - r_f$ chứ không phải long-short theo nghĩa thường. Bạn đã có sẵn chuỗi $f_k$ theo thời gian. Beta của cổ phiếu $i$ ước lượng bằng **hồi quy chuỗi thời gian**: regress return của $i$ theo thời gian lên các chuỗi factor return, hệ số hồi quy là $\beta_{ik}$. Điểm yếu: beta là một con số trung bình trên cả cửa sổ hồi quy, cập nhật chậm, và với cổ phiếu mới niêm yết thì chưa có đủ lịch sử để chạy.
...
**Cross-sectional (kiểu Barra — chuẩn risk model thương mại).** Đảo ngược hoàn toàn. Exposure không phải hồi quy ra — nó là **đặc tính quan sát được** của từng cổ phiếu tại từng thời điểm (z-score của book/price, log-market-cap, momentum 12-1...). Bạn *biết ngay hôm nay* exposure value của Apple là bao nhiêu, không cần chờ cửa sổ. Ngược lại, thứ chưa biết là **factor return** $f_k$ — và nó được ước lượng **mỗi ngày** bằng hồi quy cross-section: regress return hôm nay của *mọi cổ phiếu* lên exposures của chúng, hệ số hồi quy là factor return của ngày đó. Ưu điểm quyết định: exposure cập nhật tức thời khi đặc tính đổi (công ty vừa báo cáo lời tăng → profitability exposure nhảy ngay *sau khi con số được công bố*), không có độ trễ cửa sổ, và tên mới niêm yết vẫn có exposure ngay ngày đầu. Kèm một cảnh báo **point-in-time** không được bỏ: "tức thời" chỉ đúng khi bạn dùng dữ liệu *như nó thực sự có tại thời điểm đó* — fundamentals phải gắn theo ngày **công bố** (có reporting lag vài tuần sau kỳ tài chính), tuyệt đối không dùng số đã *restated* về sau hay chưa công bố; nếu không, exposure "biết ngay hôm nay" chỉ là look-ahead trá hình.

Hai trường phái này dùng chung một *họ kỹ thuật* — hồi quy cross-section lặp qua thời gian — nhưng khác **mục tiêu**. **Fama-MacBeth** là bản academic đầy đủ: một thủ tục **suy luận** (inference). Barra-style daily cross-sectional regression của practitioner giống hệt *bước 2* của Fama-MacBeth — ước lượng factor return $\lambda_t$ cho mỗi kỳ — nhưng dừng ở chuỗi $\lambda_t$ để nuôi risk model, trong khi Fama-MacBeth đi tiếp *bước 3*: lấy trung bình $\bar\lambda$ và tính SE theo thời gian để kiểm định premium. Cùng vòng lặp, hai đích đến khác nhau.
...
**Bước 3 — trung bình và kiểm định.** Premium ước lượng là trung bình chuỗi: $\bar\lambda = \frac{1}{T}\sum_t \lambda_t$. Sai số chuẩn là $SE = \text{std}(\lambda_t)/\sqrt{T}$ — nhưng công thức này chỉ đúng khi chuỗi $\lambda_t$ độc lập theo thời gian. Khi $\lambda_t$ **tự tương quan**, phải thêm hiệu chỉnh **Newey-West**; nguồn của autocorrelation gồm forward return **chồng lấn** (overlapping windows), sự **dai dẳng của bản thân premium**, và **stale/non-synchronous prices** — chứ không riêng gì trường hợp exposure momentum 12 tháng trượt cửa sổ. t-stat $= \bar\lambda / SE$.
...
Chuỗi $\{\lambda_t\}$ này chính là chỗ hai trường phái dùng chung một cỗ máy: với academic nó là đầu vào của **máy kiểm định** (t-stat của $\bar\lambda$ ở bước 3); với practitioner nó **chính là daily factor return** của risk model — thứ ta sẽ đưa vào ma trận $F$ ở mục sau. Cùng một vòng lặp cross-section, hai đích đến. Trong `src/alpha`, `crossSectionalFactorModel` minh họa đúng vòng lặp này ở dạng **tối giản** (OLS cross-section mỗi kỳ + sample covariance của factor returns) — nó là bộ khung, chưa phải một risk model engine cấp thương mại; những tinh chỉnh ở mục sau mới là thứ tách bản đồ chơi khỏi bản chạy tiền thật.
...
Vendors thương mại: MSCI Barra, Axioma (nay thuộc SimCorp), Bloomberg — mọi quỹ equity nghiêm túc hoặc mua vendor hoặc tự xây bản nội bộ (nhiều quỹ lớn xây riêng để kiểm soát định nghĩa factor và tránh crowding với người dùng vendor). Trong `quantc`, `src/alpha` mới chỉ có **bộ khung tối giản** của một risk model kiểu này (cross-section OLS + sample covariance); đúng bốn quyết định ước lượng ở trên — WLS theo $\sqrt{\text{mktcap}}$ và ràng buộc industry, EWMA hai half-life kèm Newey-West và vol-regime, idio shrinkage, winsorize + industry-median fill — chính là khoảng cách giữa bộ khung đó và một engine cấp Barra.
...
Cả sample covariance lẫn PCA đều bệnh cùng một chỗ: khi $N$ và $T$ cùng lớn và cùng cỡ, **phần lớn eigenvalue nhỏ là nhiễu thuần túy**, không mang thông tin, nhưng nếu bạn dùng chúng nguyên xi trong optimizer thì optimizer sẽ "tin" vào các hướng nhiễu đó và dồn tiền vào chúng — đúng cái mà chương portfolio construction gọi là "error maximization". **Random Matrix Theory (RMT)** cho ta một dao mổ sắc để tách tín hiệu khỏi nhiễu, và module `rmt` trong `src/alpha` làm một **bản đơn giản** của việc này (dùng $\sigma^2 = 1$ cố định thay vì fit bulk — xem bước 2).
...
Một lưu ý convention quan trọng khi $q = N/T > 1$ (nhiều tài sản hơn số quan sát — đúng chế độ $N > T$ mà các mục trước cảnh báo): sample correlation matrix bị suy biến, có $N - T$ eigenvalue **bằng 0**, và phân phối MP khi đó mang thêm một khối xác suất khối lượng $1 - T/N$ **tại 0**, còn biên $\lambda_-$ đổi ý nghĩa. Đừng áp thẳng cặp $\lambda_\pm$ ở trên cho trường hợp $q > 1$ — ví dụ dưới đây cố ý lấy $q = 0.5 < 1$ để công thức dùng được nguyên bản.
...
**Bước 2.** Tính $\lambda_+$ theo Marchenko-Pastur từ $q = N/T$ (module `rmt` lấy $\sigma^2 = 1$; một bản tinh vi hơn sẽ **fit $\sigma^2$** bằng cách khớp phần bulk của phổ eigenvalue với phân phối MP lý thuyết, vì phần variance đã bị các factor thật hút mất nên $\sigma^2$ hiệu dụng của phần nhiễu nhỏ hơn 1 — với bảng của ta, ba PC đầu đã hút $28\%$ variance, nên nhiễu chỉ còn chia nhau ~$72\%$, kéo $\lambda_+$ hiệu dụng xuống dưới $2.92$ một chút).
...
Tệ hơn nữa cho cả các factor **thật**: McLean & Pontiff (2016) đo return của factor **trước và sau** khi paper công bố, và thấy factor return sau publication thấp hơn trung bình **~58%**. Nhưng phải tách con số này như Chương 1 đã nhấn, đừng gộp cả 58% vào "arbitrage": khoảng **26%** trong đó là *out-of-sample decay* thuần túy — phần bias in-sample tự bay hơi khi ra ngoài mẫu, xảy ra **dù có công bố hay không**; chỉ phần dôi ra (~58% − 26% ≈ 32%) mới đúng là **hiệu ứng publication** — thị trường đọc paper, arbitrage ùa vào, giá điều chỉnh, edge co lại. Để thấy con số này cắn thế nào, hãy áp vào một factor có Sharpe gross $0.6$ trước publication: sau khi return co $58\%$, và giả sử vol không đổi, Sharpe rơi về $0.6 \times 0.42 = 0.25$ — từ một chiến lược đáng chạy thành một chiến lược mà sau phí gần như không còn gì. Bài học kép, và nó định hình cả sự nghiệp của bạn:
...
5. **Smooth** (EMA vài ngày) nếu turnover quá cao so với horizon của tín hiệu — nhưng vì EMA làm mượt *theo từng tên dọc thời gian*, cross-section sau khi mượt không còn chắc mean 0 / std 1, nên phải **chuẩn hóa lại** (re-rank hoặc re-z-score, và re-neutralize nếu cần) sau bước này; hoặc gọn hơn, smooth *raw signal trước* rồi mới winsorize → neutralize → z-score ở cuối.
...
a2 = rank(close/ts_mean(close, 252) - 1)               // trend: giá vs trung bình 252 ngày (proxy, không phải return 12-1 canonical)
...
Từng dòng đơn lẻ cho IC quãng 0.01–0.03, không đáng trade sau phí. Giá trị nằm ở chỗ chúng **ít tương quan với nhau** vì đến từ những nguồn thông tin khác nhau — giá, volume, analyst, microstructure. Tổ hợp vài chục dòng như vậy, qua neutralization và optimizer, ra một chiến lược thật. Mô hình kinh doanh của WorldQuant đúng nghĩa đen là công nghiệp hóa việc sản xuất các dòng này — hàng triệu alpha trong kho, đãi lấy vài nghìn cái sống sót — một minh họa cực đoan của Fundamental Law mà ta sẽ dựng nền toán ở 7.3. Ở tầng code, năm dòng này ánh xạ gần như một-một sang các operator trong `src/alpha`: `ts_mean`, `ts_std` và `rank` (`csRank`) nằm trong operator registry `OPERATORS`, còn `ts_corr` là một ts-operator export riêng (nó nhận hai ma trận nên không đi qua registry một-tham-số như các cái kia); mỗi alpha là một biểu thức composable ghép các operator này — thêm `a6` không đụng vào bất kỳ dòng nào của năm alpha cũ.
...
**Signal decay.** Mọi alpha có một tốc độ phân rã: sau khi tín hiệu phát ra, forward return còn dự báo được trong bao lâu trước khi thông tin đã bị giá hấp thụ. Đo bằng cách tính IC của tín hiệu hôm nay với return ở nhiều horizon: 1 ngày, 5 ngày, 20 ngày, 40 ngày, 60 ngày, 90 ngày — theo quy ước **cumulative forward return** (tổng return từ hôm nay tới mốc horizon). Một chi tiết cài đặt cần biết: `alphaDecay`/`icSeries` trong `src/alpha` tương quan `signal[t]` với **một hàng** `returns[t+horizon]` — tức return *một kỳ* tại đúng offset đó, không phải tổng cumulative — nên muốn tái tạo đường cong holding-period ở đây, bạn phải truyền vào ma trận **forward-horizon return đã tính sẵn**, chứ không phải chuỗi return một-kỳ thô. Ví dụ một PEAD signal đo được IC theo horizon như sau:
...
Định lượng cái "trông như noise" đó cho cụ thể. Chuỗi IC 250 ngày với mean 0.03 và std 0.10 có standard error của mean $= 0.10/\sqrt{250} = 0.0063$, nên $t$-stat $= 0.03/0.0063 = 4.7$ — có ý nghĩa thống kê rất vững. Nhưng xác suất IC của *một ngày bất kỳ* âm là $\Phi(-0.03/0.10) = \Phi(-0.3) \approx 38\%$: gần bốn trên mười ngày, một tín hiệu thật trông "sai". Đây là con số bạn cần thuộc để không hoảng khi live. Một chuỗi *một tuần* (5 phiên) toàn âm nghe như thảm họa, nhưng với $p = 0.38$ mỗi ngày độc lập nó chỉ là $0.38^5 \approx 0.008$ — hiếm cho một cửa sổ cố định, nhưng qua ~250 phiên khởi đầu và nhiều tín hiệu chạy song song thì gần như *chắc chắn* gặp vài lần mỗi năm. Đừng đẩy con số này đi quá xa: một chuỗi **15 phiên** toàn âm chỉ là $0.38^{15} \approx 5\times10^{-7}$ — kể cả rải trên cả năm (~$10^{-4}$ cho một tín hiệu) và hàng trăm tín hiệu, nó vẫn rất khó xảy ra *thuần do xui*; một run dài đến thế thường là dấu hiệu **serial dependence hoặc regime xấu** (IC không còn độc lập ngày-qua-ngày), tức "tín hiệu đang chết" chứ không phải "tín hiệu tốt đang xui". Biết trước phân phối của cái xấu là cách duy nhất để phân biệt hai khả năng đó.

**Fundamental Law of Active Management** (Grinold 1989) là công thức triết lý của cả nghề. Dạng đầy đủ có thêm **transfer coefficient** $TC$ (phần tín hiệu sống sót qua ràng buộc danh mục — xem Chương 1 và 11):

$$IR \approx IC \times \sqrt{BR} \times TC,$$

trong đó IR là information ratio và BR là **breadth** — số cược **độc lập** mỗi năm. Bản gọn $IR \approx IC\sqrt{BR}$ mà ta dùng ngay dưới đây là trường hợp lý tưởng $TC = 1$ (không ma sát ràng buộc); $TC$ sẽ trở lại ở phần haircut cuối mục. Đọc thấm từng vế: kỹ năng dự báo (IC) nhân với **căn** của số lần đặt cược. Universe 4000 cổ phiếu × 250 ngày là $10^6$ cược danh nghĩa mỗi năm, nên IC 0.02 cho IR lý thuyết $0.02 \times \sqrt{10^6} = 20$. Con số hoang đường ấy chính là lời giải cho câu đố "IC bé thế sao RenTec giàu": **công nghiệp hóa số lượng cược yếu-mà-độc-lập**. Hệ quả chiến lược cũng ra thẳng từ công thức: tăng breadth — thêm tài sản, thêm thị trường, thêm tần suất, thêm tín hiệu *không tương quan* — thường dễ hơn tăng IC; và một cược vĩ mô mỗi quý (BR ~ 4) cần IC khổng lồ mới đáng, đó là lý do quant ít chơi trò dự báo Fed.
...
Chữ **độc lập** in đậm mới là chỗ toàn bộ khó khăn nằm ở đó, và định lượng nó là điều tách một QR nghiệp dư khỏi một QR ăn tiền. Các cược trong thực tế *không* độc lập, nên phải thay $BR$ bằng **breadth hiệu dụng** $N_{\text{eff}} \approx N/(1 + (N-1)\bar\rho)$, với $\bar\rho$ là correlation trung bình giữa các cược. (Đây là xấp xỉ **equicorrelation** — coi mọi cặp cùng $\bar\rho$; breadth thật với sector block, correlation âm, và ràng buộc danh mục sẽ lệch khỏi con số này, nên đọc nó như một ước lượng bậc nhất chứ không phải giá trị chính xác.) Lấy universe 3000 cổ phiếu, residual sau neutralize còn $\bar\rho = 0.02$:

$$N_{\text{eff}} = \frac{3000}{1 + 2999 \times 0.02} = \frac{3000}{60.98} \approx 49$$

cược độc lập mỗi kỳ rebalance — không phải 3000. Cộng thêm transfer coefficient $\approx 0.5$ (phần tín hiệu sống sót qua constraints, chương 11), IR lý thuyết 20 co về khoảng thực tế: $0.02 \times \sqrt{49 \times 250} \approx 2.2$ trước transfer, rồi $\times 0.5$ còn quãng 1.1, và một chiến lược tốt hạ cánh đâu đó trong dải 1.5–3. Lưu ý con số $250$ ở đây là **số phiên/năm, *trước* khi haircut cho tự tương quan thời gian**: vì tín hiệu hôm nay gần giống hôm qua, số *cược thời gian độc lập* thật sự nhỏ hơn 250 — đó là một phần lý do IR thực tế nằm dưới cận trên $2.2$ (bên cạnh transfer coefficient), và muốn chặt chẽ thì thay $250$ bằng một $N^{\text{time}}_{\text{eff}} < 250$. Bảng số này giải thích tại sao mọi mắt xích của pipeline — neutralization tốt (để $\bar\rho$ nhỏ), tín hiệu decay nhanh vừa đủ (cược mới thật), constraint lỏng đúng chỗ (TC cao) — đều trực tiếp quy ra Sharpe.
...
Định lượng cái phanh để thấy nó là số học chứ không phải phép màu. Giả sử vol realized dài hạn của danh mục momentum là 12%/năm và bạn nhắm đúng target vol 12%, nên scale nền $= 12/12 = 1.0$. Đầu 2009 vol realized 6 tháng của factor nổ lên 30%/năm, nên target-vol scaling cắt exposure xuống $12/30 = 0.40$: bạn vào cú crash với 40% vị thế bình thường thay vì full. Vì nhiều cú momentum crash *đi kèm vol (và crowding) nổ lên trước khi đảo chiều*, việc giảm size khi vol cao thường né được phần đáng kể cú mất mát mà **không cần dự báo được cú đảo chiều** — bạn chỉ phản ứng với một biến quan sát được là vol. Nhưng đừng thần thánh hóa: vol-target không bắt được *mọi* crash (có cú đảo chiều nổ ra khi vol còn thấp), và nó có thể delever đúng lúc thị trường bật lại — cắt luôn cả phần hồi phục; vol/crowding/bear-rebound là cảnh báo hữu ích, không phải lá chắn hoàn hảo. Sharpe cải thiện 0.5 → 1.0 đến từ đúng chỗ này: edge trung bình gần như giữ nguyên, nhưng cắt được cái đuôi trái nặng nhất nên std giảm, mẫu số của Sharpe co lại, và tỉ số phình lên.
...
Có một nguyên tắc thứ tự nên khắc cốt xuyên suốt mục này: **kết hợp ở tầng tín hiệu (alpha) trước, rồi mới tối ưu ở tầng danh mục (weight) — không trộn hai việc**. Alpha combination trả lời câu "cổ phiếu nào hấp dẫn hơn"; portfolio construction (chương 11) trả lời câu "cầm bao nhiêu mỗi cái dưới ràng buộc rủi ro và chi phí". Gộp lẫn hai tầng **một cách vô kỷ luật** — để optimizer vừa chọn tín hiệu vừa chọn trọng số danh mục cùng lúc mà không regularize hay attribution rạch ròi — dễ tạo ra một cỗ máy overfit không thể chẩn đoán: khi nó hỏng, bạn không biết là do tín hiệu tồi hay do trọng số danh mục sai, và không tách được thì không sửa được. (Joint optimization đa-alpha *có* tồn tại và chạy tốt ở các quỹ lớn khi được regularize mạnh và giữ attribution sạch — nguyên tắc ở đây là "đừng trộn tùy tiện", không phải "không bao giờ trộn".)
...
nghĩa là ngay cả khi *mọi* tín hiệu của bạn đều vô dụng, cái tốt nhất trong 1000 lần thử vẫn kỳ vọng show Sharpe quãng 1.18 chỉ nhờ hên. Nên một backtest Sharpe 1.2 sau 1000 lần thử gần như chắc chắn là đồ giả. (Công thức $SR_0 = \sqrt{2\ln N/T}$ chỉ là **xấp xỉ leading-order** cho kỳ vọng của max trên $N$ trial độc lập Gaussian; Deflated Sharpe đầy đủ ở Chương 9 còn tính cả skew/kurtosis của return và **correlation giữa các trial** — thường kéo số trial *hiệu dụng* xuống dưới $N$ danh nghĩa vì các lần thử không độc lập.) Không ghi chép số lần thử nghĩa là không biết ngưỡng này, và không biết ngưỡng này nghĩa là tự lừa mình một cách có hệ thống — bạn sẽ đều đặn cấp vốn cho những con số 1.2 mà lẽ ra phải vứt.

Trong `quantc`, các building block trong `src/alpha` **hỗ trợ đúng hướng kiến trúc** cho vòng đời này: signal là các đơn vị composable đăng ký qua registry (`SIGNALS`), dùng chung một backtest engine, đo IC và turnover theo cùng một chuẩn — thêm một alpha mới không đụng vào core. Nhưng đây mới là bộ khung, **chưa phải một platform production đầy đủ**: trong ba nỗi đau vừa kể, repo hiện *chưa* có hai mảnh — một **data layer dùng chung research/production** (thứ chống lỗi live-ra-0) và một **sổ ghi mọi thí nghiệm** (thứ chống multiple-testing tự lừa). Mảnh đã có là pipeline chuẩn hóa (mục 7.1) chạy giống hệt nhau ở mọi alpha, để cái duy nhất phân biệt một tín hiệu tốt với một tín hiệu tồi đúng là *giả thuyết kinh tế đằng sau nó* — chứ không phải một khác biệt vô tình trong cách một người tình cờ xử lý dữ liệu khác người kia.
...
Bài học đầu tiên và đau nhất: giá sai có thể *sai thêm* trước khi đúng, và bạn có thể phá sản trước khi được minh oan. De Long-Shleifer-Summers-Waldmann (DSSW, 1990) mô hình hóa điều này. Trong thị trường có "noise trader" — người giao dịch theo sentiment phi lý — arbitrageur biết một tài sản đang bị định giá cao 10% và short nó. Nhưng noise trader đang trong cơn hưng phấn có thể đẩy giá cao thêm 20% nữa. Arbitrageur short ở mức +10% giờ ôm khoản lỗ chưa thực hiện, có thể ăn margin call, buộc đóng vị thế đúng đáy của sự phi lý — tức mua lại ở +30% để cắt lỗ, khóa chặt khoản thua. Cái *rủi ro rằng sentiment đi ngược thêm* chính là noise trader risk, và nó là một rủi ro **khó hedge cho triệt để**: bạn có thể trung hòa bớt phần market/sector/crowding/liquidity bằng các proxy tương ứng, nhưng phần panic/short-squeeze *đặc thù của chính cơn hưng phấn đó* không có factor sạch nào để bù — và đúng phần residual ấy mới là rủi ro sống còn.
...
Overconfidence là *một* cách giải thích một sự thật vĩ mô gây tranh cãi: **excess volatility** (Shiller 1981). Giá cổ phiếu dao động mạnh hơn nhiều so với dòng cổ tức tương lai chiết khấu *ở discount rate cố định* có thể biện minh — Shiller đo rằng volatility thực của giá lớn gấp nhiều lần (bội số 5-13 lần theo các ước lượng của ông) so với volatility mà mô hình present-value của cổ tức cho phép; thị trường "quá xúc động". Nhưng đừng quy vội toàn bộ cho tâm lý: phần lớn cái "excess" ấy có thể đến từ **discount rate biến thiên theo thời gian** và **risk premium thay đổi** (Cochrane), cùng các giả định về payout — một lời giải thuần *rational*; overconfidence chỉ là một trong nhiều nguồn khả dĩ. Excess volatility là nền cho mọi chiến lược mean-reversion và variance-selling: nếu giá dao động quá mức so với fundamental, đứng bán sự dao động đó (fade extremes, bán vol) có kỳ vọng dương. Đây cũng là điểm giao P/Q: variance risk premium — implied vol trung bình cao hơn realized vol — một phần là phần bù cho việc gánh rủi ro tail, một phần là hệ quả của việc người mua bảo hiểm (option) over-pay vì sợ hãi (xem cuốn Q-world về variance risk premium).
...
Đây là alpha *không* phải "sai giá" mà là **phần bù cho việc gánh một rủi ro mà người khác muốn tránh**. Nó bền **chừng nào rủi ro đó — và mandate/khẩu vị của những người muốn né nó — còn tồn tại**: vì nó không phải lỗi của ai để mà bị "sửa", nó là giá của bảo hiểm. Value là ví dụ kinh điển: cổ phiếu rẻ (price/book thấp) *rẻ có lý do* — chúng là công ty gặp khó, và bạn được trả premium vì ôm rủi ro rằng chúng gặp khó *đúng lúc bạn cũng đang khó* (Fama-French: value là distress risk; Campbell-Cochrane: nó co-vary với marginal utility xấu — bạn lỗ nhất đúng lúc một đồng đô đau nhất). Đặc điểm nhận diện quyết định: **risk premium đau đúng lúc tệ nhất**. Value crash 2017-2020 (một chu kỳ đau kéo dài, rồi bật lại mạnh 2021-22) không phải dấu hiệu value "chết" mà chính là *cơ chế* của premium — nếu nó không bao giờ đau, sẽ không có ai được trả để ôm.

Con số. Value premium historical (HML của Fama-French) annualized khoảng 3-5% với vol ~10%, tức Sharpe $\approx 0.04/0.10 = 0.4$ — thấp so với momentum nhưng **bền bỉ và capacity khổng lồ** (nó là factor công khai, hàng trăm tỷ đô chạy nó). Hệ quả quản lý: *đừng* cắt risk premium **chỉ vì** drawdown — cắt value đáy 2020 là khóa lỗ đúng trước khi được trả công. (Nhưng "không cắt vì drawdown" không phải giấy phép nhắm mắt giữ: vẫn phải re-evaluate nếu *cấu trúc* premium đổi — crowding tăng vọt, implementation cost bào hết biên, hay câu chuyện rủi ro nền tảng không còn đúng.) Bạn size nó theo vốn dài hạn, chịu horizon nhiều năm, và *không* mong alpha residual sau khi trừ factor: hồi quy return chiến lược value của bạn lên HML cho beta ~1 và alpha ~0 vì **nó LÀ factor**, không phải bí mật của bạn. Carry (FX carry, commodity roll, bond carry) cùng loại: bạn được trả vì đứng bán bảo hiểm cho ai cần phòng ngừa — và carry "hoạt động tới khi không" (carry crash khi risk-off dồn dập, tất cả các cặp carry cùng gãy một lúc).

### Loại 2 — Behavioral: bị arbitrage dần khi lộ

Đây là alpha từ *lỗi* con người (mục 8.3): momentum (disposition/under-reaction), PEAD (conservatism), long-term reversal (overreaction). Điểm sống còn: vì nó là *lỗi*, nó *có thể bị sửa* — khi đủ vốn thông minh học được và đứng bên kia, edge co lại. Hồ sơ tuổi thọ: **hữu hạn và suy giảm sau publication**, được limits to arbitrage bảo vệ tạm thời chứ không vĩnh viễn. Lưu ý momentum là một *hybrid*: nguồn của nó là behavioral (disposition/under-reaction), nhưng nó được che một phần bởi **crash risk / limits to arbitrage** (cái đuôi $-25\%$ năm 2009 là phần bù rủi ro giữ nó sống, mục 8.3) — nên nó vừa decay như một behavioral alpha vừa mang một cấu phần *risk-premium-like*, không thuần một loại nào.

Định lượng suy giảm bằng McLean-Pontiff (2016) với phép tính cụ thể. Giả sử một anomaly cho long-short return **6%/năm in-sample** (con số điển hình của một anomaly công bố). McLean-Pontiff đo alpha rớt trung bình khoảng **26%** *ngoài mẫu* — phần này chủ yếu là data-mining trong mẫu gốc bị lột ra, xảy ra dù có công bố hay không, không phải arbitrage: $6\% \times (1 - 0.26) = 4.44\%$/năm. Cộng thêm phần bị arbitrage sau khi paper lan ra (thêm ~32 điểm phần trăm), tổng suy giảm chạm ~58%: $6\% \times (1 - 0.58) \approx 2.52\%$/năm. Nói cách khác, một anomaly hào nhoáng 6% in-sample thực chất chỉ còn kỳ vọng quãng **2.5-4.4%/năm** trong tay bạn — và co tiếp khi crowding tăng. Đây là lý do momentum *thô* 12-1 (đã in từ 1993) chỉ còn Sharpe ~0.75 sau phí chứ không phải con số hào nhoáng của paper gốc — nó đã bị bào ba thập kỷ. Hệ quả quản lý ngược hẳn Loại 1: behavioral alpha *cần* được theo dõi crowding sát sao, cắt khi tín hiệu decay (live-vs-backtest tracking, chương 7), và giá trị của researcher là *biến thể tốt hơn* — momentum có phanh vol (constant-volatility scaling nâng Sharpe từ ~0.5 lên quãng 1.0) là cách ăn phần premium mà version thô đã trả hết qua crash. Behavioral alpha là tài sản hao mòn; bạn phải liên tục làm mới.
...
| **Behavioral** | Lỗi hệ thống của con người | Người mắc lỗi (disposition, overreaction) | Hữu hạn; OOS decay ~26%, tổng sau publication ~58% (6%→~2.5-4.4%) | Theo dõi crowding; biến thể tốt hơn; cắt khi decay | Momentum 12-1: IC 0.025, SR sau phí 0.75, MDD -25% (2009) |
