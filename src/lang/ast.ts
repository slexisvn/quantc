...
export type Expr =
  ...
  | { readonly kind: 'let'; readonly name: string; readonly value: Expr; readonly body: Expr; readonly pos: Position }
...
export type Stmt =
  ...
  | { readonly kind: 'pay'; readonly amount: Expr; readonly date: Expr; readonly currency: string | null; readonly pos: Position }
...
export interface Underlying {
  ...
  readonly modelParams: ModelParam[]
  readonly pos: Position
}
