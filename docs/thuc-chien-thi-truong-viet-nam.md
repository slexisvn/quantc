...
> Tài liệu companion cho hai cuốn [P-World](p-world.md) (alpha research, buy-side) và [Q-World](q-world.md) (derivatives pricing, sell-side). Đây là lớp "dịch" toàn bộ framework trong hai cuốn sang **thực chiến thị trường chứng khoán Việt Nam**: những gì áp dụng thẳng, những gì phải chỉnh, và những gì chưa dùng được — cùng lộ trình cụ thể để xây một hệ thống giao dịch định lượng tại VN. Bám cơ chế & quy định thị trường VN hiện hành (2026: hậu KRX go-live; FTSE đã *xác nhận* nâng hạng Secondary Emerging Market, hiệu lực 21/09/2026 — chưa hoàn tất tại thời điểm tài liệu).
>
> **Lưu ý quan trọng:** đây là tài liệu *phương pháp*, không phải khuyến nghị đầu tư hay lời hứa sinh lời. Thị trường VN đang cải cách nhanh (KRX là *nền tảng kỹ thuật* cho short selling, T+0, options — nhưng mỗi tính năng bật theo quy định & thông báo riêng, chưa có lịch cố định); **luôn kiểm tra quy định & biểu phí hiện hành với công ty chứng khoán của bạn** trước khi triển khai vốn thật.
...
Ở Việt Nam, **cả hai đều dịch chuyển** — theo hai hướng ngược nhau: một hướng *lấy đi* của bạn một công cụ, một hướng *dịch cán cân* về phía bạn.

**Hệ quả (a) — mất công cụ short.** Bán khống cổ phiếu cơ sở với nhà đầu tư retail ở VN **hiện chưa làm được**; lộ trình securities borrowing & lending và covered short đang được xây dựng qua hệ thống KRX nhưng còn chờ khung pháp lý và thông báo riêng, chưa có mốc thời gian chắc chắn. Nghĩa là toàn bộ họ chiến lược dựa trên short *trên cổ phiếu* — market-neutral, pairs, stat-arb hai chân long/short cùng lúc trên equity — **chưa chạy được**. Đây không phải chi tiết nhỏ: đó là nửa cái toolbox trong Chương 5 (lý thuyết danh mục), Chương 11 (portfolio construction) và Chương 15 (bản đồ chiến lược) của cuốn P. Nếu bạn muốn short hoặc phòng hộ, cửa hiện có là **index futures** niêm yết trên HNX — cho phép long/short cả hai chiều, giao dịch intraday, có đòn bẩy. Chủ lực và thanh khoản nhất là **VN30 Index Futures** (tài sản cơ sở là chỉ số VN30); từ **10/10/2025** có thêm **VN100 Index Futures** (rổ rộng hơn, phủ ~88% vốn hóa HOSE) — nhưng thanh khoản VN100 futures thường mỏng hơn VN30, nên VN30 vẫn là hợp đồng mặc định cho hầu hết chiến lược. Vì thế Mục 4 chia thế giới của bạn làm đúng hai sân: *long-only trên cổ phiếu* và *hai chiều trên VN30/VN100 futures* — và bạn phải học sống trong ranh giới đó thay vì mơ về pairs trading trên hai mã ngân hàng.

**Hệ quả (b) — nhiều khả năng có behavioral edge.** Cẩn thận đừng dựng một đối lập giả: cuốn P **không** bảo "anomaly đơn giản đã chết". Ngược lại, **Chương 8** cho thấy momentum công khai vẫn sống sau ba thập kỷ; điều P nói là ở thị trường phát triển alpha công khai đã *yếu đi, crowded và phụ thuộc regime* vì lực arbitrage mạnh. Giả thuyết cho VN là thị trường nới đúng chỗ đó. Khoảng **85–90% giá trị giao dịch** (theo *giá trị*, không phải chỉ đếm số lượng cổ phiếu) trên thị trường VN đến từ nhà đầu tư **cá nhân (retail) trong nước**. Một thị trường bị chi phối bởi noise trader, lại thiếu lực arbitrage để dập — một phần chính vì không short được (hệ quả (a) quay lại thành lợi thế) — là môi trường mà **các anomaly behavioral có nhiều dư địa sống hơn**. Nhưng đây là một **giả thuyết cần kiểm định, không phải kết luận đóng đinh**: nghiên cứu thực nghiệm tại VN có tìm thấy momentum, song kết quả phụ thuộc giai đoạn mẫu và cách kiểm soát rủi ro; reversal và dấu vết dòng tiền (flow) — gồm cả **dòng tiền khối ngoại** công bố theo mã mỗi ngày, một nguồn tín hiệu đặc thù của VN — đều cần backtest trung thực xác nhận trước khi tin. Chính **Chương 8 (Behavioral & limits to arbitrage)** của cuốn P mô tả *cơ chế* sinh ra những anomaly này. Định hướng thực chiến (chưa phải kết luận): ở VN bạn có lý do để **thử tín hiệu đơn giản trước** — một momentum sạch, một filter thanh khoản, một chút kỷ luật risk — thay vì lao thẳng vào mô hình 200 feature, rồi để dữ liệu VN tự nói nó sống được đến đâu.
...
Lấy **HOSE** làm chuẩn: ngày giao dịch cổ phiếu chia làm phiên sáng **9:00–11:30** và phiên chiều **13:00–14:45**, và — đây là điểm khác biệt lớn nhất so với microstructure trong Ch12 P-World — nó **không phải một phiên khớp lệnh liên tục duy nhất**. Cấu trúc HOSE gồm ba giai đoạn khác nhau về bản chất khớp lệnh:
...
**HNX và UPCoM chạy lịch khác HOSE — đừng bê nguyên ba phiên trên sang hai sàn này.** HNX **không có ATO**: mở cửa bằng khớp liên tục ngay từ 9:00, có ATC 14:30–14:45, và sau đó là **phiên PLO (Post Limit Order) 14:45–15:00** khớp ở đúng giá đóng cửa — thứ HOSE không có. UPCoM có cấu trúc đơn giản nhất: **không ATO cũng không ATC**, chỉ khớp liên tục kéo dài tới **15:00**. Nghĩa là "giờ đóng cửa" và cơ chế chốt giá close khác nhau giữa ba sàn; một engine dùng chung một lịch phiên cho cả ba sẽ sai với HNX/UPCoM. Phần "Ý nghĩa giao dịch" dưới đây mô tả cơ chế call-auction của HOSE; với HNX phải tính thêm PLO, với UPCoM thì giá close là giá khớp liên tục cuối phiên chứ không phải giá đấu giá.
...
Lô giao dịch chuẩn (lô chẵn) trên HOSE là **100 cổ phiếu**; số lẻ 1–99 cổ phiếu (lô lẻ) giao dịch theo cơ chế riêng, thanh khoản kém. Sau KRX, lô lẻ **vẫn được giao dịch** (kể cả tham gia phiên định kỳ bằng lệnh LO), nên không hẳn là "cấm" số lẻ — vị thế 137 cổ phiếu về nguyên tắc có thể dựng bằng leg 100 (lô chẵn) cộng leg 37 (lô lẻ). Nhưng với người xây danh mục, **thực dụng nhất vẫn là làm tròn khối lượng mỗi lệnh về bội số của 100**: leg lô lẻ thanh khoản mỏng và cần mô hình thanh khoản/slippage riêng, nên bạn không dựng được vị thế "137 cổ phiếu" một cách *trơn tru* trong khối lô chẵn. Ràng buộc lô chẵn này ăn thẳng vào bài toán position sizing của Ch11 P-World (Portfolio construction): với tài khoản nhỏ và cổ phiếu giá cao, bước nhảy 100 cổ phiếu có thể là một phần đáng kể vốn, làm trọng số danh mục thực tế lệch khỏi mục tiêu tối ưu mà bộ tối ưu hóa trả về. Đây là một nguồn tracking error hệ thống mà backtest phải mô phỏng chứ không được bỏ qua — nếu không, engine sẽ giả định bạn nắm được đúng trọng số phân số mà thị trường không cho phép.
...
Biên độ còn đặt một trần lên phân phối return *của phiên thường*: giá trong phiên được phép dao động quanh **giá tham chiếu** ±7% (HOSE), nên **phần lớn** return close-to-close nằm trong $[-7\%, +7\%]$ — nhưng **không phải mọi return đều thế**. Ngoại lệ gồm ngày chào sàn (biên ±20%), ngày giao dịch không hưởng quyền (giá tham chiếu bị điều chỉnh theo cổ tức/phát hành, nên close-to-close *thô* có thể vượt ±7%) và các trường hợp giá tham chiếu đặc biệt. Điểm mấu chốt cho engine: biên độ neo vào **giá tham chiếu** của phiên chứ không vào giá đóng cửa hôm trước. Ở phiên thường, việc chặn này bóp đuôi phân phối và ảnh hưởng tới mọi ước lượng rủi ro trong Ch14 (Risk management) P-World — VaR và vol tính từ dữ liệu bị censoring ở biên sẽ thiên lệch xuống, khiến bạn *đánh giá thấp* rủi ro thật. Và một chuỗi "kịch sàn nhiều phiên liên tiếp" chính là dấu hiệu một cú sập bị biên độ *trải mỏng ra nhiều ngày* thay vì rơi hết trong một phiên: cú giảm 25% ngoài đời có thể hiện ra trong data thành bốn phiên sàn trông "hiền" — một cái bẫy khác cho bất kỳ mô hình rủi ro nào đọc return ngày một cách máy móc.

### 2.6 Room ngoại và dòng tiền khối ngoại

Mỗi mã có **trần tỷ lệ sở hữu nước ngoài** (foreign ownership limit — FOL, "room ngoại"). Trần này **không phải một hằng số đồng nhất**: nó phụ thuộc điều ước quốc tế, pháp luật chuyên ngành, danh mục ngành hạn chế/có điều kiện và các quy định chuyển tiếp (khung hiện hành: Nghị định 155/2020, sửa đổi bởi Nghị định 245/2025). Các mốc hay gặp là **49%** ở nhiều ngành hạn chế và **30%** với ngân hàng, nhưng ngành **không thuộc diện hạn chế có thể không bị giới hạn room**. Mã **hết room** thì nhà đầu tư nước ngoài thường chỉ mua thêm được qua thỏa thuận và phải trả **premium** — nhưng đây **không phải lối thoát chung**: nó chỉ khả thi trong các cấu trúc **không làm tăng tổng sở hữu nước ngoài** (mua lại từ nhà đầu tư ngoại khác), chứ không cho phép nâng tổng room quá trần. Song song, **giao dịch mua/bán ròng của khối ngoại được công bố hằng ngày theo từng mã**.
...
- **Hệ thống KRX go-live 5/5/2025** (công nghệ Hàn Quốc): đây chỉ là **nền tảng kỹ thuật** có thể *hỗ trợ* T+0, bán khống, options và settlement nhanh hơn — bản thân KRX không tự bật các sản phẩm đó. Mỗi tính năng cần **quy định và thông báo riêng** (chính FAQ của công ty chứng khoán khi KRX ra mắt nói rõ chưa có hướng dẫn cho các sản phẩm mới). Vì thế **tránh gắn một mốc thời gian cứng** (kiểu "hoàn tất trong 2026–2028") khi chưa có văn bản nguồn; nguyên tắc an toàn: đừng viết chiến lược dựa trên một tính năng "sắp có" cho tới khi có quy định cụ thể và nó thực sự bật.
- **FTSE Russell đã *xác nhận* (4/2026) nâng hạng VN lên Secondary Emerging Market**, **hiệu lực từ 21/09/2026** và đưa vào rổ theo **nhiều đợt (tranche) kéo dài sang 2027**. Tại thời điểm tài liệu này, việc nâng hạng đã được xác nhận nhưng **chưa có hiệu lực, chưa hoàn tất**. Khi có hiệu lực, nó kéo dòng vốn ngoại thụ động (ETF và quỹ index) vào các mã trong rổ → mở cơ hội **event-driven** quanh nâng hạng và các đợt rebalance rổ chỉ số.
...
| Giờ & phiên — HOSE | 9:00–11:30 & 13:00–14:45; ATO (9:00–9:15), khớp liên tục, ATC (14:30–14:45), thỏa thuận | Close = giá call-auction (ATC); tín hiệu trên close thực thi từ $t+1$ |
| Giờ & phiên — HNX | **Không ATO**; khớp liên tục từ 9:00, ATC 14:30–14:45, **PLO 14:45–15:00** | Lịch khác HOSE; có PLO khớp ở giá đóng cửa |
| Giờ & phiên — UPCoM | **Không ATO/ATC**; chỉ khớp liên tục tới **15:00** | Close = giá khớp liên tục cuối phiên, không phải đấu giá |
...
| Short cơ sở | Retail CHƯA làm được (còn chờ khung pháp lý) | Muốn short/leverage → index futures (VN30 chủ lực; VN100 từ 10/2025) |
| Bối cảnh | KRX 5/2025 (nền tảng; tính năng bật theo quy định riêng); FTSE EM hiệu lực 21/9/2026; CCP ~Q1/2027 | Cấu hình cơ chế phải tách khỏi logic → dễ đổi khi T+1/short bật |

Nắm chắc các dòng bảng này, bạn đã có bộ ràng buộc để đối chiếu mọi chiến lược trong hai cuốn sách: cái nào chạy thẳng trên equity VN, cái nào phải lách (mục 3), và cái nào buộc phải chuyển sang futures (mục 4). Mọi mục còn lại của chương này đều là hệ quả của bảng đó.
...
Đây là ràng buộc nặng nhất. Retail VN **hiện chưa bán khống được cổ phiếu cơ sở** (SBL — securities borrowing & lending — cùng covered short còn chờ khung pháp lý và thông báo riêng qua hệ thống KRX, chưa có mốc thời gian chắc chắn). Lưu ý phạm vi: cái *thiếu* ở đây là **short**, không phải đòn bẩy — retail vẫn vay được tiền mua cổ phiếu qua **margin** (xem Mục 4). Toàn bộ họ chiến lược mà cuốn P dựng trên khả năng short một rổ cổ phiếu đều **không thể triển khai nguyên trạng**:
...
1. **Đẩy toàn bộ nhu cầu short/hedge sang index futures.** VN30 Index Futures (niêm yết HNX từ 8/2017) cho **long/short cả hai chiều, giao dịch intraday, đòn bẩy**, hệ số nhân 100.000 VND/điểm chỉ số; từ 10/10/2025 có thêm VN100 futures nhưng thanh khoản còn rất mỏng nên VN30 vẫn là lựa chọn thực tế. Một chiến lược "long một rổ cổ phiếu + short VN30 futures để trung hòa beta thị trường" cho bạn một **danh mục beta-hedged — không phải market-neutral thực thụ**: nó chỉ khử **beta ước lượng** so với VN30 (mà beta thay đổi theo thời gian), và vẫn để lại nguyên rủi ro **sector, size, value, idiosyncratic**, cộng **tracking error** (rổ của bạn khác rổ VN30) và **basis risk** (futures lệch spot). Nói đúng hơn: nó tái tạo *một phần* tinh thần market-neutral của Ch11/Ch14 — bạn khử được rủi ro thị trường hệ thống, phần chiếm phần lớn variance của một danh mục cổ phiếu VN, chứ không phải toàn bộ rủi ro chung. Chi tiết cấu trúc beta-hedge này thuộc Mục 8.
...
3. **Chờ hạ tầng.** Khi SBL/covered short mở cho retail (còn chờ khung pháp lý, chưa có mốc chắc chắn), một phần của Ch15 sẽ "mở khóa". Nhưng lưu ý cái nó cần **không phải Greeks** — Greeks là chuyện của quyền chọn/CW, không phải short cổ phiếu. Short cổ phiếu cần một hạ tầng cho vay chứng khoán: **nguồn hàng để vay (borrow availability), chi phí vay (borrow cost), tài sản thế chấp (collateral), rủi ro bị gọi trả hàng (recall), và xử lý corporate action** trên vị thế short. Đó mới là bộ công cụ phải dựng khi lớp này mở. Nguyên tắc production: **không thiết kế hệ thống hôm nay dựa trên một tính năng chưa tồn tại**.

### 3.2. T+2 — chặn day-trade ở thị trường cơ sở

Chu kỳ thanh toán ở thị trường cơ sở là **T+2**: **chính lô cổ phiếu vừa mua chưa bán lại được cho tới khi về tài khoản (~T+2)**. Sắc thái quan trọng, đừng nói quá: T+2 *không* cấm mọi giao dịch trong ngày — nếu bạn đã có sẵn **hàng đã thanh toán** (mua từ các phiên trước), bạn vẫn có thể bán số hàng đó và đặt lệnh mua cùng mã trong phiên liên tục cùng ngày. Cái T+2 chặn là *quay vòng đúng lô vừa mua*, không phải toàn bộ hoạt động intraday. Dù vậy, với retail, các chiến lược **high-turnover intraday trên cổ phiếu cash vẫn khó chạy** — và không chỉ vì T+2. Cụ thể trong P:

- **HFT & market-making tầng microstructure** (Ch12 microstructure, Ch13 execution): không khả thi ở cash equity cho retail — nhưng vì cả một *chùm* rào cản chứ không riêng T+2: quyền truy cập thị trường, quản trị inventory, phí giao dịch, latency, thiếu công cụ short, và hạ tầng (không co-location). T+2 chỉ là một mảnh.
...
$$\text{fill}_{t} = \begin{cases} \text{no fill} & \text{giá khóa ở trần/sàn và KHÔNG có thanh khoản đối ứng phía bạn cần}\\ \text{fill một phần, giới hạn bởi volume đối ứng} & \text{giá khóa nhưng có đối ứng (theo queue position)}\\ \text{fill kèm slippage} & \text{ngược lại}\end{cases}$$

Điểm cần chính xác: kịch trần/kịch sàn **không** có nghĩa "không bao giờ khớp". Vẫn có giao dịch nếu xuất hiện bên đối ứng; vấn đề chỉ là **thứ tự hàng chờ (queue position)** và khối lượng đối ứng có đủ chạm tới lệnh của bạn hay không. Vì thế engine mô hình *xác suất và mức độ* khớp theo dữ liệu sẵn có, chứ không áp một luật tuyệt đối: (1) **không khớp** khi giá bị khóa ở biên **và không có thanh khoản đối ứng** ở phía bạn cần; (2) nếu **có dữ liệu order book**, mô hình **queue position** — lệnh chỉ khớp phần nào tùy khối lượng đối ứng chạm tới chỗ bạn đứng trong hàng chờ; (3) nếu **chỉ có OHLCV**, chạy **hai kịch bản** — *strict no-fill* (không khớp gì ở phiên kịch biên) và *fill giới hạn bởi volume* (khớp tối đa một phần nhỏ volume phiên) — rồi báo cáo cả hai như một **khoảng**, **không coi strict no-fill là "sự thật"** mà chỉ là một cận; (4) coi những ngày locked-limit như **partial/missed trades**, và tính cả cái giá của việc kẹt hàng khi một mã nằm sàn nhiều phiên liên tiếp mà bạn không thoát được. Ràng buộc này thực chất là một **limit to arbitrage** rất đặc thù VN (Ch8): edge tồn tại trên giấy nhưng cơ chế thị trường chặn bạn thu hoạch đúng lúc nó lớn nhất.
...
| Pairs trading / stat-arb (Ch7, Ch15) | **Không dùng được** trực tiếp | Chưa short cổ phiếu | Chuyển sang long-only relative strength; chờ SBL (chưa có mốc chắc chắn) |
| Long/short & market-neutral equity (Ch11, Ch14, Ch15) | **Không dùng được** nguyên trạng | Chưa short cổ phiếu | Beta-hedge bằng VN30 futures (Mục 8) — **beta-hedged, KHÔNG phải market-neutral** |
...
| Vol-targeting sizing (Ch14) | **Chạy thẳng** | — | Áp trực tiếp lên rổ long-only hoặc danh mục futures |
| Risk parity (Ch11, Ch14) | **Phải chỉnh** | Ít risk sleeve / tài sản giao dịch được | Cần nhiều sleeve rủi ro; hạn chế khi chỉ có 1 rổ long-only + 1 futures |
| Kelly / fractional-Kelly sizing (Ch14) | **Chạy thẳng** (thận trọng) | Dữ liệu ngắn → ước lượng edge kém tin | Dùng fractional Kelly; deflated Sharpe là công cụ *sàng lọc* riêng, không phải đầu vào trực tiếp co Kelly |
...
| Behavioral alpha / limits to arbitrage (Ch8) | **Chạy thẳng** (giả thuyết: có thể mạnh hơn) | — | Retail ~85–90% *giá trị* giao dịch → noise trader dày; edge đảo chiều/dòng tiền *có thể* lớn hơn — cần kiểm định |

Điểm cần nhớ: cột "không dùng được" gần như luôn là hệ quả của **một** ràng buộc (chưa short, hoặc T+2), và gần như luôn có **một** đường vòng — qua VN30 futures, hoặc qua việc thu hẹp về position-trading long-only. Ngược lại, lớp behavioral của Ch8 không bị chặn, và **nhiều khả năng được khuếch đại** bởi cấu trúc retail-nặng (~85–90% *giá trị* giao dịch đến từ nhà đầu tư cá nhân) của thị trường VN — đây là **giả thuyết cần kiểm định**, chưa phải dữ kiện đã chứng minh, nhưng đủ cơ sở để các Mục 6 (tín hiệu alpha) và 11 (template) dồn trọng tâm vào đó thay vì vào bộ máy long/short kinh điển của sách.


## 4. Hai sân chơi: VN30 futures vs long-only equity

Trước khi viết một dòng code alpha nào, người làm quant ở Việt Nam phải trả lời một câu rất cụ thể: *tôi sẽ trade cái gì?* Đây không phải câu hỏi cảm tính — nó quyết định **bạn được dùng bao nhiêu phần của cuốn P-World**. Lý do rất trực tiếp, và cần **tách bạch hai kỹ thuật**: **bán khống (short)** cổ phiếu cơ sở thì retail VN **hiện chưa làm được** (SBL/covered short còn chờ khung pháp lý, chưa có mốc chắc chắn); còn **đòn bẩy (leverage)** thì retail **vẫn có** — qua **giao dịch ký quỹ (margin)** trên danh mục chứng khoán đủ điều kiện ký quỹ (Thông tư 120/2020/TT-BTC). Nghĩa là cái *thực sự* thiếu ở tầng cổ phiếu là **short**, không phải đòn bẩy; và khi tài liệu này khuyên long-only "không đòn bẩy", đó là một **lựa chọn cash-only** để kiểm soát rủi ro, không phải một hạn chế của thị trường. Bất cứ chiến lược nào trong sách mặc định "short cổ phiếu là chuyện đương nhiên" đều gãy ngay khúc này (chi tiết ràng buộc ở Mục 3).
...
Đây là sân cho phép cả long lẫn short, giao dịch **intraday** (mua bán trong ngày, không dính chu kỳ T+2 như thị trường cơ sở) và có **đòn bẩy** thật. Tài sản cơ sở là **chỉ số VN30 spot**, nên đây cũng chính là điểm nối với Q-World Ch2 (nền tảng forward/futures) và Ch9 (lãi suất, basis futures–spot). *(Từ 10/10/2025 có thêm **VN100 Index Futures** trên cùng sàn — rổ rộng hơn — nhưng thanh khoản còn **rất mỏng** so với VN30, chênh tới mấy bậc độ lớn, nên VN30 vẫn là hợp đồng thực tế cho mọi chiến lược cần khớp lệnh nghiêm túc.)*

Hãy thực tế về **phạm vi** cuốn P mà một hợp đồng chỉ số mở khóa. VN30 futures là **một underlying duy nhất**: nó tuyệt cho **directional theo chuỗi thời gian** (Ch7), **hedge beta** danh mục (Ch14), khai thác **basis/carry**, và **execution** (Ch13). Nhưng một hợp đồng chỉ số **không cho bạn breadth** — không có cross-section để chạy factor-neutral, pairs, cross-sectional stat-arb, hay portfolio construction đa-tài-sản (Ch11) đúng nghĩa; những thứ đó cần một rổ nhiều tài sản giao dịch được hai chiều mà VN chưa có. Nói gọn: futures mở khóa *chiều sâu* directional/hedging, không mở khóa *chiều rộng* danh mục.
...
- **Ký quỹ (margin) chỉ một phần notional** — tỷ lệ ký quỹ ban đầu do VSD/CTCK quy định và thay đổi theo thời kỳ, nên đừng đóng đinh con số %. Điểm dễ nhầm nhất: **đòn bẩy $\sim 5\times$ là *khả năng tối đa*, không phải đòn bẩy mặc định.** Đòn bẩy *thực* là tỷ lệ **exposure danh nghĩa / vốn**, do *bạn* chọn qua số hợp đồng nắm giữ: có 130 triệu và giữ **một** hợp đồng notional $\sim 130$ triệu là exposure $\sim$**1×** — dù tiền ký quỹ yêu cầu thấp hơn nhiều; chỉ khi chủ động dùng gần hết khả năng ký quỹ (giữ $\sim$4–5 hợp đồng) mới thành $\sim 5\times$.
- **Cơ chế margin động.** Lãi/lỗ được tính theo giá thị trường mỗi ngày (**variation margin**); nếu vốn ký quỹ tụt dưới **maintenance margin** bạn bị **margin call**, không nạp bổ sung kịp thì bị **forced liquidation** (đóng vị thế bắt buộc). Đòn bẩy càng cao thì ngưỡng call càng gần — đây là con dao hai lưỡi (xem cảnh báo cuối mục).
- **Tháng đáo hạn:** tháng hiện tại, tháng kế, và 2 tháng cuối của 2 quý gần nhất. **Ngày đáo hạn: thứ Năm thứ ba** của tháng đáo hạn. Hợp đồng **thanh toán bằng tiền** (cash-settled), *không* giao nhận cổ phiếu. Giá thanh toán cuối cùng **không phải giá đóng cửa VN30**, mà là **trung bình cộng số học của chỉ số VN30 trong 30 phút cuối phiên đáo hạn** (15 phút khớp liên tục + 15 phút ATC) **sau khi loại 3 giá trị cao nhất và 3 giá trị thấp nhất** của phiên liên tục. Vì thế basis so với *giá đóng cửa* không nhất thiết đúng bằng 0 tại đáo hạn (nó hội tụ về mức giá trung bình đó). Hệ quả vận hành: tới gần đáo hạn, thanh khoản dịch sang tháng kế nên hệ thống phải biết **roll** vị thế; nếu không, phần còn lại sẽ tự động **thanh toán tiền mặt tại mức giá trung bình 30 phút cuối** — một mức bạn không kiểm soát, đừng để vô tình bị cuốn vào.

Vì cho short và intraday, index futures (VN30 chủ lực) là nơi bạn chạy được các họ chiến lược **directional hai chiều** (long *và* short theo tín hiệu), **trend-following intraday**, và các mô hình mean-reversion trong ngày — những thứ tầng cổ phiếu cơ sở không cho. Đó là lý do nó xứng đáng làm *engine systematic chính* cho ai đã đủ chín tay.
...
- **Chi phí vòng.** *Ví dụ minh họa* (khớp với running example của tài liệu): mua cổ phiếu HOSE giá 50.000đ, phí môi giới $\sim 0{,}2\%$/chiều (mua và bán), thuế thu nhập khi bán $0{,}1\%$ trên giá trị bán (thu mỗi lần bán, bất kể lãi/lỗ). Vòng mua + bán $\Rightarrow$ chi phí $\approx 0{,}2\% + 0{,}2\% + 0{,}1\% \approx \mathbf{0{,}5\%}$. Con số này chính là "điểm gãy chi phí" mà Ch8–9 cuốn P nói tới: một tín hiệu chỉ đáng trade nếu alpha kỳ vọng mỗi vòng **vượt xa** 0,5% sau khi trừ slippage. Trong *ví dụ minh họa* này, mức phí ~0,5%/vòng là lý do khiến rebalance thưa (ví dụ theo tháng) thường hợp lý hơn rebalance hằng ngày cho long-only VN — nhưng đây là hệ quả của *bộ số phí giả định*, không phải một định luật: tần suất rebalance tối ưu phải được tìm bằng cách cân alpha-decay thực tế với chi phí thực tế của bạn, không mặc định tháng luôn thắng ngày.
...
|---|---|---|---|---|---|
| Học nghề, không muốn đòn bẩy giết tài khoản | **(B) Long-only** | Không | Không (lựa chọn cash-only; margin có sẵn) | Không (T+2) | Ch5–7 (bỏ leg short), Ch9, Ch11, Ch14 |
| Directional hai chiều, trend intraday, hedge danh mục | **(A) VN30 futures** | **Có** | **Có** (tối đa $\sim 5\times$; thực tế do bạn chọn) | **Có** | Directional/hedge/execution của P (Ch7,13,14); Q Ch2,9 — không có breadth cho factor/pairs |
...
Nếu bạn là người mới, **hãy khởi động ở sân (B) long-only**, không phải (A). Lý do rất thực dụng: đòn bẩy của futures khuếch đại lỗi. Một hệ thống còn non — sai chỗ nào đó trong data điều chỉnh corporate action (Mục 5), hay backtest quá lạc quan (Mục 7) — nếu chạy trên long-only thì bạn mất tiền *tuyến tính* và còn thời gian sửa. Cũng con lỗi đó chạy trên futures dùng đòn bẩy cao (có thể tới $\sim 5\times$) thì **cháy tài khoản** trước khi bạn kịp nhận ra hệ thống sai.
...
*Một phép so notional để thấy chênh lệch cỡ vốn (ví dụ minh họa):* với $\sim 130$ triệu VND, ở sân (B) bạn mua được đúng $\sim 130$ triệu tiền cổ phiếu (cash-only, không đòn bẩy — dù về nguyên tắc có thể thêm margin); cũng số tiền đó ở sân (A) đủ **ký quỹ** cho vài hợp đồng futures. Nhưng exposure lớn không tự động xảy ra: giữ đúng một hợp đồng thì phơi nhiễm chỉ $\sim$1×, chỉ *khi bạn chọn* nắm nhiều hợp đồng thì exposure danh nghĩa mới lớn hơn nhiều lần vốn thực. Chính **khả năng nống exposure** đó vừa hấp dẫn vừa nguy hiểm — và là lý do thứ tự B → A không phải lời khuyên đạo đức, mà là quản trị rủi ro.
...
Điểm khởi đầu thực tế cho một retail quant VN là **`vnstock`** — thư viện Python phổ biến nhất để lấy dữ liệu thị trường Việt Nam: giá lịch sử và intraday, báo cáo tài chính, bảng giá, và dữ liệu **khối ngoại** (mua/bán ròng theo mã). Nhưng phải định vị đúng, đừng nói quá: vnstock dùng **giấy phép tùy chỉnh cho mục đích cá nhân/nghiên cứu phi thương mại** (dùng thương mại phải xin phép tác giả), có **rate limit**, và chính tác giả **cảnh báo dữ liệu có thể thiếu/không nhất quán/sai** và **không nên dùng cho giao dịch thật hay thuật toán** khi chưa thẩm định kỹ. Vì thế hãy coi nó là **adapter phục vụ nghiên cứu/prototype**, *không phải* một **production market-data feed**: nó là nơi tự nhiên để đặt tầng data của backtester (trong `quantc`, tương ứng tầng data của `src/alpha`), nhưng trước khi đưa vốn thật vào, bạn cần một nguồn đã được thẩm định. Khi cần chất lượng cao hơn — dữ liệu tài chính đã chuẩn hóa, chuỗi điều chỉnh nhất quán, hoặc lịch sử dài hơn — có các vendor thương mại như **FiinTrade/FiinX** (FiinGroup), **Wichart**, **Vietstock**; chart thì TradingView; cộng đồng phân tích kỹ thuật hay backtest trên **Amibroker**. Nguyên tắc của Ch2 vẫn giữ nguyên bất kể nguồn: **giữ song song hai chuỗi giá** — `adjusted` để tính return, `raw` để mô phỏng giá khớp lệnh thật — cộng một `security master` map identifier bền theo mã.

Một đặc thù VN mà thị trường Mỹ không có: **foreign flow** (khối ngoại mua/bán ròng) được công bố hằng ngày theo mã và lấy được qua vnstock. Nó là một tín hiệu alpha đặc thù VN, không thuộc phạm vi mục này (mục này lo phần data hygiene), nhưng nó phải nằm trong schema data ngay từ đầu, với kỷ luật PIT **đầy đủ hơn một cột ngày**. Một `as_of_date` dạng *ngày* là chưa đủ; schema tối thiểu cần: **`published_at`/`available_at`** (timestamp thời điểm dữ liệu thực sự có sẵn), **`ingested_at`** (lúc pipeline nạp), **revision/version** (đánh số bản sửa), cùng **`source`** và **timestamp truy xuất**. Điểm sắc với foreign flow: **tổng mua/bán ròng cả ngày chỉ hoàn chỉnh *sau* khi phiên đóng**, nên dùng con số đó để ra quyết định tại *close cùng ngày* là look-ahead — nó chỉ được phép dùng từ phiên sau. Có đủ các trường trên thì tầng alpha phía sau mới dùng được mà không rò rỉ tương lai.
...
Một cú giảm 16,6% trong một ngày — nhưng **không nhà đầu tư nào mất tiền**: họ đang giữ nhiều cổ phiếu hơn với cùng tổng giá trị. Đây là "alpha ma" y hệt bẫy dividend của Ch2, chỉ khác là biên độ lớn hơn nhiều vì tỷ lệ chia ở VN thường lớn. Cách chữa giống Ch2: nhân một **adjustment factor** dồn ngược vào toàn bộ giá quá khứ. Với tỷ lệ chia $s$ (ở đây mỗi cổ cũ thành $1{,}2$ cổ mới, $s = 1{,}2$), factor cho ngày đó là $1/s = 1/1{,}2 \approx 0{,}833$. Nhân toàn bộ chuỗi quá khứ với 0,833: giá 50.000 của ngày liền trước thành $50.000 \times 0{,}833 \approx 41.700$, và cú "rớt" ảo biến mất (ở ví dụ này giả định giá đóng cửa ex-date đúng bằng giá tham chiếu lý thuyết; ngày thực cổ phiếu vẫn dao động thật, nên return sau điều chỉnh **không nhất thiết bằng 0**). Nhớ chiều điều chỉnh của Ch2: **sửa quá khứ, không sửa hiện tại**; giá hôm nay phải là giá trade được. Với phát hành quyền mua (rights) ở giá ưu đãi, factor phức tạp hơn (phải tính giá trị lý thuyết của quyền), nhưng nguyên tắc y hệt.
...
3. **Kiểm chứng tay vài mã**: chọn 3–5 mã có sự kiện chia lớn đã biết, rồi **đối chiếu adjustment factor với điều khoản sự kiện** (tỷ lệ chia, giá phát hành), với **giá tham chiếu lý thuyết ngày ex** mà sàn công bố, và với **quy tắc làm tròn**. **Đừng** dùng phép thử "return sau điều chỉnh phải ~0%": cổ phiếu vẫn có **biến động thật trong ngày ex-date**, nên một return khác 0 hoàn toàn hợp lệ — cái cần kiểm là *factor có khớp điều khoản sự kiện và giá tham chiếu lý thuyết không*, không phải ép return về 0. Nếu factor lệch khỏi điều khoản, nguồn đó sai — đừng backtest trên nó.
...
Nếu universe backtest của bạn chỉ gồm các mã **hiện đang niêm yết**, bạn đã tự trao cho chiến lược một siêu năng lực tiên tri: nó không bao giờ cầm các mã đó vào đúng lúc chúng bị đình chỉ/hủy. Cách chữa mượn tinh thần Ch2 nhưng **không được bê máy móc mô hình CRSP "gán một delisting return âm lớn cho mọi mã"** — ở VN điều đó sai. Rời sàn ở VN có nhiều trạng thái rất khác nhau: **đình chỉ giao dịch** chỉ tạo ra một tài sản *không thanh khoản* (chưa chắc mất giá trị); **hủy niêm yết** có thể là **chuyển xuống UPCoM**, **sáp nhập**, **hủy tự nguyện**, hoặc công ty vẫn tồn tại và giao dịch ngoài sàn. Vì thế engine phải **giữ trạng thái mỗi mã (`active/suspended/delisted/transferred`)**, **theo security qua venue mới** (nối tiếp giá khi mã chuyển xuống UPCoM), và **chỉ ghi nhận return khi có giá thực hoặc cash recovery thực** — không phịa một con số âm cố định. Chỉ khi mã thực sự mất trắng (không thu hồi được gì) thì delisting return mới đúng là một số âm lớn. Ở VN, nhiều feed rẻ tiền hoặc mặc định có thể **không** giữ đầy đủ các mã đã rời sàn; đây là lý do đầu tiên để nghi ngờ một backtest "quá đẹp". Hành động: chủ động gom danh sách mã đã hủy/đình chỉ theo lịch sử và ghép return cuối của chúng vào universe, thay vì lọc chúng ra một cách vô tình.
...
Sai lầm kinh điển: backtest chiến lược "long các cổ phiếu **trong VN30**" nhưng áp danh sách thành viên **hôm nay** cho quá khứ. Làm vậy là bạn ngầm chọn những mã đủ tốt để trụ lại rổ — một dạng survivorship bias ở tầng universe, chồng lên bẫy 5.3. Đúng kỷ luật Ch2: mỗi ngày backtest phải hỏi *"mã này có trong VN30 **tại ngày đó** không?"* bằng một bảng membership có `start_date`/`end_date` theo từng kỳ đổi rổ, **không** phải một danh sách VN30 tĩnh. Với chiến lược event-driven (Mục 6, họ 5) thì `start/end` *chưa đủ*: bảng còn cần cột **`announced_at`** — ngày HOSE **công bố** thành phần rổ mới, luôn *trước* ngày hiệu lực. Thiếu nó, backtest có thể "biết" thành phần rổ mới trước khi thị trường biết — một look-ahead tinh vi bơm phồng chính cái edge rebalance mà bạn định đo. Vì rổ chỉ đổi ~2 lần/năm, bảng này nhỏ và hoàn toàn khả thi để dựng tay từ lịch sử công bố rổ (ghi **cả** ngày công bố lẫn ngày hiệu lực).
...
| Universe PIT | VN30 đổi rổ ~2 lần/năm; fundamental công bố trễ | Bảng membership `start/end` + `announced_at`; join fundamental theo ngày công bố |
...
> **Về nhãn `(VN-FACTS)` dùng xuyên tài liệu.** `(VN-FACTS)` **không** phải một dataset có thật trong repo — nó là **nhãn nội bộ** trỏ tới tập dữ kiện cơ chế thị trường VN mà tài liệu dựa vào (tỷ trọng retail, room ngoại, T+2, biên độ, specs futures, lịch FTSE…). Mỗi dữ kiện phải neo vào **nguồn sơ cấp kèm ngày hiệu lực**, không được dùng như "chân lý" trần trụi. Bảng nguồn tối thiểu (kiểm tra lại trước khi dùng vốn thật — cơ chế VN đổi nhanh):
>
> | Dữ kiện | Nguồn sơ cấp | Ghi chú / ngày hiệu lực |
> |---|---|---|
> | Cơ chế giao dịch (giờ, phiên, biên độ, lô, tick, T+2) | Quy chế giao dịch VNX/HOSE/HNX | Theo bản quy chế đang áp dụng |
> | Room ngoại (FOL) | Nghị định 155/2020, sửa đổi bởi Nghị định 245/2025 | Trần phụ thuộc ngành; không đồng nhất |
> | Margin (đòn bẩy cổ phiếu) | Thông tư 120/2020/TT-BTC | Cho nhà đầu tư trong nước |
> | Specs & thanh toán futures VN30/VN100 | VSDC; spec hợp đồng HNX/CTCK | VN100 futures từ 10/10/2025; VN30 cash-settled theo giá TB 30 phút cuối |
> | Nâng hạng FTSE | FTSE Russell / LSEG | Xác nhận 4/2026; hiệu lực 21/09/2026; vào rổ nhiều đợt tới ~9/2027 |
> | Retail ~85–90% *giá trị* giao dịch | Số liệu HOSE / báo cáo thị trường | Theo **giá trị** (không phải khối lượng); cần pin nguồn & kỳ cụ thể |
> | `vnstock` | PyPI / GitHub (thinh-vu/vnstock) | Giấy phép phi thương mại; research-grade, **không** phải production feed |
>
> Con số **85–90%** cần thận trọng nhất: nó là **giá trị** giao dịch (không phải khối lượng cổ phiếu), dao động theo giai đoạn, và mọi suy luận "retail đông ⇒ behavioral alpha mạnh hơn" chỉ là **giả thuyết cần kiểm định**, không phải hệ quả tất yếu.

### Vì sao behavioral edge ở VN đậm hơn sách

Ch8 dạy rằng behavioral alpha sinh ra từ **lỗi hệ thống** của con người: disposition effect kìm giá cổ phiếu thắng tạo momentum, overreaction tạo reversal, over-trading do quá tự tin tạo thanh khoản cho người cung cấp thanh khoản hớt. Ở thị trường Mỹ large-cap, phần lớn các lỗi này đã bị vốn thông minh bào mòn tới mức chỉ còn premium mỏng. Ở VN thì khác về *cường độ*: khoảng **85–90% giá trị giao dịch là nhà đầu tư cá nhân trong nước** (VN-FACTS; theo *giá trị*, không phải khối lượng), tức bên kia mỗi lệnh của bạn thường là một noise trader chứ không phải một arbitrageur kỷ luật đã trừ sạch lỗi. Đây đúng là điều kiện Ch8 nói *có thể* làm behavioral edge **mạnh hơn thị trường phát triển** — lỗi hành vi ở đây chưa bị vốn thông minh chen vào giữa. Nhấn mạnh "có thể": đây là **giả thuyết định hướng cần kiểm định**, không phải một dữ kiện đã chứng minh. Nhưng đúng theo tinh thần "limits to arbitrage", phải nói rõ con dao này cắt hai chiều: chính nơi behavioral edge đậm cũng là sân hoạt động của **đội lái (pump-and-dump)** — nhóm thao túng cổ phiếu thanh khoản thấp, chủ yếu mid/small-cap (VN-FACTS). "Tín hiệu đẹp" trên một cổ phiếu mỏng có thể chỉ là một sóng làm giá đang cuốn bạn vào đúng lúc nó sắp xả. Nguyên tắc phòng vệ xuyên suốt mục này, không thương lượng: **bám VN30/large-cap và lọc bỏ mã thanh khoản mỏng bằng bộ lọc ADV**, đúng như universe long-only mặc định VN-FACTS khuyến nghị.

### Họ 1 — Momentum cross-sectional (12-1 tháng) trên VN30

Đây là **baseline hypothesis** (giả thuyết nền), không phải "ứng viên số một" đã được chứng minh — lý do kinh tế của nó (Ch8) áp vào VN một cách hợp lý, nhưng phải kiểm định trước khi tin. Momentum sống nhờ **under-reaction và disposition effect**: nhà đầu tư bán cổ phiếu thắng quá sớm để chốt lời nhỏ, khiến giá bò lên fair value từ từ thay vì nhảy tới ngay — phần điều chỉnh còn lại rỉ ra trong nhiều tuần. Với một thị trường cá nhân chiếm áp đảo như VN, chính cơ chế "bán non người thắng" này còn đậm hơn nơi sách khảo sát. Tín hiệu chuẩn của Ch7 là return **12 tháng bỏ tháng gần nhất** (bỏ tháng cuối để tránh dính short-term reversal); quy ước ~21 phiên cho một tháng, ~252 phiên cho một năm:

$$\text{mom}_{i,t} = \frac{P_{i,t-21}}{P_{i,t-252}} - 1$$

Bằng chứng thực nghiệm ở VN **không đồng nhất**: có nghiên cứu tìm cấu hình momentum tốt ở khung ~6–9 tháng chứ không hẳn 12-1, có nghiên cứu thấy hiệu quả **suy yếu sau khi kiểm soát rủi ro** — nên coi cấu hình 12-1 trên VN30 là điểm khởi đầu để *kiểm định*, không phải thông số đã chốt. Long nhóm rank cao, cầm thong thả vài tuần đến vài tháng (half-life dài, turnover thấp — Ch7.2), nên phí vòng và thuế bán 0,1% mỗi lần bán (VN-FACTS) bào mòn ít. Quan trọng: **chạy trên rổ VN30**, không phải toàn HOSE. Momentum trên smallcap VN gần như chắc chắn bắt phải sóng đội lái — đó là sóng làm giá chứ không phải drift behavioral, và nó sẽ đảo chiều dữ dội đúng lúc bạn đang cầm nặng nhất. Cross-ref Ch8: momentum là **Loại 2 (behavioral) — tài sản hao mòn**, cần theo dõi crowding và cân nhắc biến thể có phanh vol (Daniel–Moskowitz risk-managed momentum, Ch7.4), vì "momentum crash" đuôi trái chính là cái giá giữ cho premium này còn sống.
...
Nhưng đây chính là chỗ **ràng buộc T+2 phá vỡ chiến lược sách** và ta phải lách (nối Mục 3). Ở thị trường cơ sở, cổ phiếu vừa mua **chưa bán được cho tới khi về tài khoản (~T+2)** (VN-FACTS) — bạn không thể quay vòng một lô trong 1–2 ngày như stat-arb Mỹ. Hệ quả trực tiếp: mean reversion tần suất cực ngắn (mua bán trong ngày, quay vòng 1 ngày) **không chạy được trên cổ phiếu cơ sở VN**. Hai đường lách, nhưng cả hai đều *đổi* chiến lược chứ không "port" nguyên trạng. **Một**, kéo holding period lên khung 5–20 ngày cho khớp T+2 — chấp nhận half-life dài hơn và IC yếu hơn, đổi lấy một chiến lược thực sự thi hành được; lưu ý T+2 chỉ đặt *sàn dưới* cho holding period, **không chứng minh 5–20 ngày là tối ưu** — độ dài tối ưu phải đo bằng half-life thực của tín hiệu. **Hai**, chuyển ý tưởng lên **VN30 futures** — nhưng đây là **đổi cả giả thuyết**: tín hiệu gốc là **cross-sectional reversal** (đảo chiều *giữa nhiều mã*, breadth trải trên rổ), còn trên một hợp đồng chỉ số thì bạn chỉ còn **time-series mean reversion trên một tài sản duy nhất** — khác cơ chế kinh tế, khác breadth, và **không phải một đường "port" tương đương**. Futures cởi được ràng buộc intraday/short, nhưng nó cho bạn một alpha *khác*, phải kiểm định riêng — không phải cùng một reversal chạy ở chỗ khác.

### Họ 3 — Dòng tiền khối ngoại (foreign net flow) — đặc sản VN

Đây là họ tín hiệu **không có trong danh mục kinh điển của Ch7** vì nó là đặc thù thị trường VN, và theo phân loại Ch8 nó thuộc dòng **structural/informational**: giá trị mua/bán ròng của nhà đầu tư nước ngoài theo từng mã được **công bố hằng ngày** (VN-FACTS). Nhưng phải nói chính xác nó *là gì*: đây là **giao dịch ròng tổng hợp của toàn bộ khối ngoại**, **không** phải dữ liệu positioning của một quỹ lớn — bạn không biết danh tính, vị thế thực, hay mục đích. Cùng một dòng "mua ròng" có thể là quỹ chủ động mang thông tin, mà cũng có thể là **positive-feedback trading** (đuổi giá), **ETF rebalance**, **arbitrage**, hay **giao dịch thỏa thuận** — những thứ chẳng có tính dự báo. Giả thuyết kinh tế *khả dĩ*: một phần khối ngoại là quỹ tổ chức mang thông tin/khẩu vị khác đám đông trong nước, và **nếu** dòng đó có quán tính thì mua ròng hôm nay có thể nối tiếp một drift giá mà bên cá nhân phản ứng chậm (under-reaction, Ch8). Nhưng bằng chứng thực nghiệm ở VN **không đồng nhất** — nên tính dự báo của foreign flow là thứ **phải kiểm định**, không được mặc định có drift. Tín hiệu thô xây dạng foreign net flow chuẩn hóa theo thanh khoản để so được giữa các mã:

$$\text{fflow}_{i,t} = \frac{\text{giá trị mua ròng khối ngoại của mã } i \text{ trong cửa sổ } k \text{ ngày}}{\text{ADTV}_{i}}$$

rồi đưa qua đúng pipeline Ch7.1. (Mẫu số phải là **ADTV — average daily trading *value*** (giá trị giao dịch bình quân ngày), *không* phải "ADV" mơ hồ: khi tử số là **tiền** thì mẫu số cũng phải là tiền, để tỷ số vô thứ nguyên và so được giữa các mã.) Hai cảnh báo đặc thù VN, cả hai đều là bẫy backtest. Một, **room ngoại**: mỗi mã có trần tỷ lệ sở hữu nước ngoài (nhiều mã 49%, ngân hàng 30% — VN-FACTS); mã đã **hết room** thì khối ngoại chỉ mua thêm được qua thỏa thuận, thường chịu premium (VN-FACTS) — dòng flow khớp lệnh của các mã này bị *bóp méo* bởi trần sở hữu chứ không phản ánh thuần khẩu vị, nên phải xử lý riêng hoặc loại khỏi universe tín hiệu. Hai, đây vẫn là **tín hiệu thô cần neutralize** (mục dưới): nếu khối ngoại đang mua đều cả rổ ngân hàng thì "fflow cao" của một mã ngân hàng là **industry bet trá hình**, không phải alpha riêng của mã đó.

### Họ 4 — Factor value/quality (long-only tilt)

Value và quality thường được xếp là **risk premium (Ch8 Loại 1)** — capacity lớn, về lý thuyết được trả để chịu đựng đúng lúc thị trường tệ. Nhưng **đừng biến cách giải thích factor thành quy tắc quản trị vốn**: premium này phụ thuộc **định nghĩa** (đo bằng biến nào), **thị trường** và **regime** — nó không "bền vô hạn định". Câu "không nên cắt trong drawdown" **nguy hiểm** nếu áp máy móc: một drawdown có thể là cái giá phải trả của factor, nhưng cũng có thể báo **data break** (lỗi corporate-action, nối Mục 5) hoặc **structural decay** (factor đang chết thật). Cách đúng: coi value/quality là **candidate factor exposure cần kiểm định PIT**, và **định trước exit/risk limit** (ngưỡng cắt, giới hạn drawdown) *trước khi* vào lệnh — chứ không cam kết "ôm qua mọi drawdown" như một tín điều. Trên VN, vì nhà đầu tư cá nhân chưa short được cổ phiếu cơ sở (VN-FACTS), ta **không** dựng được long/short HML thuần như sách; thay vào đó dùng chúng làm **tilt trong danh mục long-only** (nối Mục 8). Ngôn ngữ là của Ch6: value đo bằng earnings yield / book-to-price / FCF yield so *trong ngành*, quality bằng ROE cao đi kèm accruals thấp (earnings là "tiền thật" chứ không phải bút toán — Sloan). Cross-ref Ch6.5: đừng kỳ vọng alpha residual sau khi đã trừ factor — value *là* factor, không phải bí mật riêng của bạn; giá trị cạnh tranh nằm ở định nghĩa sạch hơn và ở dữ liệu point-in-time nghiêm hơn. Ở VN điều thứ hai là chiến trường thật: cổ tức bằng **cổ phiếu**, thưởng cổ phiếu, phát hành thêm/quyền mua diễn ra rất dày (VN-FACTS) khiến các nguồn data điều chỉnh giá không nhất quán — đây là nguồn lỗi backtest lớn nhất ở VN (nối Mục 5 về PIT/corporate-action).

### Họ 5 — Event-driven: nâng hạng FTSE & VN30 rebalance

Structural alpha (Ch8 Loại 3) — cược chống *quy tắc*, không chống *lỗi*. Hai sự kiện VN sạch nhất (VN-FACTS): (1) **FTSE Russell nâng hạng Việt Nam lên Secondary Emerging Market** — đã *xác nhận* (4/2026), **hiệu lực 21/09/2026**, và việc **đưa vào rổ chia thành nhiều đợt (tranche) kéo dài tới ~9/2027**, *không* phải một cú inflow duy nhất. Mỗi đợt kéo một phần dòng vốn ngoại thụ động (ETF/quỹ index) vào các mã trong rổ — cầu cứng, tương đối vô cảm với giá, đúng cơ chế index-add của Ch8; chiến thuật phải canh *từng đợt* theo lịch FTSE, không đặt cược vào một ngày duy nhất; (2) **VN30 rebalance** (rổ đổi định kỳ ~2 lần/năm — VN-FACTS): mã được thêm vào rổ bị các quỹ tham chiếu VN30 mua vào, mã bị loại bị bán ra. Chiến thuật là canh *lịch và quy tắc rổ* — vào vị thế trước ngày effective, thoát khi cầu thụ động đã khớp xong — chứ không canh fundamental. Cảnh báo Ch8 đóng khung capacity: edge index-rebalance co lại khi ai cũng biết trò này và cùng đứng trước ngày effective, nên coi đây là cơ hội có hạn về quy mô, không phải mỏ vô tận.
...
1. **Winsorize** — clip outlier về $\pm 3$ MAD quanh median, **nhưng chỉ sau khi đã xác nhận quan sát là *thật***. Đây là chỗ cực dễ sai ở VN: một outlier khổng lồ thường là **lỗi corporate-action chưa adjust** (nối Mục 5), *không* phải một giá trị cực đoan có thật — và winsorize **không được dùng để che lỗi đó**. Dữ liệu lỗi phải bị **quarantine / fail validation** và báo động, chứ không được clip cho gọn rồi tiếp tục trade trên data hỏng. Chỉ winsorize những giá trị đã qua kiểm chứng là quan sát thật nhưng nằm ở đuôi phân phối.
...
Chuẩn công nghiệp là **rank-IC** (Spearman) — correlation cross-sectional giữa tín hiệu hôm nay và forward return. Với equity daily trên **universe rộng**, **IC 0.02–0.05 là tín hiệu tốt thật sự**; ai khoe IC 0.2 trên universe rộng gần như chắc chắn dính look-ahead bug (Ch7.3). Lưu ý: khoảng 0.02–0.05 này rút ra từ các universe **hàng nghìn mã** — **không mặc nhiên là benchmark cho một rổ 30 mã như VN30** (ít mã thì IC mẫu nhiễu hơn nhiều), nên đừng dùng nó làm chuẩn cứng cho VN30. Fundamental Law nối IC với kết quả:
...
**Ví dụ minh họa (số giả định — và cố ý phơi bày một cạm bẫy đếm breadth).** Giả sử một combo momentum + foreign-flow trên VN30 đo được mean rank-IC $= 0.04$, std IC $= 0.12$ (IC risk-adjusted $= 0.33$). Cross-section cho breadth **không gian** hiệu dụng $N_{\text{eff}} = N/(1+(N-1)\bar\rho) \approx 12$ (30 mã tương quan cao co lại). **Cạm bẫy phải tránh:** đừng nhân thẳng $12 \times 50\ \text{tuần} = 600$ rồi kết luận BR $= 600$. Công thức $N/(1+(N-1)\bar\rho)$ chỉ co breadth theo **tương quan không gian giữa các mã *trong một kỳ***; nó **không** phải ước lượng tổng quát cho breadth xuyên **cả không gian lẫn thời gian**. Với một tín hiệu chậm như momentum 12-1, cửa sổ tín hiệu và forward return của các tuần **chồng lấn (overlap) nặng** — "cược" tuần này qua tuần khác **không độc lập**, nên tăng tần suất rebalance **không tự sinh thêm breadth** (chỉ tăng phí). Breadth thời gian thực = số kỳ *không chồng lấn* của tín hiệu, thường nhỏ hơn số tuần rất nhiều. Vì thế IR thực tế của một danh mục VN30 momentum thường **thấp hơn nhiều** con số "$0.04\times\sqrt{600}\approx 1.0$" mà phép nhân ngây thơ gợi ra — và đó đúng là bài học VN: breadth mỏng (ít mã, tín hiệu chậm chồng lấn) ép IR xuống, nên từng điểm IC và từng tín hiệu *thật sự* độc lập thêm vào đều đắt giá. Hai lưu ý nữa để không tự lừa: **transfer coefficient (TC)** không phải một "haircut sau phí" gọn gàng — nó đo mức tín hiệu bị **ràng buộc danh mục** (long-only, giới hạn trọng số, thanh khoản) làm méo *trước cả* khi tính phí (Ch11); và quy tắc "live chỉ giữ 50–70% IC của backtest" là một **kinh nghiệm ước lệ, không có nguồn chắc**, nên coi nó là lời nhắc phải haircut mạnh tay, đừng dùng như một hằng số. Với lịch sử data VN ngắn (VN-Index từ 2000, VN30 futures từ 2017 — VN-FACTS), overfitting cực dễ, nên ở VN càng phải bi quan hơn.
...
Ch9 nhấn: phòng thủ look-ahead không phải "cẩn thận hơn" mà là một **kiến trúc event-driven** — engine đẩy dữ liệu nhỏ giọt theo timestamp, code chiến lược tại $t$ chỉ thấy event $\le t$. Nhưng kiến trúc event-driven *không tự* chặn look-ahead: nó chỉ là cái khung để bạn xếp thứ tự thời gian cho đúng. Cái phải đúng là **chuỗi nhân quả tách bạch theo phiên**: `BAR_CLOSE(t) → SIGNAL(t) → ORDER(t+1) → FILL(t+1)`. Tín hiệu tính trên close phiên $t$ **không được khớp trong chính phiên $t$** — vì lúc bạn "thấy" close thì phiên đã đóng, mọi giá trong ngày đó là quá khứ không đặt lệnh vào được; lệnh chỉ ra thị trường ở phiên kế và khớp ở giá *có thể thực thi* của phiên đó (open/VWAP + slippage), **không phải** ở giá tham chiếu hay giá đóng của phiên tín hiệu. Dưới đây là khung tối giản gắn xử lý VN, đã tách rõ hai pha (sinh tín hiệu vs khớp lệnh của phiên trước). Đây là pseudo-code minh họa, không phải API của thư viện cụ thể nào:

```
pending = []                                      # lệnh sinh ở phiên trước, chờ khớp hôm nay
for day in trading_days:                          # event-driven: mỗi ngày một event
    prices = feed.bar(day)                        # chỉ dữ liệu <= day
    release_settled_lots(book, day)               # lô có available_from <= day -> bán được
    release_pending_cash(book, day)               # tiền bán đã settle (T+2) -> khả dụng

    # (A) KHỚP lệnh sinh từ phiên TRƯỚC, tại giá có thể thực thi của phiên t
    for order in pending:
        px = prices[order.symbol]
        if order.symbol not in universe_asof(day): continue     # lọc VN30 (point-in-time) + ADV
        if order.side == BUY  and px.locked_ceiling():  continue # khóa trần + không đối ứng -> non-fill
        if order.side == SELL and px.locked_floor():    continue # khóa sàn + không đối ứng -> non-fill
        qty  = min(order.qty, PARTICIP_CAP * px.adv)             # participation cap
        fill = apply_slippage(px.exec_price(order), order, px)   # open/VWAP + spread/impact,
                                                                 #   KHÔNG phải ref_price/close phiên tín hiệu
        if order.side == BUY:
            cost = fill*qty + buy_fee(fill, qty)
            if cost > cash: qty = affordable_qty(cash, fill)     # kiểm tra buying power
            book.add_lot(order.symbol, qty, fill,
                         available_from=afternoon(next_bday(day, SETTLE_LAG)))  # T+2, bán được từ CHIỀU
            cash -= fill*qty + buy_fee(fill, qty)
        else:  # SELL
            qty      = min(qty, book.available_to_sell(order.symbol))   # T+2: chỉ bán phần đã settle
            proceeds = fill*qty - sell_fee(fill, qty) - sell_tax(fill, qty)  # phí + thuế bán 0,1%
            book.reduce(order.symbol, qty)
            book.add_pending_cash(proceeds, next_bday(day, SETTLE_LAG))  # tiền bán về T+2 (trừ khi ứng trước)

    # (B) SINH tín hiệu trên close phiên t -> orders cho phiên KẾ (không khớp hôm nay)
    signals = strategy.on_bar(day, history_upto(day))    # chỉ thấy event <= close(day)
    pending = strategy.orders(signals)                   # thực thi ở t+1, không phải t

    record_pnl_and_positions(day)
```

Những dòng "linh hồn VN" là: lệnh của phiên trước khớp ở **giá thực thi của phiên khớp** chứ không ở giá tín hiệu (chống look-ahead khớp cùng phiên); `available_from = afternoon(next_bday(day, SETTLE_LAG))` (T+2 — cổ phiếu thường chỉ bán được *phiên chiều* ngày T+2, không phải đầu ngày); `add_pending_cash(...)` (tiền bán cũng về T+2, không tái dùng ngay trừ khi bật dịch vụ ứng trước có phí/lãi); nhánh `continue` chỉ khi biên **khóa cứng và không có đối ứng** (`locked_ceiling/locked_floor`, không phải mọi lần chạm biên); và `sell_tax` (thuế bán 0,1% chỉ đánh chiều bán). Bỏ bất kỳ dòng nào là mở lại đúng một nguồn lạc quan giả đã bàn ở trên — và cả nhóm đều thuộc loại lỗi *im lặng*, không văng exception, nên bạn sẽ không biết mình đang tự lừa cho tới khi tiền thật ra khỏi tài khoản.

Khung trên **cố tình tối giản để làm nổi ba ràng buộc VN** — nó *chưa* phải một matching engine đầy đủ và không nên bị nhầm là đủ để chạy production. Còn thiếu, tối thiểu: partial fill / spread / market impact / hàng chờ (queue priority) tại từng mức giá; sổ lệnh chờ và hủy/sửa lệnh; lô chẵn (100cp HOSE) và lô lẻ; corporate action (cổ tức tiền/cổ phiếu, quyền mua, thưởng) và điều chỉnh giá; trạng thái đình chỉ / hủy niêm yết / chuyển sàn; và cho book futures thì mark-to-market + ký quỹ biến đổi hằng ngày, margin call, roll. Mỗi hạng mục bỏ sót là một giả định lạc quan tiềm ẩn; khung này là *điểm khởi hành* để gắn dần chúng vào, không phải đích đến.

### 7.6 Overfit — data VN ngắn, deflated Sharpe + purged CV là bắt buộc

VN-FACTS ghi lịch sử data ngắn: VN-Index từ năm 2000, VN30 futures từ năm 2017 → **overfitting cực dễ**. Điều này khớp thẳng với Ch9. Một *heuristic* để cảm độ lớn của vấn đề: ngưỡng Sharpe giả (mức Sharpe kỳ vọng cao nhất thu được thuần từ may rủi khi thử nhiều cấu hình) xấp xỉ $SR_0 \approx \sqrt{2\ln N / T}$ — nó **tăng theo $N$** (số lần thử) và **phình lên khi $T$ (độ dài mẫu) ngắn**. Hai điều phải nói rõ để không dùng sai công thức này. Thứ nhất, $N$ ở đây là **số lần thử *độc lập hiệu dụng*, không phải tổng số cấu hình thô**: các cấu hình gần nhau (cùng họ tín hiệu, tham số kề nhau) tương quan cao nên đếm như ít phép thử hơn nhiều — lấy tổng số config nhét vào $N$ sẽ *thổi phồng* ngưỡng. Thứ hai, $\sqrt{2\ln N/T}$ chỉ là xấp xỉ bậc nhất cho *ngưỡng*, **không phải bản thân DSR**. Với futures VN chỉ vài năm data ($T$ nhỏ), ngưỡng noise vẫn cao đến mức một Sharpe backtest 1.5 hoàn toàn có thể là ảo giác của multiple testing. Kỷ luật bắt buộc, không phải tùy chọn:

- **Deflated Sharpe Ratio (DSR)** (Ch9): đây mới là thống kê đầy đủ — nó hiệu chỉnh Sharpe quan sát theo *phân phối* Sharpe của các trial (qua phương sai của chúng), số trial độc lập hiệu dụng, độ dài mẫu $T$, và **skew/kurtosis** của chuỗi lợi nhuận; công thức $\sqrt{2\ln N/T}$ ở trên chỉ là cách nhẩm nhanh cái phần "ngưỡng kỳ vọng cao nhất", không thay được DSR. Với $T$ ngắn của VN, phần phạt lớn. Phải log trung thực số cấu hình từng chạy qua đầu (kể cả "thử cho vui rồi bỏ") để ước $N$ hiệu dụng cho đúng; đây là con số dễ tự bịp nhất.
- **Purged K-Fold CV + embargo** và, nếu đủ compute, **CPCV** (Ch9) để lấy *phân phối* Sharpe OOS thay vì một con số — đặc biệt giá trị khi mẫu ngắn khiến một đường OOS đơn lẻ rất nhiễu. Nhưng chúng **có điều kiện, không máy móc**: *purging* chỉ cần khi label hoặc cửa sổ nắm giữ của các mẫu **chồng lấn** nhau, và độ dài *embargo* phải xuất phát từ information horizon của tín hiệu (tín hiệu chậm → embargo dài), không phải một hằng số tùy tiện. Cảnh báo ngược cho data VN ngắn: chia quá nhiều fold (CPCV) trên mẫu nhỏ tạo ra các fold tí hon, mỗi ước lượng Sharpe cực nhiễu — có khi phản tác dụng so với một OOS holdout gọn.
...
$$\max_{w}\ \ \mu^\top w - \tfrac{\gamma}{2}\, w^\top \Sigma w - C_{\text{trade}}(w, w_{\text{prev}}) \quad\text{s.t.}\quad w_i \ge 0,\ \ \sum_i w_i = 1,\ \ w_i \le \bar w,\ \ \Big|{\textstyle\sum_{i\in s}} w_i - b_s\Big| \le \delta_s.$$

Ở đây $C_{\text{trade}}(w, w_{\text{prev}})$ là **chi phí giao dịch** để đi từ danh mục cũ $w_{\text{prev}}$ sang $w$ — hàm của turnover $\lVert w - w_{\text{prev}}\rVert$ cộng model impact/slippage (mục 7.3), *không* phải transfer coefficient của mục 6 (ký hiệu tách bạch để tránh nhầm hai khái niệm trùng tên tắt "TC").
...
Đây chính xác là bài toán mà Ch14 gọi là exposure ẩn: một danh mục *trông* đa dạng nhưng phân rã factor kiểu Barra (Ch6) lộ ra net beta lớn. Khác biệt là ở VN bạn *biết trước* — net beta của bất kỳ long-only book nào cũng dương và cỡ 1, không cần đợi phân rã mới bàng hoàng. Muốn cắt nó, cửa thực tế nhất là **hedge overlay bằng short index futures — chủ yếu VN30 futures** (thanh khoản sâu nhất), với VN100 futures là ứng viên phụ cho rổ rộng nhưng còn mỏng thanh khoản.
...
Kết quả sau hedge: danh mục còn lại **gần trung tính với *beta VN30*** (chính xác hơn: *approximately VN30-beta-neutral*), nghĩa là P&L của nó bớt trả lời câu "VN-Index lên hay xuống" và nghiêng hơn về câu **"rổ long của bạn có chạy mạnh hơn VN30 hay không"**. Nhưng đừng gọi nhầm nó là "thuần kỹ năng chọn cổ phiếu" hay market-neutral thực thụ: overlay chỉ triệt tiêu **đúng một exposure — beta VN30 *ước lượng***. Sau hedge vẫn còn nguyên exposure ngành, size, style/value, và rủi ro idiosyncratic của từng mã, cộng thêm basis risk, roll và **sai số của chính ước lượng $\beta$** (hedge sai lượng nếu $\beta$ ước lệch). Đây là *xấp xỉ* thứ market-neutral mà Ch14 mô tả, đạt được không phải bằng short cổ phiếu (không được phép ở VN) mà bằng overlay chỉ số — một xấp xỉ hữu ích, không phải alpha thuần. Bạn vừa chuyển từ đặt cược *hướng thị trường* sang đặt cược *kỹ năng chọn cổ phiếu* — đúng mục tiêu tối hậu của portfolio construction.
...
2. **Roll.** VN30 futures đáo hạn vào ngày **thứ Năm thứ ba** của tháng đáo hạn (VN-FACTS). Muốn *duy trì hedge liên tục* thì phải roll vị thế short sang tháng kế **trước** khi đáo hạn — mỗi lần roll trả phí giao dịch (VN-FACTS: phí phái sinh cỡ vài nghìn đồng/hợp đồng/chiều) cộng với chịu basis của tháng mới. Nếu *không* roll và giữ tới đáo hạn thì không có giao nhận vật chất: hợp đồng được **thanh toán bằng tiền** theo giá thanh toán cuối (FSP — trung bình VN30 phiên đáo hạn, xem mục 4), và hedge của bạn kết thúc tại đó chứ không tự gia hạn.
3. **Ký quỹ biến đổi và điều kiện margin call.** Điểm dễ viết ngược: VN30 futures được **mark-to-market và thanh toán lãi/lỗ bằng tiền mỗi ngày** (variation margin, VSDC). Vì vậy đúng lúc thị trường *sập*, leg short của bạn đang *lãi* và **nhận** tiền variation margin hằng ngày — nó **không** bị margin-call ở kịch bản này; ngược lại, margin call trên chính leg short phát sinh khi thị trường **tăng mạnh** làm short *lỗ*. Cái thật sự gây căng thanh khoản trong một cú sập là hai thứ khác: (i) cơ quan thanh toán **nâng tỷ lệ ký quỹ / haircut** trong regime biến động cao (VN-FACTS: tỷ lệ ký quỹ do VSDC/CTCK quy định, đổi theo thời kỳ), buộc nộp thêm ký quỹ dù vị thế đang lãi; và (ii) phải **bơm tiền bù lỗ cho rổ long** (đặc biệt nếu rổ long dùng margin) đúng lúc dòng tiền eo hẹp. Bài học LTCM của Ch14 áp thẳng: giữ funding buffer để cú (i)+(ii) không buộc bạn đóng leg hedge đúng lúc cần nó nhất.
...
**Ví dụ minh họa:** target vol danh mục 20%/năm. Regime bình lặng, realized vol đo được 15% → scale gross lên $20/15 \approx 1{,}33$. Hai chỗ phải nói thẳng ở đây. Thứ nhất, ý nghĩa của $1{,}33$ **không** phải "thị trường đang rẻ" — vol thấp *không* đồng nghĩa tài sản định giá rẻ; nó chỉ nói cùng một mức rủi ro mục tiêu giờ *cho phép* nắm exposure lớn hơn. Thứ hai, một book **long-only bằng tiền mặt không tự động lên được $1{,}33\times$**: vượt 100% vốn đòi hỏi **đòn bẩy** — margin trên cổ phiếu (có lãi vay) hoặc dùng long futures như exposure tổng hợp — nên phải kèm **leverage cap** (trần đòn bẩy khả dụng), **funding cost** vào P&L, và một **vol floor** để công thức $1/\hat\sigma$ không nổ size khi vol đo được xuống gần 0. Vào một chuỗi bão, realized vol nhảy lên 35% → scale xuống $20/35 \approx 0{,}57$, cắt hơn nửa gross; nhưng chiều *giảm* size này cũng vướng ràng buộc VN — nếu cổ phiếu **kịch sàn không có đối ứng** thì bạn *không bán bớt được* để hạ gross như công thức đòi, nên cần một **rebalance band** (chỉ chỉnh size khi lệch đủ xa mục tiêu, tránh giao dịch vì nhiễu) và một quy tắc xử lý phần không thanh khoản. Cơ chế này tự động deleverage khi vào regime nguy hiểm, cắt bớt đuôi trái của phân phối P&L (Ch14). Nhưng nhớ đúng giới hạn Ch14 đã cảnh báo: vol dự báo *trễ* — một phiên cả rổ gap sàn $-7\%$ ngay đầu phiên đánh trúng bạn ở size cũ *trước khi* $\hat\sigma$ kịp nhảy; vol targeting làm phân phối gọn hơn nhưng không cứu bạn khỏi cú jump của đúng một ngày. Ở VN, cơ chế biên độ HOSE $\pm7\%$/ngày (VN-FACTS) vừa là bức tường chặn cú lỗ một ngày ở $-7\%$, vừa là cái bẫy: khi cổ phiếu kịch sàn thường **không có bên đối ứng để khớp** (ai cũng muốn bán, không ai muốn mua — VN-FACTS), bạn không thoát được ở giá sàn. Nên đừng backtest vol targeting với giả định "cắt được ngay ở giá sàn" — đó là một trong những giả định lạc quan giết chết backtest ở VN.
...
- **$\mu$ ước lượng cực tệ** vì lịch sử data VN ngắn (VN-FACTS: VN-Index từ 2000, VN30 futures từ 2017) → overfitting cực dễ. Ch14 định lượng đòn này: nếu bạn tưởng $\mu = 8\%$ nhưng thực ra chỉ $4\%$, thì full-Kelly bạn đang chạy hóa ra *chính là* **double-Kelly** ($2\times$) của thực tại. Trong mô hình Gaussian liên tục, growth rate $g(f) = f\mu - \tfrac12 f^2\sigma^2$ đạt đỉnh ở $f^* = \mu/\sigma^2$ và **về đúng 0 tại $f = 2f^*$** (double-Kelly: tăng trưởng bằng như không đặt cược) — chỉ *vượt* $2\times$ mới kéo growth âm. Nói cách khác, ước lệch $\mu$ gấp đôi đã đủ để xóa sạch lợi thế tăng trưởng dù chưa lỗ kỳ vọng; lệch hơn nữa mới âm. Half-Kelly là hàng rào chống đúng sai số này, đổi ~25% growth lấy việc chỉ chịu một phần tư variance và đứng xa mép $2\times$ đó.
...
Xếp thứ tự đúng — và một cái bẫy: vol targeting (8.4) và Kelly (8.5) **không thật sự độc lập**, vì cả hai đều là hàm của $\sigma$. Kelly đã chứa $\sigma^{-2}$ ($f^* = \mu/\sigma^2$) còn vol targeting scale theo $\sigma^{-1}$; nếu bạn nhân *mù* hai scaler cùng đo trên $\sigma$ hiện tại, đòn bẩy hiệu dụng phụ thuộc gần $\sigma^{-3}$ — deleverage/leverage phản ứng thái quá, khuếch đại đúng cái nó định làm dịu. Cách ghép sạch là coi chúng như **một policy đòn bẩy hợp nhất**, không phải hai lớp rời: Kelly đặt *mốc gross trung bình dài hạn* dùng $\sigma$ dài hạn (ổn định), vol targeting chỉ điều chỉnh *quanh* mốc đó theo $\sigma$ hiện tại — tách vai trò của $\sigma$ để không đếm nó hai lần. Và trên tất cả, funding constraint của Ch14 là trần cứng: *thị trường có thể vô lý lâu hơn thời gian bạn còn trả nổi margin* — khi Kelly và funding xung đột, funding luôn thắng.
