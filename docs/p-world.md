...
P-world chơi trò ngược lại, và khó hơn theo một nghĩa sẽ làm rõ ở 1.2 — *nhận thức luận*, không phải kỹ thuật toán (và lưu ý: so sánh "P khó hơn Q" ở đây đang đặt P-world thực tế cạnh một Q-world đã lý tưởng hóa; Q thực tế cũng có phần khó riêng): **dự báo phân phối thật của giá tương lai, và kiếm tiền từ chỗ dự báo của mình tốt hơn cái mà giá thị trường đang ngầm định**. Không có phép màu replication nào cứu ta cả. Ta phải đoán $\mu$ — chính cái mà Q-world vứt đi — và đoán đúng thường xuyên hơn sai một chút.
...
**Quant thuần hệ thống.** Đại diện: **Renaissance** (quỹ Medallion huyền thoại — được đồn ~66%/năm trước phí; từ giữa thập niên 2000 đã **trả lại vốn cho nhà đầu tư ngoài và chỉ còn mở cho nhân viên**), **Two Sigma, DE Shaw, AQR, PDT, WorldQuant, Man AHL/Numeric, Squarepoint, Qube**. (AQR ở đây chỉ là một mặt — nó đồng thời là CTA và asset manager factor, minh họa cho tính chồng lấn đã nói ở trên. Còn **XTX** về bản chất là một *electronic market maker*, xếp đúng hơn ở nhóm prop/market maker ngay dưới hơn là "quant thuần hệ thống".) Văn hóa đặc trưng: "một mô hình lớn tập thể" (collaborative) — mọi researcher đóng góp vào một hệ thống chung, thay vì cạnh tranh theo pod. RenTec và Two Sigma nổi tiếng kiểu này; nó đổi lấy tính cạnh tranh nội bộ để lấy sự phối hợp.
